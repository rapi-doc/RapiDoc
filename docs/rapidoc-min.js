              ...
              ${"http"===e.type.toLowerCase()&&"basic"===e.scheme.toLowerCase()?D`
                  ...
                  <div>
                    <input
                      ...
                      style="width:100px"
                      @change = ${e=>{FR.call(this,e.target?e.target:e)}}
                    >
                    <input
                      type="password"
                      spellcheck="false"
...
`:void 0}function YR(e){if(this.resolvedSpec.securitySchemes&&e){const t=[];return e.forEach((e=>{const r=[],n=[];0===Object.keys(e).length?t.push({securityTypes:"None",securityDefs:[]}):(Object.keys(e).forEach((t=>{let o="";const a=this.resolvedSpec.securitySchemes.find((e=>e.securitySchemeId===t));e[t]&&Array.isArray(e[t])&&(o=e[t].join(", ")),a&&(n.push(a.typeDisplay),r.push({...a,scopes:o}))})),t.push({securityTypes:n.length>1?`${n[0]} + ${n.length-1} more`:n[0],securityDefs:r}))})),D`<div style="position:absolute; top:3px; right:2px; font-size:var(--font-size-small); line-height: 1.5;">
  ...
  <div class="tab-panel col"
    ...
    ${e.map(((e,t)=>{var r,n,o;return D`
      <div class="tab-content m-markdown" style= "display:${0===t?"block":"none"}" data-tab = '${e.lang}${t}'>
        ...
        <pre><code class="language">${Me().languages[null===(r=e.lang)||void 0===r?void 0:r.toLowerCase()]?bR(Me().highlight(e.source,Me().languages[null===(n=e.lang)||void 0===n?void 0:n.toLowerCase()],null===(o=e.lang)||void 0===o?void 0:o.toLowerCase())):e.source}</code></pre>
      </div>`}))}
    ...
    `))}
  `}const eF={},tF=gR(class extends yR{constructor(){super(...arguments),this.nt=eF}render(e,t){return t()}update(e,[t,r]){if(Array.isArray(t)){if(Array.isArray(this.nt)&&this.nt.length===t.length&&t.every(((e,t)=>e===this.nt[t])))return z}else if(this.nt===t)return z;return this.nt=Array.isArray(t)?Array.from(t):t,this.render(t,r)}}),rF=l`
.border-top {
  border-top:1px solid var(--border-color);
}
.border{
...
`,l``,l``,l``,l``];customElements.define("json-tree",class extends re{static get properties(){return{data:{type:Object},renderStyle:{type:String,attribute:"render-style"}}}static get styles(){return[He,rF,We,l`
      :host{
        display:flex;
      }
      .json-tree {
...
`;customElements.define("schema-tree",class extends re{static get properties(){return{data:{type:Object},schemaExpandLevel:{type:Number,attribute:"schema-expand-level"},schemaDescriptionExpanded:{type:String,attribute:"schema-description-expanded"},allowSchemaDescriptionExpandToggle:{type:String,attribute:"allow-schema-description-expand-toggle"},schemaHideReadOnly:{type:String,attribute:"schema-hide-read-only"},schemaHideWriteOnly:{type:String,attribute:"schema-hide-write-only"}}}connectedCallback(){super.connectedCallback(),(!this.schemaExpandLevel||this.schemaExpandLevel<1)&&(this.schemaExpandLevel=99999),this.schemaDescriptionExpanded&&"true false".includes(this.schemaDescriptionExpanded)||(this.schemaDescriptionExpanded="false"),this.schemaHideReadOnly&&"true false".includes(this.schemaHideReadOnly)||(this.schemaHideReadOnly="true"),this.schemaHideWriteOnly&&"true false".includes(this.schemaHideWriteOnly)||(this.schemaHideWriteOnly="true")}static get styles(){return[He,oF,rF,l`
    ...
    `}generateTree(e,t="object",r="",n="",o="",a=0,i=0,s=""){var l;if("true"===this.schemaHideReadOnly){if("array"===t&&"readonly"===s)return;if(e&&"readonly"===e["::readwrite"])return}if("true"===this.schemaHideWriteOnly){if("array"===t&&"writeonly"===s)return;if(e&&"writeonly"===e["::readwrite"])return}if(!e)return D`<div class="null" style="display:inline;">
        ...
        <div class="tr ${a<this.schemaExpandLevel||null!==(g=e["::type"])&&void 0!==g&&g.startsWith("xxx-of")?"expanded":"collapsed"} ${e["::type"]||"no-type-info"}" title="${e["::deprecated"]?"Deprecated":""}">
          ...
          <div class='td key-descr m-markdown-small'>${bR(Be(o||""))}</div>
        </div>
      ...
      <div class = "tr primitive" title="${A?"Deprecated":""}">
        ...
        <div class='td key-descr'>
          ${"array"===t?D`<span class="m-markdown-small">${bR(Be(o))}</span>`:""}
    ...
    `]}});function aF(e){var t,r;const n=null!==(t=null==e?void 0:e.width)&&void 0!==t?t:20,o=null!==(r=null==e?void 0:e.height)&&void 0!==r?r:20;return D`
...
`}function sF(e){var t,r;const n=null!==(t=null==e?void 0:e.width)&&void 0!==t?t:20,o=null!==(r=null==e?void 0:e.height)&&void 0!==r?r:20;return D`
    <svg width=${n} height=${o} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  `}customElements.define("bread-crumbs",class extends re{static get properties(){return{headers:{type:Array}}}static get styles(){return[l`
        .container {
          display: flex;
          align-items: center;
        }
...
`:""}
    ...
    `}});class lF extends re{constructor(e,t){super(),this.active=!0,this.message=null!=t?t:"",this.tone=null!=e?e:"positive",this.tones={info:{borderColor:l`#7CBBEA`,bgColor:l`#DEECF7`,icon:aF},positive:{borderColor:l`#83D187`,bgColor:l`#DFF1E0`,icon:aF},warning:{borderColor:l`#F5AE70`,bgColor:l`#FFEBD7`,icon:aF},critical:{borderColor:l`#F49494`,bgColor:l`#F8E3E3`,icon:aF}}}firstUpdated(){const e=e=>{this.renderRoot.querySelectorAll(".toast-active").length>0&&"fadeOut"===e.animationName&&this.onClose()};this.renderRoot.getElementById("toast").addEventListener("animationend",e),this.renderRoot.getElementById("toast").addEventListener("webkitAnimationEnd",e)}onClose(){this.active=!1;this.dispatchEvent(new CustomEvent("closed-toast",{detail:"closed toast",bubbles:!0,composed:!0}))}render(){return D`
        ...
        `}static get styles(){return[l`
            ...
            `]}}var cF,pF,dF;cF=lF,pF="properties",dF={tone:{type:String},tones:{type:{}},message:{type:String},active:{type:Boolean}},pF in cF?Object.defineProperty(cF,pF,{value:dF,enumerable:!0,configurable:!0,writable:!0}):cF[pF]=dF,customElements.define("toast-component",lF);class uF extends re{constructor(e,t,r,n){super(),this.id=e,this.content=t,this.computedUrl=r,this.variables=n,this.copied=!1,this.showButton=!1,this.showToast=!1,this.addEventListener("closed-toast",(()=>{this.showToast=!1}))}reset(){this.copied=!1,this.showButton=!1}willUpdate(e){e.has("id")&&this.reset()}onButtonClick(){navigator.clipboard.writeText(this.computedUrl?this.computedUrl:this.content),this.copied=!0}onTextClick(){navigator.clipboard.writeText(this.computedUrl?this.computedUrl:this.content),this.showToast=!0}onMouseOver(){this.showButton=!0}onMouseLeave(){this.showButton=!1,this.copied=!1}parseURL(){if(!this.variables)return this.content;let e=this.content;for(const[t,r]of Object.entries(this.variables)){const n=new RegExp(`{${t}}`,"g");e=e.replace(n,'<span class="variable">{var}</span>'.replace("{var}",r.value))}return e}render(){return D`
            <div class='container'>
                <div @mouseover="${this.onMouseOver}" @mouseleave="${this.onMouseLeave}" class="content-copy-container">
                    ${D`<span @click="${this.onTextClick}" part="label-operation-path" class="url">${bR(this.parseURL())}</span>`}
        ...
        `}static get styles(){return[l`
          ...
          `]}}function hF(e){var t;const r=null===(t=this.resolvedSpec)||void 0===t?void 0:t.servers.find((t=>t.url===e));return!!r&&(this.selectedServer=r,this.requestUpdate(),this.dispatchEvent(new CustomEvent("api-server-change",{bubbles:!0,composed:!0,detail:{selectedServer:r}})),!0)}function fF(e,t){const r=[...e.currentTarget.closest(".server-vars").querySelectorAll("input, select")];let n=t.url;r.forEach((e=>{t.variables[e.dataset.var].value=e.value;const r=new RegExp(`{${e.dataset.var}}`,"g");n=n.replace(r,e.value)})),t.computedUrl=n,FR.call(this,e.target?e.target:e),this.requestUpdate()}function mF(){return this.selectedServer&&this.selectedServer.variables?D`
      ...
      ${Object.entries(this.selectedServer.variables).map((e=>D`
        <div>
          ...
          <div>
            ...
            <select
              data-var = "${e[0]}"
              @input = ${e=>{fF.call(this,e,this.selectedServer)}}
            >
    ...
    `:""}function gF(){var e,t,r;return!this.resolvedSpec||this.resolvedSpec.specLoadError?"":D`
  <section id = 'servers' part="section-servers" class='server-template row-api-right-box regular-font observe-me ${"read focused".includes(this.renderStyle)?"section-gap--read-mode":"section-gap"}'>
    ...
    <div style="display: flex; align-items: center;" class="server-template">
      ${null!==(e=this.selectedServer)&&void 0!==e&&e.computedUrl?D`
            <base-url id='copy-baseURL' content='${null===(t=this.selectedServer)||void 0===t?void 0:t.url}${this.path}' computedUrl='${this.selectedServer.computedUrl}' .variables='${null===(r=this.selectedServer)||void 0===r?void 0:r.variables}' style="width: 100%;">
    ...
    <div class="row-api regular-font request-panel ${"read focused".includes(this.renderStyle)||"true"===this.callback?"read-mode":"view-mode"}">
      <div class="row-api-left">
        ${tF([this.allowTry,this.parameters,this.activeParameterSchemaTabs],(()=>this.inputParametersTemplate("path")))}
        ${tF([this.allowTry,this.parameters,this.activeParameterSchemaTabs],(()=>this.inputParametersTemplate("query")))}
        ${this.requestBodyTemplate()}
        ${tF([this.allowTry,this.parameters,this.activeParameterSchemaTabs],(()=>this.inputParametersTemplate("header")))}
        ${tF([this.allowTry,this.parameters,this.activeParameterSchemaTabs],(()=>this.inputParametersTemplate("cookie")))}
    ...
    ${r.length>0?D`<span style="font-weight:bold; font-size:12px;margin-top:10px;">Example: </span>
        ${r.map(((r,n)=>{var o,a,i;return D`
          ...
          <a part="anchor anchor-param-example" class = "${"true"===this.allowTry?"":"inactive-link"}"
            ...
            @click="${t=>{const r=t.target.closest("div").querySelector(`[data-pname="${e}"]`);r&&("array"===t.target.dataset.exampleType?r.value=t.target.dataset.example.split("~|~"):r.value=t.target.dataset.example,FR.call(this,r),this.requestUpdate())}}"
          >
          ${"true"===this.useSummaryToListExamples?r.description||r.summary||(r.value&&Array.isArray(r.value)?null===(a=r.value)||void 0===a?void 0:a.join(", "):r.value||""):r.value&&Array.isArray(r.value)?null===(i=r.value)||void 0===i?void 0:i.join(", "):r.value||""}
          </a>
          ${"array"===t?"] ":""}
        `}))}
      `:""}`}inputParametersTemplate(e){const t=this.parameters?this.parameters.filter((t=>t.in===e)):[];if(0===t.length)return"";let r="";"path"===e?r="Path Params":"query"===e?r="Query-String Params":"header"===e?r="Headers":"cookie"===e&&(r="Cookies");const n=[];for(const r of t){const[t,o,a]=RR(r);if(!t)continue;const i=xR(t);if(!i)continue;const s=_R(t,{});let l="form",c=!0,p=!1;"query"===e&&(r.style&&"form spaceDelimited pipeDelimited".includes(r.style)?l=r.style:o&&(l=o),"boolean"==typeof r.explode&&(c=r.explode),"boolean"==typeof r.allowReserved&&(p=r.allowReserved));const d=kR(r.examples||wR(r.example)||wR(null==a?void 0:a.example)||(null==a?void 0:a.examples)||i.examples||wR(i.example),i.type);d.exampleVal||"object"!==i.type||(d.exampleVal=PR(t,o||"json","","","true"===this.callback||"true"===this.webhook,"true"!==this.callback&&"true"!==this.webhook,!0,"text")[0].exampleValue),this.resolvedSpec.securitySchemes.some((e=>e.name===r.name))||n.push(D`
              ...
              ${"true"===this.allowTry?D`
                ...
                anchor:anchor, anchor-param-example:anchor-param-example"
                        ...
                        <input type="${"password"===i.format?"password":"text"}" spellcheck="false" style="width:100%" W
                          ...
                          @input = ${e=>{FR.call(this,e.target?e.target:e),this.requestUpdate()}}
                        />`}`:""}
    ...
    <div class="request-card">
      ...
      `,a.forEach((e=>{let a,i=[];if(this.selectedRequestBodyType.includes("json")||this.selectedRequestBodyType.includes("xml")||this.selectedRequestBodyType.includes("text")||this.selectedRequestBodyType.includes("jose"))e.mimeType===this.selectedRequestBodyType&&(i=PR(e.schema,e.mimeType,e.examples,e.example,"true"===this.callback||"true"===this.webhook,"true"!==this.callback&&"true"!==this.webhook,"text",!1),this.selectedRequestBodyExample||(this.selectedRequestBodyExample=i.length>0?i[0].exampleId:""),o=D`
            ${o}
          ...
          `);(e.mimeType.includes("json")||e.mimeType.includes("xml")||e.mimeType.includes("text")||this.selectedRequestBodyType.includes("jose"))&&(a=_R(e.schema,{}),"table"===this.schemaStyle?n=D`
            ${n}
            <schema-table
    ...
    `}formDataParamAsObjectTemplate(e,t,r){var n;const o=_R(t,{}),a=PR(t,"json",t.examples,t.example,"true"===this.callback||"true"===this.webhook,"true"!==this.callback&&"true"!==this.webhook,"text",!1);return D`
    ...
    `}formDataTemplate(e,t,r=""){const n=[];if(e.properties){for(const r in e.properties){var o,a;const i=e.properties[r];if(i.readOnly)continue;const s=i.examples||i.example||"",l=i.type,c=xR(i),p="read focused".includes(this.renderStyle)?"200px":"160px",d=kR(c.examples||c.example,c.type);n.push(D`
                      ...
                      ${c.allowedValues&&c.allowedValues.split("┃").map(((e,t)=>D`
                        ...
                        ${D`
                          <a part="anchor anchor-param-constraint" class = "${"true"===this.allowTry?"":"inactive-link"}"
                            ...
                            data-enum="${e.trim()}"
                            @click="${e=>{const t=e.target.closest("div").querySelector(`[data-pname="${r}"]`);t&&("array"===e.target.dataset.type?t.value=[e.target.dataset.enum]:t.value=e.target.dataset.enum,FR.call(this,t),this.requestUpdate())}}"
                          > 
                            ${e} 
                          </a>`}`))}
                    </div>`:""}
    ...
    `;if(this.resultLoad){const e=this.renderRoot.host.shadowRoot.children[0];FR.call(this,e.target?e.target:e)}else this.updateComplete.then((()=>{const e=this.renderRoot.host.shadowRoot.children[0];FR.call(this,e.target?e.target:e),this.requestUpdate()})),this.resultLoad=!0;return D`
    ...
    `}generateTree(e,t="object",r="",n="",o="",a=0,i=0,s=""){var l,c;if("true"===this.schemaHideReadOnly){if("array"===t&&"readonly"===s)return;if(e&&"readonly"===e["::readwrite"])return}if("true"===this.schemaHideWriteOnly){if("array"===t&&"writeonly"===s)return;if(e&&"writeonly"===e["::readwrite"])return}if(!e)return D`<div class="null" style="display:inline;">
        <span style='margin-left:${16*(a+1)}px'> &nbsp; </span>
        <span class="key-label xxx-of-key"> ${n.replace("::OPTION~","")}</span>
        ${"array"===t?D`<span class='mono-font'> [ ] </span>`:"object"===t?D`<span class='mono-font'> { } </span>`:D`<span class='mono-font'> schema undefined </span>`}
      </div>`;const p=null!==(l=e["::type"])&&void 0!==l&&l.startsWith("xxx-of")?a:a+1,d="xxx-of-option"===t||"xxx-of-option"===e["::type"]||n.startsWith("::OPTION")?i:i+1,u=10*d;if(0===Object.keys(e).length)return D`<span class="td key object" style='padding-left:${u}px'>${n}</span>`;let h="",f="",m=!1;if(n.startsWith("::ONE~OF")||n.startsWith("::ANY~OF"))h=n.replace("::","").replace("~"," "),m=!0;else if(n.startsWith("::OPTION")){const e=n.split("~");h=e[1],f=e[2]}else h=n;let g="";if("object"===e["::type"]?g="array"===t?"array of object":"object":"array"===e["::type"]&&(g="array"===t?"array of array "+("object"!==r?`of ${r}`:""):"array"),"object"==typeof e)return D`
        ${p>=0&&n?D`
            <div class='tr ${p<=this.schemaExpandLevel?"expanded":"collapsed"} ${e["::type"]}' data-obj='${h}' title="${e["::deprecated"]?"Deprecated":""}">
              ...
              <div class='td key-descr' style='line-height:1.7'>${bR(Be(o||""))}</div>
            </div>`:D`
    ...
    `}resetSelection(){this.selectedStatus="",this.selectedMimeType=""}getResponseStatusType(e){const t=e.toString();return t.startsWith("1")?"informational":t.startsWith("2")?"success":t.startsWith("3")?"redirection":t.startsWith("4")||t.startsWith("5")?"error":""}responseTemplate(){if(!this.responses)return"";for(const n in this.responses){this.selectedStatus||(this.selectedStatus=n);const o={};for(const r in null===(e=this.responses[n])||void 0===e?void 0:e.content){var e,t;const a=this.responses[n].content[r];this.selectedMimeType||(this.selectedMimeType=r);const i=_R(a.schema,{}),s=PR(a.schema,r,a.examples,a.example,"true"!==this.callback&&"true"!==this.webhook,"true"===this.callback||"true"===this.webhook,r.includes("json")?"json":"text");o[r]={description:this.responses[n].description,examples:s,selectedExample:(null===(t=s[0])||void 0===t?void 0:t.exampleId)||"",schemaTree:i}}const a=[];for(const e in null===(r=this.responses[n])||void 0===r?void 0:r.headers){var r;a.push({name:e,...this.responses[n].headers[e]})}this.headersForEachRespStatus[n]=a,this.mimeResponsesForEachStatus[n]=o}return D`
                ...
                >
                  <div style='display: flex; flex-direction: row; justify-content: flex-start; align-items: center;'>
                    <div style="display: flex; justify-content: center; align-items: center; margin-right: 8px">
                      ${function(e){var t,r;const n=null!==(t=null==e?void 0:e.width)&&void 0!==t?t:16,o=null!==(r=null==e?void 0:e.height)&&void 0!==r?r:16;return D`
  ...
  `}()}
    ...
    `}responseHeaderListTemplate(e){return D`
      ...
      <table style="border-collapse: collapse; margin-bottom:16px; border:1px solid var(--border-color); border-radius: var(--border-radius)" class="small-font-size mono-font">
        ${e.map((e=>{var t,r,n,o,a,i;return D`
          <tr>
            ...
            <td style="padding:8px; vertical-align: baseline; border-top: 1px solid var(--light-border-color); text-overflow: ellipsis;">
              ${(null===(o=e.content)||void 0===o||null===(a=o["text/plain"])||void 0===a?void 0:a.example)||(null===(i=e.schema)||void 0===i?void 0:i.example)||""}
            </td>
          </tr>
        `}))}
    ...
    `:D`
      ...
      `}});class yF extends re{constructor(e,t){super(),this.id=e,this.content=t,this.copied=!1,this.showButton=!1,this.showToast=!1,this.addEventListener("closed-toast",(()=>{this.showToast=!1}))}reset(){this.copied=!1,this.showButton=!1}willUpdate(e){e.has("id")&&this.reset()}onButtonClick(){navigator.clipboard.writeText(this.content),this.copied=!0}onTextClick(){navigator.clipboard.writeText(this.content),this.showToast=!0}onMouseover(){this.showButton=!0}onMouseLeave(){this.showButton=!1,this.copied=!1}render(){return D`
        ...
        `}static get styles(){return[l`
          ...
          `]}}function vF(e,t,r,n,o){var a;let i="";t&&(i+=`${Be(t)}\n\n`);try{const e=JSON.parse(decodeURIComponent(n));switch(r){case"code":i+=Be(e.codes.reduce(((e,t)=>{switch(t.language){case"jsonc":t.language="json";break;case"curl":t.language="curl"}return`${e}\n\`\`\`${t.language}\n${decodeURIComponent(t.code)}\n\`\`\`\n`}),""));break;case"html":case"embed":i+=`\n\n${e.html}\n\n`;break;case"image":i+=e.images.reduce(((e,t)=>`${e}\n\n<img src="${t.image[0]}" alt="${t.image[1]}" style="width:50%;" />`),"");break;case"api-header":i+=Be(`## ${e.title}`);break;case"callout":i+=`<blockquote class=${e.type}><h3>${null!==(a=e.title)&&void 0!==a?a:""}</h3>${Be(e.body)}</blockquote>`;break;case"parameters":{const{rows:t,cols:r}=e;let n="\n\n";for(let t=0;t<r;t++)e.data[`h-${t}`]?n+=`| ${e.data[`h-${t}`]}`:n+="|";n+="|\n";for(let e=0;e<r;e++)n+="| :---";for(let o=0;o<t;o++){n+="|\n";for(let t=0;t<r;t++)e.data[`${o}-${t}`]?n+=`| ${e.data[`${o}-${t}`].replace(/\n/gm,"<br />")}`:n+="|"}n+="|\n",i+=Be(n)}break;default:i+=""}o&&(i+=Be(o))}catch(e){i+=`\n\n<blockquote class="warning"><h3>Work in progress</h3>[block:${r}]${n}[/block]</blockquote>\n\n`,o&&(i+=Be(o))}return i}function bF(e){return e.replace(/(?<TextBefore>[^[\]]*)\[block:(?<Type>[^\]]*)\](?<Content>.+?)\[\/block\](?<TextAfter>[^[\]]*)/gms,vF)}function xF(e){const t=new Be.Renderer;return t.heading=(t,r,n,o)=>`<h${r} class="observe-me" id="${e}--${o.slug(n)}">${t}</h${r}>`,t}function wF(e,t=""){var r,n,o;const a=new Set;for(const t in e.responses)for(const r in null===(i=e.responses[t])||void 0===i?void 0:i.content){var i;a.add(r.trim())}const s=[...a].join(", "),l=this.resolvedSpec.securitySchemes.filter((t=>{var r;return t.finalKeyValue&&(null===(r=e.security)||void 0===r?void 0:r.some((e=>t.securitySchemeId in e)))}))||[],c=this.resolvedSpec.securitySchemes.find((e=>e.securitySchemeId===tt&&"-"!==e.value));c&&l.push(c);const p=e.xCodeSamples?QR.call(this,e.xCodeSamples):"";return e.description=bF(e.description),D`
  ...
  `}function kF(){return this.resolvedSpec?D`
  ${this.resolvedSpec.tags.map((e=>D`
    <section id="${e.elementId}" part="section-tag" class="regular-font section-gap--read-mode observe-me" style="border-top:1px solid var(--primary-color);">
      ...
      ${bR(`\n          <div class="m-markdown regular-font">\n          ${Be(e.description||"","true"===this.infoDescriptionHeadingsInNavBar?{renderer:xF(e.elementId)}:void 0)}\n        </div>`)}
      </div>
    </section>
    <section class='regular-font section-gap--read-mode' part="section-operations-in-tag">
      ${e.paths.map((e=>wF.call(this,e,"BBB")))}
    </section>
    `))}
`:""}function $F(e){return D`
  ...
  ${"table"===this.schemaStyle?D`
      ...
      <schema-tree
        ...
        exportparts = "schema-description:schema-description, schema-multiline-toggle:schema-multiline-toggle"
      > </schema-tree>`}
  </div>`}function SF(e,t){return-1!==e.id.indexOf("schemas-")?$F.call(this,e):D`
  <div class='divider'></div>
  <div class='expanded-endpoint-body observe-me ${e.name}' id='cmp--${e.id}' >
    ${D`
  ...
  `}function AF(){return this.resolvedSpec?D`
  ${this.resolvedSpec.components.map((e=>D`
    ...
    <div class='regular-font section-gap--read-mode'>
      ${e.subComponents.filter((e=>!1!==e.expanded)).map((t=>SF.call(this,t,e.name)))}
    </div>
    `))}
`:""}function OF(){const e=new Be.Renderer;return e.heading=(e,t,r,n)=>`<h${t} class="observe-me" id="overview--${n.slug(r)}">${e}</h${t}>`,e}function EF(){var e,t,r,n;return this.resolvedSpec.info.description=bF(this.resolvedSpec.info.description),D`
    <section part="section-overview" class="observe-me ${"view"===this.renderStyle?"section-gap":"section-gap--read-mode"}">
      ...
      ${null!==(e=this.resolvedSpec)&&void 0!==e&&e.info?D`
          ...
          ${this.resolvedSpec.info.description?D`${bR(`\n                <div class="m-markdown regular-font">\n                ${Be(this.resolvedSpec.info.description,"true"===this.infoDescriptionHeadingsInNavBar?{renderer:OF()}:void 0)}\n              </div>`)}`:""}
          </div>
        `:""}
    </section>
  `}function TF(e,t="toggle"){const r=null==e?void 0:e.closest(".nav-bar-tag-and-paths");if(r){const e=r.classList.contains("expanded");!e||"toggle"!==t&&"collapse"!==t?e||"toggle"!==t&&"expand"!==t||r.classList.replace("collapsed","expanded"):r.classList.replace("expanded","collapsed")}}function CF(e){TF(e.target,"toggle")}function jF(e,t="expand-all"){!function(e,t="expand-all"){const r=[...e.querySelectorAll(".nav-bar-tag-and-paths")];"expand-all"===t?r.map((e=>{e.classList.replace("collapsed","expanded")})):r.map((e=>{e.classList.replace("expanded","collapsed")}))}(e.target.closest(".nav-scroll"),t)}function _F(){var e,t,r,n;return!this.resolvedSpec||this.resolvedSpec.specLoadError?D`
      ...
      <div id='link-operations-top' class='nav-bar-section operations' data-content-id='operations-top' @click = '${e=>this.scrollToEventTarget(e,!1)}'>
        <div style="font-size:16px; display:flex; margin-left:10px;">
          ${"focused"===this.renderStyle?D`
              <div @click="${e=>{jF.call(this,e,"expand-all")}}" title="Expand all" style="transform: rotate(90deg); cursor:pointer; margin-right:10px;">▸</div>
              <div @click="${e=>{jF.call(this,e,"collapse-all")}}" title="Collapse all" style="transform: rotate(270deg); cursor:pointer;">▸</div>`:""}  
        </div>
        <div class='nav-bar-section-title'> OPERATIONS </div>
      </div>

      <!-- TAGS AND PATHS-->
      ${this.resolvedSpec.tags.filter((e=>e.paths.filter((e=>ot(this.matchPaths,e,this.matchType))).length)).map((e=>D`
          <div class='nav-bar-tag-and-paths ${e.expanded?"expanded":"collapsed"}'>
            ${"General ⦂"===e.name?D`<hr style="border:none; border-top: 1px dotted var(--nav-text-color); opacity:0.3; margin:-1px 0 0 0;"/>`:D`
                <div 
                  ...
                  @click='${e=>{"focused"===this.renderStyle&&"expand-collapse"===this.onNavTagClick?CF.call(this,e):this.scrollToEventTarget(e,!1)}}'
                >
                  <div>${e.name}</div>
                  <div class="nav-bar-tag-icon" @click="${e=>{"focused"===this.renderStyle&&"show-description"===this.onNavTagClick&&CF.call(this,e)}}">
                  </div>
                </div>
              `}
            ${"true"===this.infoDescriptionHeadingsInNavBar?D`
            ...
            <div class='nav-bar-paths-under-tag'>
              ...
              ${e.paths.filter((e=>!this.matchPaths||ot(this.matchPaths,e,this.matchType))).map((e=>D`
              <div 
                class='nav-bar-path
...
`}function PF(e){const t=new Be.Renderer;return t.heading=(t,r,n,o)=>`<h${r} class="observe-me" id="${e}--${o.slug(n)}">${t}</h${r}>`,t}function IF(e){return D`
    <div class='regular-font section-gap--focused-mode' part="section-operations-in-tag">
      ${e}
    </div>`}function RF(){var e;if("true"===this.showInfo)return IF(EF.call(this));const t=this.resolvedSpec.tags[0],r=null===(e=this.resolvedSpec.tags[0])||void 0===e?void 0:e.paths[0];return IF(t&&r?wF.call(this,r,t.name):"")}function FF(e){return D`
    <h1 id="${e.elementId}">${e.name}</h1>
    ${"show-description"===this.onNavTagClick&&e.description?D`
        <div class="m-markdown">
          ${bR(`\n            <div class="m-markdown regular-font">\n              ${Be(e.description||"","true"===this.infoDescriptionHeadingsInNavBar?{renderer:PF(e.elementId)}:void 0)}\n            </div>`)}
        </div>`:""}
  `}function LF(){if(!this.focusedElementId||!this.resolvedSpec)return;const e=this.focusedElementId;let t,r=null,n=null,o=0;if(e.startsWith("overview")&&"true"===this.showInfo)t=EF.call(this);else if("auth"===e&&"true"===this.allowAuthentication)t=ZR.call(this);else if("servers"===e&&"true"===this.allowServerSelection)t=gF.call(this);else if("operations-top"===e)t=D`
    <div id="operations-top" class="observe-me">
      <slot name="operations-top"></slot>
    </div>`;else if(e.startsWith("cmp--")&&"true"===this.showComponents)t=AF.call(this);else if(e.startsWith("tag--")){const r=e.indexOf("--",4)>0?e.substring(0,e.indexOf("--",5)):e;n=this.resolvedSpec.tags.find((e=>e.elementId===r)),t=n?IF.call(this,FF.call(this,n)):RF.call(this)}else{for(o=0;o<this.resolvedSpec.tags.length&&(n=this.resolvedSpec.tags[o],r=this.resolvedSpec.tags[o].paths.find((t=>`${t.elementId}`===e)),!r);o+=1);if(r){TF(this.shadowRoot.getElementById(`link-${e}`),"expand"),t=IF.call(this,wF.call(this,r,n.name))}else t=RF.call(this)}return t}function DF(e){if(e.expanded)e.expanded=!1,"true"===this.updateRoute&&window.history.replaceState(null,null,`${window.location.href.split("#")[0]}${"#"===this.routePrefix?"":`${this.routePrefix}`}`);else if(e.expanded=!0,"true"===this.updateRoute){const t=`${this.routePrefix||"#"}${e.elementId}`;window.location.hash!==t&&window.history.replaceState(null,null,`${window.location.href.split("#")[0]}${t}`)}this.requestUpdate()}function zF(e,t="expand-all"){const r=[...e.querySelectorAll(".section-tag")];"expand-all"===t?r.map((e=>{e.classList.replace("collapsed","expanded")})):r.map((e=>{e.classList.replace("expanded","collapsed")}))}function qF(e,t="expand-all"){zF.call(this,e.target.closest(".operations-root"),t)}function NF(e,t=!1){return D`
  <summary @click="${t=>{DF.call(this,e,t)}}" part="section-endpoint-head-${e.expanded?"expanded":"collapsed"}" class='endpoint-head ${e.method} ${e.deprecated?"deprecated":""} ${t||e.expanded?"expanded":"collapsed"}'>
  ...
  `}function BF(e){var t;const r=new Set;for(const t in e.responses)for(const o in null===(n=e.responses[t])||void 0===n?void 0:n.content){var n;r.add(o.trim())}const o=[...r].join(", "),a=this.resolvedSpec.securitySchemes.filter((t=>{var r;return t.finalKeyValue&&(null===(r=e.security)||void 0===r?void 0:r.some((e=>t.securitySchemeId in e)))}))||[],i=this.resolvedSpec.securitySchemes.find((e=>e.securitySchemeId===tt&&"-"!==e.value));i&&a.push(i);const s=e.xCodeSamples?QR(e.xCodeSamples):"";return e.description=bF(e.description),D`
  <style>
      .label-operation-container {
        text-align: left;
        direction: ltr;
  ...
  </div>`}function UF(e=!0,t=!0,r=!1){return this.resolvedSpec?D`
    ${e?D`
        <div style="display:flex; justify-content:flex-end;"> 
          <span @click="${e=>qF(e,"expand-all")}" style="color:var(--primary-color); cursor:pointer;">
            Expand all
          </span> 
          &nbsp;|&nbsp; 
          <span @click="${e=>qF(e,"collapse-all")}" style="color:var(--primary-color); cursor:pointer;" >
            Collapse all
          </span> 
          &nbsp; sections
        </div>`:""}
            ...
            <div class='section-tag-body'>
              ...
              ${e.paths.filter((e=>!this.matchPaths||ot(this.matchPaths,e,this.matchType))).map((e=>D`
                <section part="section-endpoint" id='${e.elementId}' class='m-endpoint regular-font ${e.method} ${r||e.expanded?"expanded":"collapsed"}'>
                  <!--${NF.call(this,e,r)}-->
                  ${r||e.expanded?BF.call(this,e):""}
                </section>`))}
            </div>
          </div>`:D`
          <div class='section-tag-body'>
          ${e.paths.filter((e=>!this.matchPaths||ot(this.matchPaths,e,"exactly"))).map((e=>D`
...
`}
    ...
    </header>`;var e}!function(e,t,r){t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r}(yF,"properties",{id:{type:String},content:{type:String},copied:{type:Boolean},showButton:{type:Boolean},showToast:{type:Boolean}}),customElements.define("content-copy-button",yF);const HF=l`
  *, *:before, *:after { box-sizing: border-box; }
...
`;function WF(){var e;return document.addEventListener("close",(()=>{this.showAdvancedSearchDialog=!1})),document.addEventListener("open",this.onOpenSearchDialog),D`
    <dialog-box 
      heading="Search" 
  ...
  `}customElements.define("dialog-box",class extends re{static get properties(){return{heading:{type:String,attribute:"heading"},show:{type:String,attribute:"show"}}}static get styles(){return[HF]}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",(e=>{"Escape"===e.code&&this.onClose()}))}attributeChangedCallback(e,t,r){t!==r&&("heading"===e&&(this.heading=r),"show"===e&&(this.show=r,"true"===r&&document.dispatchEvent(new CustomEvent("open",{bubbles:!0,composed:!0,detail:this})))),super.attributeChangedCallback(e,t,r)}render(){return D`
    ${"true"===this.show?D`
        ...
        </div>`:""}`}onClose(){document.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}});const VF={color:{inputReverseFg:"#fff",inputReverseBg:"#333",headerBg:"#444",getRgb(e){if(0===e.indexOf("#")&&(e=e.slice(1,7)),3!==e.length&&4!==e.length||(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),6!==e.length)throw new Error("Invalid HEX color.");return{r:parseInt(e.slice(0,2),16),g:parseInt(e.slice(2,4),16),b:parseInt(e.slice(4,6),16)}},luminanace(e){const t=this.getRgb(e);return.299*t.r+.587*t.g+.114*t.b},invert(e){return this.luminanace(e)>135?"#000":"#fff"},opacity(e,t){const r=this.getRgb(e);return`rgba(${r.r}, ${r.g}, ${r.b}, ${t})`},brightness(e,t){const r=this.getRgb(e);return r.r+=t,r.g+=t,r.b+=t,r.r>255?r.r=255:r.r<0&&(r.r=0),r.g>255?r.g=255:r.g<0&&(r.g=0),r.b>255?r.b=255:r.b<0&&(r.b=0),`#${r.r.toString(16).padStart(2,"0")}${r.g.toString(16).padStart(2,"0")}${r.b.toString(16).padStart(2,"0")}`},hasGoodContrast(e,t){return this.luminanace(e)-this.luminanace(t)}}};function GF(e){return/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3}|[A-Fa-f0-9]{8}|[A-Fa-f0-9]{4})$/i.test(e)}function KF(e,t={}){let r={};const n=t.primaryColor?t.primaryColor:"dark"===e?"#f76b39":"#ff591e",o=VF.color.invert(n),a=VF.color.opacity(n,"0.8");if("dark"===e){const e=t.bg1?t.bg1:"#2a2b2c",i=t.fg1?t.fg1:"#bbb",s=t.bg2?t.bg2:VF.color.brightness(e,5),l=t.bg3?t.bg3:VF.color.brightness(e,17),c=t.bg3?t.bg3:VF.color.brightness(e,35),p=t.fg2?t.fg2:VF.color.brightness(i,-15),d=t.fg3?t.fg3:VF.color.brightness(i,-20),u=t.fg3?t.fg3:"#A1A8B3",h=t.inlineCodeFg?t.inlineCodeFg:"#aaa",f="#bbb",m="#eee",g=t.headerColor?t.headerColor:VF.color.brightness(e,10),y=t.navBgColor?t.navBgColor:VF.color.brightness(e,10);r={bg1:e,bg2:s,bg3:l,lightBg:c,fg1:i,fg2:p,fg3:d,lightFg:u,inlineCodeFg:h,primaryColor:n,primaryColorTrans:a,primaryColorInvert:o,selectionBg:f,selectionFg:m,overlayBg:"rgba(80, 80, 80, 0.4)",navBgColor:y,navTextColor:t.navTextColor?t.navTextColor:VF.color.opacity(VF.color.invert(y),"0.50"),navHoverBgColor:t.navHoverBgColor?t.navHoverBgColor:VF.color.brightness(y,-15),navHoverTextColor:t.navHoverTextColor?t.navHoverTextColor:VF.color.invert(y),navAccentColor:t.navAccentColor?t.navAccentColor:VF.color.brightness(n,25),headerColor:g,headerColorInvert:VF.color.invert(g),headerColorDarker:VF.color.brightness(g,-20),headerColorBorder:VF.color.brightness(g,10),borderColor:t.borderColor||VF.color.brightness(e,20),lightBorderColor:t.lightBorderColor||"#e7e9ee",codeBorderColor:t.codeBorderColor||VF.color.brightness(e,30),inputBg:t.inputBg||VF.color.brightness(e,-5),placeHolder:t.placeHolder||VF.color.opacity(i,"0.3"),hoverColor:t.hoverColor||VF.color.brightness(e,-10),red:t.red?t.red:"#F06560",lightRed:t.lightRed?t.lightRed:VF.color.brightness(e,-10),pink:t.pink?t.pink:"#ffb2b2",lightPink:t.lightPink||VF.color.brightness(e,-10),green:t.green||"#7ec699",lightGreen:t.lightGreen||VF.color.brightness(e,-10),blue:t.blue||"#71b7ff",lightBlue:t.lightBlue||VF.color.brightness(e,-10),orange:t.orange?t.orange:"#f08d49",lightOrange:t.lightOrange||VF.color.brightness(e,-10),yellow:t.yellow||"#827717",lightYellow:t.lightYellow||VF.color.brightness(e,-10),purple:t.purple||"#786FF1",brown:t.brown||"#D4AC0D",codeBg:t.codeBg||VF.color.opacity(VF.color.brightness(e,-15),.7),codeFg:t.codeFg||"#aaa",codePropertyColor:t.codePropertyColor||"#f8c555",codeKeywordColor:t.codeKeywordColor||"#cc99cd",codeOperatorColor:t.codeOperatorColor||"#67cdcc"}}else{const e=t.bg1?t.bg1:"#fafbfc",i=t.fg1?t.fg1:"#444444",s=t.bg2?t.bg2:VF.color.brightness(e,-5),l=t.bg3?t.bg3:VF.color.brightness(e,-15),c=t.bg3?t.bg3:VF.color.brightness(e,-45),p=t.fg2?t.fg2:"#545454",d=t.fg3?t.fg3:VF.color.brightness(i,30),u=t.fg3?t.fg3:"#A1A8B3",h=t.inlineCodeFg?t.inlineCodeFg:"brown",f="#444",m="#eee",g=t.headerColor?t.headerColor:VF.color.brightness(e,-180),y=t.navBgColor?t.navBgColor:VF.color.brightness(e,-200);r={bg1:e,bg2:s,bg3:l,lightBg:c,fg1:i,fg2:p,fg3:d,lightFg:u,inlineCodeFg:h,primaryColor:n,primaryColorTrans:a,primaryColorInvert:o,selectionBg:f,selectionFg:m,overlayBg:"rgba(0, 0, 0, 0.4)",navBgColor:y,navTextColor:t.navTextColor?t.navTextColor:VF.color.opacity(VF.color.invert(y),"0.65"),navHoverBgColor:t.navHoverBgColor?t.navHoverBgColor:VF.color.brightness(y,-15),navHoverTextColor:t.navHoverTextColor?t.navHoverTextColor:VF.color.invert(y),navAccentColor:t.navAccentColor?t.navAccentColor:VF.color.brightness(n,25),headerColor:g,headerColorInvert:VF.color.invert(g),headerColorDarker:VF.color.brightness(g,-20),headerColorBorder:VF.color.brightness(g,10),borderColor:t.borderColor||"#B9B9B9",lightBorderColor:t.lightBorderColor||"#e7e9ee",codeBorderColor:t.codeBorderColor||"transparent",inputBg:t.inputBg||"rgba(255, 255, 255, 0.0001)",placeHolder:t.placeHolder||VF.color.brightness(u,20),hoverColor:t.hoverColor||VF.color.brightness(e,-5),rebelPink:"#e31c58",red:t.red||"#F06560",lightRed:t.lightRed||"#fff0f0",pink:t.pink?t.pink:"#990055",lightPink:t.lightPink?t.lightPink:"#ffb2b2",green:t.green||"#690",lightGreen:t.lightGreen||"#fbfff0",blue:t.blue||"#47AFE8",lightBlue:t.lightBlue||"#eff8fd",orange:t.orange||"#FF9900",lightOrange:t.lightOrange||"#fff5e6",yellow:t.yellow||"#827717",lightYellow:t.lightYellow||"#fff5cc",purple:t.purple||"#786FF1",brown:t.brown||"#D4AC0D",fgPositive:"#38853C",bgPositive:"#DFF1E0",borderPositive:"#83D187",fgWarning:"#D56A00",bgWarning:"#FFEBD7",borderWarning:"#F5AE70",fgInfo:"#2978B5",bgInfo:"#DEECF7",borderInfo:"#7CBBEA",fgCritical:"#CC3D3D",bgCritical:"#F8E3E3",borderCritical:"#F49494",codeBg:t.codeBg||VF.color.opacity(VF.color.brightness(e,-15),.7),codeFg:t.codeFg||"#666",codePropertyColor:t.codePropertyColor||"#905",codeKeywordColor:t.codeKeywordColor||"#07a",codeOperatorColor:t.codeOperatorColor||"#9a6e3a"}}return D`
  <style>
  *, *:before, *:after { box-sizing: border-box; }
  ...
  :host {
    ...
    <!-- Header -->
    ${"false"===this.showHeader?"":MF.call(this)}

    <!-- Advanced Search -->
    ${"false"===this.allowAdvancedSearch?"":WF.call(this)}

    <div id='the-main-body' class="body ${this.cssClasses}" dir= ${this.pageDirection} >
      <!-- Side Nav -->
      ${"read"!==this.renderStyle&&"focused"!==this.renderStyle||"true"!==this.showSideNav||!this.resolvedSpec?"":_F.call(this)}
        ...
        <div class="main-content-inner--${this.renderStyle}-mode">
          ${!0===this.loading?D`<div class="loader"></div>`:D`
              ${!0===this.loadFailed?D`<div style="text-align: center;margin: 16px;"> Unable to load the Spec</div>`:D`
                  ...
                  ${"focused"===this.renderStyle?D`${LF.call(this)}`:D`
                      ${"true"===this.showInfo?EF.call(this):""}
                      <div id="operations-top" class="observe-me">
                        <slot name="operations-top"></slot>
                      </div>  
                      ${"read"===this.renderStyle?kF.call(this):UF.call(this,t,r,n)}
                    `}
                  </div>
                `}`}
        </div>
  ...
  `}function eL(e=!1){if(!this.resolvedSpec)return"";const t={bg1:GF(this.bgColor)?this.bgColor:"",fg1:GF(this.textColor)?this.textColor:"",headerColor:GF(this.headerColor)?this.headerColor:"",primaryColor:GF(this.primaryColor)?this.primaryColor:"",navBgColor:GF(this.navBgColor)?this.navBgColor:"",navTextColor:GF(this.navTextColor)?this.navTextColor:"",navHoverBgColor:GF(this.navHoverBgColor)?this.navHoverBgColor:"",navHoverTextColor:GF(this.navHoverTextColor)?this.navHoverTextColor:"",navAccentColor:GF(this.navAccentColor)?this.navAccentColor:""};return this.resolvedSpec.specLoadError?e?D`
        ${"dark"===this.theme?KF.call(this,"dark",t):KF.call(this,"light",t)}
        <div style="display:flex; align-items:center; border:1px dashed var(--border-color); height:42px; padding:5px; font-size:var(--font-size-small); color:var(--red); font-family:var(--font-mono)"> ${this.resolvedSpec.info.description} </div>
      `:D`
      ${"dark"===this.theme?KF.call(this,"dark",t):KF.call(this,"light",t)}
      <!-- Header -->
