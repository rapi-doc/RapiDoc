...
`:void 0}function rR(e){if(this.resolvedSpec.securitySchemes&&e){const t=[];return e.forEach((e=>{const r=[],n=[];0===Object.keys(e).length?t.push({securityTypes:"None",securityDefs:[]}):(Object.keys(e).forEach((t=>{let a="";const o=this.resolvedSpec.securitySchemes.find((e=>e.securitySchemeId===t));e[t]&&Array.isArray(e[t])&&(a=e[t].join(", ")),o&&(n.push(o.typeDisplay),r.push({...o,scopes:a}))})),t.push({securityTypes:n.length>1?`${n[0]} + ${n.length-1} more`:n[0],securityDefs:r}))})),D`<div style="position:absolute; top:3px; right:2px; font-size:var(--font-size-small); line-height: 1.5;">
  ...
  <div class="tab-panel col"
  ...
  </section>`}function aR(e){return D`
    ...
    `))}
  `}const oR={},iR=DP(class extends NP{constructor(){super(...arguments),this.nt=oR}render(e,t){return t()}update(e,[t,r]){if(Array.isArray(t)){if(Array.isArray(this.nt)&&this.nt.length===t.length&&t.every(((e,t)=>e===this.nt[t])))return N}else if(this.nt===t)return N;return this.nt=Array.isArray(t)?Array.from(t):t,this.render(t,r)}}),sR=l`
.border-top {
  border-top:1px solid var(--border-color);
}
.border{
...
`;customElements.define("schema-tree",class extends re{static get properties(){return{data:{type:Object},schemaExpandLevel:{type:Number,attribute:"schema-expand-level"},schemaDescriptionExpanded:{type:String,attribute:"schema-description-expanded"},allowSchemaDescriptionExpandToggle:{type:String,attribute:"allow-schema-description-expand-toggle"},schemaHideReadOnly:{type:String,attribute:"schema-hide-read-only"},schemaHideWriteOnly:{type:String,attribute:"schema-hide-write-only"}}}connectedCallback(){super.connectedCallback(),(!this.schemaExpandLevel||this.schemaExpandLevel<1)&&(this.schemaExpandLevel=99999),this.schemaDescriptionExpanded&&"true false".includes(this.schemaDescriptionExpanded)||(this.schemaDescriptionExpanded="false"),this.schemaHideReadOnly&&"true false".includes(this.schemaHideReadOnly)||(this.schemaHideReadOnly="true"),this.schemaHideWriteOnly&&"true false".includes(this.schemaHideWriteOnly)||(this.schemaHideWriteOnly="true")}static get styles(){return[He,$R,sR,l`
      ...
      <div class="tree ${"true"===this.schemaDescriptionExpanded?"expanded-descr":"collapsed-descr"}">
        ...
        ${null!==(r=this.data)&&void 0!==r&&r["::description"]?D`<span part="schema-description" class='m-markdown'> ${qP(Be(this.data["::description"]||""))}</span>`:""}
        ${this.data?D`
    ...
    `}generateTree(e,t="object",r="",n="",a="",o=0,i=0,s=""){var l;if("true"===this.schemaHideReadOnly){if("array"===t&&"readonly"===s)return;if(e&&"readonly"===e["::readwrite"])return}if("true"===this.schemaHideWriteOnly){if("array"===t&&"writeonly"===s)return;if(e&&"writeonly"===e["::readwrite"])return}if(!e)return D`<div class="null" style="display:inline;">
      ...
      `;const[g,v,b,x,w,k,$,S,A]=e.split("~|~");if("🆁"===v&&"true"===this.schemaHideReadOnly)return;if("🆆"===v&&"true"===this.schemaHideWriteOnly)return;const O=g.replace(/┃.*/g,"").replace(/[^a-zA-Z0-9+]/g,"").substring(0,4).toLowerCase();let E="",T="";return"array"===t?"readonly"===s?(E="🆁",T="Read-Only"):"writeonly"===s&&(E="🆆",T="Write-Only"):"🆁"===v?(E="🆁",T="Read-Only"):"🆆"===v&&(E="🆆",T="Write-Only"),D`
      <div class = "tr primitive" title="${A?"Deprecated":""}">
        ...
        <div class='td key-descr'>
          ${"array"===t?D`<span class="m-markdown-small">${qP(Be(a))}</span>`:""}
          ${$?D`<span class="m-markdown-small">
              ${qP(Be(`${S?`**${S}:**`:""} ${$} ${b||x||w||k?'<span class="more-content">⤵</span>':""}`))}
    ...
    <div class="request-card">
      ...
      `,o.forEach((e=>{let o,i=[];if(this.selectedRequestBodyType.includes("json")||this.selectedRequestBodyType.includes("xml")||this.selectedRequestBodyType.includes("text")||this.selectedRequestBodyType.includes("jose"))e.mimeType===this.selectedRequestBodyType&&(i=xR(e.schema,e.mimeType,e.examples,e.example,"true"===this.callback||"true"===this.webhook,"true"!==this.callback&&"true"!==this.webhook,"text",!1),this.selectedRequestBodyExample||(this.selectedRequestBodyExample=i.length>0?i[0].exampleId:""),a=D`
            ${a}
            <div class = 'example-panel border-top pad-top-8'>
              ...
              ${i.filter((e=>e.exampleId===this.selectedRequestBodyExample)).map((t=>D`
                <div class="example ${t.exampleId===this.selectedRequestBodyExample?"example-selected":""}" data-example = '${t.exampleId}'>
                  ...
                  ${t.exampleDescription?D`<div class="m-markdown-small" style="padding: 4px 0"> ${qP(Be(t.exampleDescription||""))} </div>`:""}
          ...
          `);(e.mimeType.includes("json")||e.mimeType.includes("xml")||e.mimeType.includes("text")||this.selectedRequestBodyType.includes("jose"))&&(o=bR(e.schema,{}),"table"===this.schemaStyle?n=D`
            ${n}
            <schema-table
      ...
      <div class='request-body-container' data-selected-request-body-type="${this.selectedRequestBodyType}">
        ...
        ${this.request_body.description?D`<div class="m-markdown" style="margin-bottom:12px">${qP(Be(this.request_body.description))}</div>`:""}
    ...
    `}formDataParamAsObjectTemplate(e,t,r){var n;const a=bR(t,{}),o=xR(t,"json",t.examples,t.example,"true"===this.callback||"true"===this.webhook,"true"!==this.callback&&"true"!==this.webhook,"text",!1);return D`
    ...
    `}formDataTemplate(e,t,r=""){const n=[];if(e.properties){for(const r in e.properties){var a,o;const i=e.properties[r];if(i.readOnly)continue;const s=i.examples||i.example||"",l=i.type,c=lR(i),p="read focused".includes(this.renderStyle)?"200px":"160px",d=pR(c.examples||c.example,c.type);n.push(D`
      ...
      <textarea
        ...
        style="width:100%"
      ></textarea>
      ${e.description?D`<span class="m-markdown-small">${qP(Be(e.description))}</span>`:""}
      ...
      <div class="tab-panel col" style="border-width:0 0 1px 0;">
        ...
        ${this.responseIsBlob?D`
            ...
            <div class="tab-content col m-markdown" style="flex:1; display:${"response"===this.activeResponseTab?"flex":"none"};" >
              ...
              <pre style="white-space:pre; min-height:50px; height:400px; resize:vertical; overflow:auto">${e?D`<code>${qP(Me().highlight(this.responseText,Me().languages[e],e))}</code>`:`${this.responseText}`}</pre>
            </div>`}
    ...
    `}generateTree(e,t="object",r="",n="",a="",o=0,i=0,s=""){var l,c;if("true"===this.schemaHideReadOnly){if("array"===t&&"readonly"===s)return;if(e&&"readonly"===e["::readwrite"])return}if("true"===this.schemaHideWriteOnly){if("array"===t&&"writeonly"===s)return;if(e&&"writeonly"===e["::readwrite"])return}if(!e)return D`<div class="null" style="display:inline;">
        ...
        <span class="key-label xxx-of-key"> ${n.replace("::OPTION~","")}</span>
        ${"array"===t?D`<span class='mono-font'> [ ] </span>`:"object"===t?D`<span class='mono-font'> { } </span>`:D`<span class='mono-font'> schema undefined </span>`}
      </div>`;const p=null!==(l=e["::type"])&&void 0!==l&&l.startsWith("xxx-of")?o:o+1,d="xxx-of-option"===t||"xxx-of-option"===e["::type"]||n.startsWith("::OPTION")?i:i+1,u=16*d;if(0===Object.keys(e).length)return D`<span class="td key object" style='padding-left:${u}px'>${n}</span>`;let h="",f="",m=!1;if(n.startsWith("::ONE~OF")||n.startsWith("::ANY~OF"))h=n.replace("::","").replace("~"," "),m=!0;else if(n.startsWith("::OPTION")){const e=n.split("~");h=e[1],f=e[2]}else h=n;let y="";if("object"===e["::type"]?y="array"===t?"array of object":"object":"array"===e["::type"]&&(y="array"===t?"array of array "+("object"!==r?`of ${r}`:""):"array"),"object"==typeof e)return D`
        ${p>=0&&n?D`
        ...
        ${Array.isArray(e)&&e[0]?D`${this.generateTree(e[0],"xxx-of-option","","::ARRAY~OF","",p,d,"")}`:D`
          ...
          `}
        <div>
      `;const[g,v,b,x,w,k,$,S,A]=e.split("~|~");if("🆁"===v&&"true"===this.schemaHideReadOnly)return;if("🆆"===v&&"true"===this.schemaHideWriteOnly)return;const O=g.replace(/┃.*/g,"").replace(/[^a-zA-Z0-9+]/g,"").substring(0,4).toLowerCase();let E="";return E="array"===t?D` 
    ...
    `}toggleObjectExpand(e){const t=e.target.closest(".tr");t.classList.contains("expanded")?(t.classList.add("collapsed"),t.classList.remove("expanded"),e.target.innerText="+"):(t.classList.remove("collapsed"),t.classList.add("expanded"),e.target.innerText="-")}});function SR(e){var t,r;const n=null!==(t=null==e?void 0:e.width)&&void 0!==t?t:20,a=null!==(r=null==e?void 0:e.height)&&void 0!==r?r:20;return D`
  ...
  `}customElements.define("api-response",class extends re{constructor(){super(),this.selectedStatus="",this.headersForEachRespStatus={},this.mimeResponsesForEachStatus={},this.activeSchemaTab="schema"}static get properties(){return{callback:{type:String},webhook:{type:String},responses:{type:Object},parser:{type:Object},schemaStyle:{type:String,attribute:"schema-style"},renderStyle:{type:String,attribute:"render-style"},selectedStatus:{type:String,attribute:"selected-status"},selectedMimeType:{type:String,attribute:"selected-mime-type"},activeSchemaTab:{type:String,attribute:"active-schema-tab"},schemaExpandLevel:{type:Number,attribute:"schema-expand-level"},schemaDescriptionExpanded:{type:String,attribute:"schema-description-expanded"},allowSchemaDescriptionExpandToggle:{type:String,attribute:"allow-schema-description-expand-toggle"},schemaHideReadOnly:{type:String,attribute:"schema-hide-read-only"},schemaHideWriteOnly:{type:String,attribute:"schema-hide-write-only"}}}static get styles(){return[He,Ve,Ye,Ge,We,sR,l`
    ...
    `}responseHeaderListTemplate(e){return D`
      ...
      ${1===e.examples.length?D`
          ${"json"===e.examples[0].exampleFormat?D`
              ...
              ${e.examples[0].exampleDescription?D`<div class="m-markdown-small" style="padding: 4px 0"> ${qP(Be(e.examples[0].exampleDescription||""))} </div>`:""}
              <json-tree 
                render-style = '${this.renderStyle}'
    ...
    `:D`
      ...
      `}});class AR extends re{constructor(e,t){super(),this.active=!0,this.message=null!=t?t:"",this.tone=null!=e?e:"positive",this.tones={info:{borderColor:l`#7CBBEA`,bgColor:l`#DEECF7`,icon:SR},positive:{borderColor:l`#83D187`,bgColor:l`#DFF1E0`,icon:SR},warning:{borderColor:l`#F5AE70`,bgColor:l`#FFEBD7`,icon:SR},critical:{borderColor:l`#F49494`,bgColor:l`#F8E3E3`,icon:SR}}}firstUpdated(){const e=e=>{this.renderRoot.querySelectorAll(".toast-active").length>0&&"fadeOut"===e.animationName&&this.onClose()};this.renderRoot.getElementById("toast").addEventListener("animationend",e),this.renderRoot.getElementById("toast").addEventListener("webkitAnimationEnd",e)}onClose(){this.active=!1;this.dispatchEvent(new CustomEvent("closed-toast",{detail:"closed toast",bubbles:!0,composed:!0}))}render(){return D`
            <output role="status" class="toast${this.active?"-active":""}" id="toast"
                ...
                <div class="close-button" @click="${this.onClose}">
                    ${function(e){var t,r;const n=null!==(t=null==e?void 0:e.width)&&void 0!==t?t:20,a=null!==(r=null==e?void 0:e.height)&&void 0!==r?r:20;return D`
    <svg width=${n} height=${a} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`}
        ...
        `;var e}static get styles(){return[l`
          ...
          `]}}function jR(e){const t=new Be.Renderer;return t.heading=(t,r,n,a)=>`<h${r} class="observe-me" id="${e}--${a.slug(n)}">${t}</h${r}>`,t}function _R(e,t=""){var r,n,a;const o=new Set;for(const t in e.responses)for(const r in null===(i=e.responses[t])||void 0===i?void 0:i.content){var i;o.add(r.trim())}const s=[...o].join(", "),l=this.resolvedSpec.securitySchemes.filter((t=>{var r;return t.finalKeyValue&&(null===(r=e.security)||void 0===r?void 0:r.some((e=>t.securitySchemeId in e)))}))||[],c=this.resolvedSpec.securitySchemes.find((e=>e.securitySchemeId===tt&&"-"!==e.value));c&&l.push(c);const p=e.xCodeSamples?nR.call(this,e.xCodeSamples):"";return D`
    ...
    <div class='expanded-endpoint-body observe-me ${e.method} ${e.deprecated?"deprecated":""} ' part="section-operation ${e.elementId}" id='${e.elementId}'>
      ...
      ${e.description?D`<div class="m-markdown"> ${qP(Be(e.description))}</div>`:""}
  ...
  `}function IR(){return this.resolvedSpec?D`
  ${this.resolvedSpec.tags.map((e=>D`
    <section id="${e.elementId}" part="section-tag" class="regular-font section-gap--read-mode observe-me" style="border-top:1px solid var(--primary-color);">
      ...
      ${qP(`\n          <div class="m-markdown regular-font">\n          ${Be(e.description||"","true"===this.infoDescriptionHeadingsInNavBar?{renderer:jR(e.elementId)}:void 0)}\n        </div>`)}
      </div>
    </section>
    <section class='regular-font section-gap--read-mode' part="section-operations-in-tag">
      ${e.paths.map((e=>_R.call(this,e,"BBB")))}
    </section>
    `))}
`:""}function PR(e){return D`
  ...
  ${"table"===this.schemaStyle?D`
      ...
      <schema-tree
        ...
        exportparts = "schema-description:schema-description, schema-multiline-toggle:schema-multiline-toggle"
      > </schema-tree>`}
  </div>`}function RR(e,t){return-1!==e.id.indexOf("schemas-")?PR.call(this,e):D`
  <div class='divider'></div>
  <div class='expanded-endpoint-body observe-me ${e.name}' id='cmp--${e.id}' >
    ${D`
  ...
  `}function LR(){return this.resolvedSpec?D`
  ${this.resolvedSpec.components.map((e=>D`
    ...
    `))}
`:""}function FR(){const e=new Be.Renderer;return e.heading=(e,t,r,n)=>`<h${t} class="observe-me" id="overview--${n.slug(r)}">${e}</h${t}>`,e}function DR(){var e,t,r,n;return D`
    <section id="overview" part="section-overview"
      ...
      ${null!==(e=this.resolvedSpec)&&void 0!==e&&e.info?D`
          ...
          ${this.resolvedSpec.info.description?D`${qP(`\n                <div class="m-markdown regular-font">\n                ${Be(this.resolvedSpec.info.description,"true"===this.infoDescriptionHeadingsInNavBar?{renderer:FR()}:void 0)}\n              </div>`)}`:""}
          </div>
        `:""}
    </section>
  `}function NR(e){var t;const r=null===(t=this.resolvedSpec)||void 0===t?void 0:t.servers.find((t=>t.url===e));return!!r&&(this.selectedServer=r,this.requestUpdate(),this.dispatchEvent(new CustomEvent("api-server-change",{bubbles:!0,composed:!0,detail:{selectedServer:r}})),!0)}function zR(e,t){const r=[...e.currentTarget.closest("table").querySelectorAll("input, select")];let n=t.url;r.forEach((e=>{const t=new RegExp(`{${e.dataset.var}}`,"g");n=n.replace(t,e.value)})),t.computedUrl=n,this.requestUpdate()}function qR(){return this.selectedServer&&this.selectedServer.variables?D`
      ...
      ${Object.entries(this.selectedServer.variables).map((e=>D`
        <tr>
          ...
          <td>
            ...
            <select
              data-var = "${e[0]}"
              @input = ${e=>{zR.call(this,e,this.selectedServer)}}
            >
        ...
        ${e[1].description?D`<tr><td colspan="2" style="border:none"><span class="m-markdown-small"> ${qP(Be(e[1].description))} </span></td></tr>`:""}
      `))}
    </table>
    `:""}function BR(){var e,t,r;return!this.resolvedSpec||this.resolvedSpec.specLoadError?"":D`
...
`}function VR(e){const t=new Be.Renderer;return t.heading=(t,r,n,a)=>`<h${r} class="observe-me" id="${e}--${a.slug(n)}">${t}</h${r}>`,t}function GR(e){return D`
    <div class='regular-font section-gap--focused-mode' part="section-operations-in-tag">
      ${e}
    </div>`}function KR(){var e;if("true"===this.showInfo)return GR(DR.call(this));const t=this.resolvedSpec.tags[0],r=null===(e=this.resolvedSpec.tags[0])||void 0===e?void 0:e.paths[0];return GR(t&&r?_R.call(this,r,t.name):"")}function JR(e){return D`
    <h1 id="${e.elementId}">${e.name}</h1>
    ${"show-description"===this.onNavTagClick&&e.description?D`
        <div class="m-markdown">
          ${qP(`\n            <div class="m-markdown regular-font">\n              ${Be(e.description||"","true"===this.infoDescriptionHeadingsInNavBar?{renderer:VR(e.elementId)}:void 0)}\n            </div>`)}
        </div>`:""}
  `}function YR(){if(!this.focusedElementId||!this.resolvedSpec)return;const e=this.focusedElementId;let t,r=null,n=null,a=0;if(e.startsWith("overview")&&"true"===this.showInfo)t=DR.call(this);else if("auth"===e&&"true"===this.allowAuthentication)t=tR.call(this);else if("servers"===e&&"true"===this.allowServerSelection)t=BR.call(this);else if("operations-top"===e)t=D`
    <div id="operations-top" class="observe-me">
      <slot name="operations-top"></slot>
    </div>`;else if(e.startsWith("cmp--")&&"true"===this.showComponents)t=LR.call(this);else if(e.startsWith("tag--")){const r=e.indexOf("--",4)>0?e.substring(0,e.indexOf("--",5)):e;n=this.resolvedSpec.tags.find((e=>e.elementId===r)),t=n?GR.call(this,JR.call(this,n)):KR.call(this)}else{for(a=0;a<this.resolvedSpec.tags.length&&(n=this.resolvedSpec.tags[a],r=this.resolvedSpec.tags[a].paths.find((t=>`${t.elementId}`===e)),!r);a+=1);if(r){UR(this.shadowRoot.getElementById(`link-${e}`),"expand"),t=GR.call(this,_R.call(this,r,n.name))}else t=KR.call(this)}return t}function ZR(e){if(e.expanded)e.expanded=!1,"true"===this.updateRoute&&window.history.replaceState(null,null,`${window.location.href.split("#")[0]}${"#"===this.routePrefix?"":`${this.routePrefix}`}`);else if(e.expanded=!0,"true"===this.updateRoute){const t=`${this.routePrefix||"#"}${e.elementId}`;window.location.hash!==t&&window.history.replaceState(null,null,`${window.location.href.split("#")[0]}${t}`)}this.requestUpdate()}function QR(e,t="expand-all"){const r=[...e.querySelectorAll(".section-tag")];"expand-all"===t?r.map((e=>{e.classList.replace("collapsed","expanded")})):r.map((e=>{e.classList.replace("expanded","collapsed")}))}function XR(e,t="expand-all"){QR.call(this,e.target.closest(".operations-root"),t)}function eL(e,t=!1){return D`
  ...
  <div part="section-endpoint-body-${e.expanded?"expanded":"collapsed"}" class='endpoint-body ${e.method} ${e.deprecated?"deprecated":""}'>
    <div class="summary">
      ...
      ${e.description?D`<div part="section-endpoint-body-description" class="m-markdown"> ${qP(Be(e.description))}</div>`:""}
      <slot name="${e.elementId}"></slot>
      ${rR.call(this,e.security)}
      ${s}
    </div>  
  ...
  </div>`}function rL(e=!0,t=!0,r=!1){return this.resolvedSpec?D`
    ${e?D`
...
`}
    ...
    </header>`;var e}!function(e,t,r){t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r}(CR,"properties",{id:{type:String},content:{type:String},copied:{type:Boolean},showButton:{type:Boolean},showToast:{type:Boolean}}),customElements.define("content-copy-button",CR);const aL=l`
  *, *:before, *:after { box-sizing: border-box; }
...
`;function oL(){var e;return document.addEventListener("close",(()=>{this.showAdvancedSearchDialog=!1})),document.addEventListener("open",this.onOpenSearchDialog),D`
    <dialog-box 
      heading="Search" 
  ...
  *, *:before, *:after { box-sizing: border-box; }
        ...
        <div class="main-content-inner--${this.renderStyle}-mode">
          ${!0===this.loading?D`<div class="loader"></div>`:D`
              ${!0===this.loadFailed?D`<div style="text-align: center;margin: 16px;"> Unable to load the Spec</div>`:D`
                  ...
                  ${"focused"===this.renderStyle?D`${YR.call(this)}`:D`
                      ${"true"===this.showInfo?DR.call(this):""}
                      ${"true"===this.allowServerSelection?BR.call(this):""}
  ...
  `}function hL(){return D`
    ${"true"===this.showInfo?DR.call(this):""}
    <div style="font-size:var(--font-size-regular);">
    ${this.resolvedSpec.schemaAndExamples.map((e=>{var t;const r=xR(e.schema,"json",e.examples,e.example,!0,!1,"json",!0);return e.selectedExample=null===(t=r[0])||void 0===t?void 0:t.exampleId,D`
