...
`:""}function KI(){const e=new We.Renderer;return e.heading=(e,t,r,n)=>`<h${t} class="observe-me" id="overview--${n.slug(r)}">${e}</h${t}>`,e}function JI(){var e,t,r,n;return z`
  ...
  <nav class='nav-bar ${this.renderStyle}' part="section-navbar">
    ...
    ${"false"===this.allowSearch&&"false"===this.allowAdvancedSearch?"":z`
      ...
      `}
    ${z`<nav class='nav-scroll' tabindex="-1" part="section-navbar-scroll" @click='${e=>tR.call(this,e)}' @keyup='${e=>tR.call(this,e)}' >
      ${"false"!==this.showInfo&&this.resolvedSpec.info?z`
          ${"true"===this.infoDescriptionHeadingsInNavBar?z`
              ${this.resolvedSpec.infoDescriptionHeaders.length>0?z`<div class='nav-bar-info' id='link-overview' data-content-id='overview' data-action='navigate' tabindex='0'> 
            ...
            `:z`<div class='nav-bar-info' id='link-overview' data-action='navigate' data-content-id='overview' tabindex='0'> 
            ${(null===(r=this.resolvedSpec.info)||void 0===r||null===(n=r.title)||void 0===n?void 0:n.trim())||"Overview"} 
              </div>`}
        `:""}
    
      ${"false"===this.allowServerSelection?"":z`<div class='nav-bar-info' id='link-servers' data-action='navigate' data-content-id='servers' tabindex='0'> API Servers </div>`}
      ${"false"!==this.allowAuthentication&&this.resolvedSpec.securitySchemes?z`<div class='nav-bar-info' id='link-auth' data-action='navigate' data-content-id='auth' tabindex='0' > Authentication </div>`:""}
...
`}function nR(e){const t=new We.Renderer;return t.heading=(t,r,n,a)=>`<h${r} class="observe-me" id="${e}--${a.slug(n)}">${t}</h${r}>`,t}function aR(e){return z`
    <div class='regular-font section-gap--focused-mode' part="section-operations-in-tag">
      ${e}
    </div>`}function oR(){var e;if("true"===this.showInfo)return aR(JI.call(this));const t=this.resolvedSpec.tags[0],r=null===(e=this.resolvedSpec.tags[0])||void 0===e?void 0:e.paths[0];return aR(t&&r?MI.call(this,r,t.name):"")}function iR(e){return z`
  ...
  `}function sR(){if(!this.focusedElementId||!this.resolvedSpec)return;const e=this.focusedElementId;let t,r=null,n=null,a=0;if(e.startsWith("overview")&&"true"===this.showInfo)t=JI.call(this);else if("auth"===e&&"true"===this.allowAuthentication)t=uI.call(this);else if("servers"===e&&"true"===this.allowServerSelection)t=XI.call(this);else if("operations-top"===e)t=z`
    <div id="operations-top" class="observe-me">
      <slot name="operations-top"></slot>
    </div>`;else if(e.startsWith("cmp--")&&"true"===this.showComponents)t=GI.call(this);else if(e.startsWith("tag--")){const r=e.indexOf("--",4)>0?e.substring(0,e.indexOf("--",5)):e;n=this.resolvedSpec.tags.find((e=>e.elementId===r)),t=n?aR.call(this,iR.call(this,n)):oR.call(this)}else{for(a=0;a<this.resolvedSpec.tags.length&&(n=this.resolvedSpec.tags[a],r=this.resolvedSpec.tags[a].paths.find((t=>`${t.elementId}`===e)),!r);a+=1);if(r){eR(this.shadowRoot.getElementById(`link-${e}`),"expand"),t=aR.call(this,MI.call(this,r,n.name||"",n.description||""))}else t=oR.call(this)}return t}function lR(e){if(e.expanded)e.expanded=!1,"true"===this.updateRoute&&window.history.replaceState(null,null,`${window.location.href.split("#")[0]}${"#"===this.routePrefix?"":`${this.routePrefix}`}`);else if(e.expanded=!0,"true"===this.updateRoute){const t=`${this.routePrefix||"#"}${e.elementId}`;window.location.hash!==t&&window.history.replaceState(null,null,`${window.location.href.split("#")[0]}${t}`)}this.requestUpdate()}function cR(e,t="expand-all"){const r=[...e.querySelectorAll(".section-tag")];"expand-all"===t?r.map((e=>{e.classList.replace("collapsed","expanded")})):r.map((e=>{e.classList.replace("expanded","collapsed")}))}function pR(e,t="expand-all"){cR.call(this,e.target.closest(".operations-root"),t)}function dR(e,t=!1){return z`
          ...
          ${!0===this.loading?z`<div class="loader"></div>`:z`
              ${!0===this.loadFailed?z`<div style="text-align: center;margin: 16px;"> Unable to load the Spec</div>`:z`
                  ...
                  ${"focused"===this.renderStyle?z`${sR.call(this)}`:z`
                      ...
                      ${"read"===this.renderStyle?HI.call(this):hR.call(this,t,r,n)}
                    `}
                  </div>
                `}`}
        </div>
