...
`;customElements.define("schema-tree",class extends ie{static get properties(){return{data:{type:Object},schemaExpandLevel:{type:Number,attribute:"schema-expand-level"},schemaDescriptionExpanded:{type:String,attribute:"schema-description-expanded"},allowSchemaDescriptionExpandToggle:{type:String,attribute:"allow-schema-description-expand-toggle"},schemaHideReadOnly:{type:String,attribute:"schema-hide-read-only"},schemaHideWriteOnly:{type:String,attribute:"schema-hide-write-only"}}}connectedCallback(){super.connectedCallback(),(!this.schemaExpandLevel||this.schemaExpandLevel<1)&&(this.schemaExpandLevel=99999),this.schemaDescriptionExpanded&&"true false".includes(this.schemaDescriptionExpanded)||(this.schemaDescriptionExpanded="false"),this.schemaHideReadOnly&&"true false".includes(this.schemaHideReadOnly)||(this.schemaHideReadOnly="true"),this.schemaHideWriteOnly&&"true false".includes(this.schemaHideWriteOnly)||(this.schemaHideWriteOnly="true")}static get styles(){return[Ke,zI,kI,c`
    ...
    `}formDataTemplate(e,t,r=""){const n=[];if(e.properties){for(const r in e.properties){var a,o;const i=e.properties[r];if(i.readOnly)continue;const s=i.examples||i.example||"",l=i.type,c=AI(i),p="read focused".includes(this.renderStyle)?"200px":"160px",d=EI(c.examples||c.example,c.type);n.push(z`
    ...
    `}toggleObjectExpand(e){const t=e.target.closest(".tr");t.classList.contains("expanded")?(t.classList.add("collapsed"),t.classList.remove("expanded"),e.target.innerText="+"):(t.classList.remove("collapsed"),t.classList.add("expanded"),e.target.innerText="-")}});function UI(e){const t=new We.Renderer;return t.heading=(t,r,n,a)=>`<h${r} class="observe-me" id="${e}--${a.slug(n)}">${t}</h${r}>`,t}function BI(e,t=""){var r,n,a,o,i,s,l,c,p;const d=new Set;for(const t in e.responses)for(const r in null===(u=e.responses[t])||void 0===u?void 0:u.content){var u;d.add(r.trim())}const h=[...d].join(", "),f=this.resolvedSpec.securitySchemes.filter((t=>{var r;return t.finalKeyValue&&(null===(r=e.security)||void 0===r?void 0:r.some((e=>t.securitySchemeId in e)))}))||[],m=this.resolvedSpec.securitySchemes.find((e=>e.securitySchemeId===ot&&"-"!==e.value));m&&f.push(m);const y=e.xCodeSamples?fI.call(this,e.xCodeSamples):"";return z`
    ...
    <div class='expanded-endpoint-body observe-me ${e.method} ${e.deprecated?"deprecated":""} ' part="section-operation ${e.elementId}" id='${e.elementId}'>
      ...
      ${null!==(n=e.externalDocs)&&void 0!==n&&n.url||null!==(a=e.externalDocs)&&void 0!==a&&a.description?z`<div style="background-color:var(--bg3); padding:2px 8px 8px 8px; margin:8px 0; border-radius:var(--border-radius)"> 
            <div class="m-markdown"> ${QP(We((null===(o=e.externalDocs)||void 0===o?void 0:o.description)||""))} </div>
            ${null!==(i=e.externalDocs)&&void 0!==i&&i.url?z`<div> <a href="${null===(s=e.externalDocs)||void 0===s?void 0:s.url}"> 
                  ${null===(l=e.externalDocs)||void 0===l?void 0:l.url} <div style="transform: rotate(270deg) scale(1.5); display: inline-block; margin-left:5px">⇲</div>
                </a> </div>`:""}
          </div>`:""}
      ...
      <div class='expanded-req-resp-container'>
        <api-request
          ...
          .api_keys = "${f}"
          .servers = "${e.servers}"
          server-url = "${(null===(c=e.servers)||void 0===c||null===(p=c[0])||void 0===p?void 0:p.url)||this.selectedServer.computedUrl}"
          fill-request-fields-with-example = "${this.fillRequestFieldsWithExample}"
  ...
  `}function MI(){return this.resolvedSpec?z`
  ${this.resolvedSpec.tags.map((e=>z`
    ...
    <section class="regular-font section-gap--read-mode" part="section-operations-in-tag">
      ${e.paths.map((e=>BI.call(this,e,"BBB")))}
    </section>
    `))}
`:""}function HI(e){return z`
  ...
  ${"table"===this.schemaStyle?z`
      ...
      <schema-tree
        ...
        exportparts = "schema-description:schema-description, schema-multiline-toggle:schema-multiline-toggle"
      > </schema-tree>`}
  </div>`}function WI(e,t){return-1!==e.id.indexOf("schemas-")?HI.call(this,e):z`
  <div class='divider'></div>
  <div class='expanded-endpoint-body observe-me ${e.name}' id='cmp--${e.id}' >
    ${z`
  ...
  `}function VI(){return this.resolvedSpec?z`
  ${this.resolvedSpec.components.map((e=>z`
    ...
    <div class='regular-font section-gap--read-mode'>
      ${e.subComponents.filter((e=>!1!==e.expanded)).map((t=>WI.call(this,t,e.name)))}
    </div>
    `))}
`:""}function GI(){const e=new We.Renderer;return e.heading=(e,t,r,n)=>`<h${t} class="observe-me" id="overview--${n.slug(r)}">${e}</h${t}>`,e}function KI(){var e,t,r,n;return z`
    <section id="overview" part="section-overview"
      ...
      ${null!==(e=this.resolvedSpec)&&void 0!==e&&e.info?z`
          ...
          ${this.resolvedSpec.info.description?z`${QP(`\n                <div class="m-markdown regular-font">\n                ${We(this.resolvedSpec.info.description,"true"===this.infoDescriptionHeadingsInNavBar?{renderer:GI()}:void 0)}\n              </div>`)}`:""}
          </div>
        `:""}
    </section>
  `}function JI(e){var t;const r=null===(t=this.resolvedSpec)||void 0===t?void 0:t.servers.find((t=>t.url===e));return!!r&&(this.selectedServer=r,this.requestUpdate(),this.dispatchEvent(new CustomEvent("api-server-change",{bubbles:!0,composed:!0,detail:{selectedServer:r}})),!0)}function YI(e,t){const r=[...e.currentTarget.closest("table").querySelectorAll("input, select")];let n=t.url;r.forEach((e=>{const t=new RegExp(`{${e.dataset.var}}`,"g");n=n.replace(t,e.value)})),t.computedUrl=n,this.requestUpdate()}function ZI(){return this.selectedServer&&this.selectedServer.variables?z`
      ...
      ${Object.entries(this.selectedServer.variables).map((e=>z`
        <tr>
          ...
          <td>
            ...
            <select
              data-var = "${e[0]}"
              @input = ${e=>{YI.call(this,e,this.selectedServer)}}
            >
    ...
    `:""}function QI(){var e,t,r;return!this.resolvedSpec||this.resolvedSpec.specLoadError?"":z`
  <section id = 'servers' part="section-servers" style="text-align:left; direction:ltr; margin-top:24px; margin-bottom:24px;" class='regular-font observe-me ${"read focused".includes(this.renderStyle)?"section-gap--read-mode":"section-gap"}'>
    ...
    ${ZI.call(this)}
  </section>`}function XI(e,t="toggle"){const r=null==e?void 0:e.closest(".nav-bar-tag-and-paths");if(r){const e=r.classList.contains("expanded");!e||"toggle"!==t&&"collapse"!==t?e||"toggle"!==t&&"expand"!==t||r.classList.replace("collapsed","expanded"):r.classList.replace("expanded","collapsed")}}function eR(e){XI(e.target,"toggle")}function tR(e,t="expand-all"){!function(e,t="expand-all"){const r=[...e.querySelectorAll(".nav-bar-tag-and-paths")];"expand-all"===t?r.map((e=>{e.classList.replace("collapsed","expanded")})):r.map((e=>{e.classList.replace("expanded","collapsed")}))}(e.target.closest(".nav-scroll"),t)}function rR(){var e,t,r,n;return!this.resolvedSpec||this.resolvedSpec.specLoadError?z`
      ...
      <div id='link-operations-top' class='nav-bar-section operations' data-content-id='operations-top' @click = '${e=>this.scrollToEventTarget(e,!1)}'>
        <div style="font-size:16px; display:flex; margin-left:10px;">
          ${"focused"===this.renderStyle?z`
              <div @click="${e=>{tR.call(this,e,"expand-all")}}" title="Expand all" style="transform: rotate(90deg); cursor:pointer; margin-right:10px;">▸</div>
              <div @click="${e=>{tR.call(this,e,"collapse-all")}}" title="Collapse all" style="transform: rotate(270deg); cursor:pointer;">▸</div>`:""}  
        </div>
          ...
          <div class='nav-bar-tag-and-paths ${e.expanded?"expanded":"collapsed"}'>
            ${"General ⦂"===e.name?z`<hr style="border:none; border-top: 1px dotted var(--nav-text-color); opacity:0.3; margin:-1px 0 0 0;"/>`:z`
                <div 
                  ...
                  @click='${e=>{"focused"===this.renderStyle&&"expand-collapse"===this.onNavTagClick?eR.call(this,e):this.scrollToEventTarget(e,!1)}}'
                >
                  <div>${e.name}</div>
                  <div class="nav-bar-tag-icon" @click="${e=>{"focused"===this.renderStyle&&"show-description"===this.onNavTagClick&&eR.call(this,e)}}">
                  </div>
                </div>
              `}
            ${"true"===this.infoDescriptionHeadingsInNavBar?z`
...
`}function nR(e){const t=new We.Renderer;return t.heading=(t,r,n,a)=>`<h${r} class="observe-me" id="${e}--${a.slug(n)}">${t}</h${r}>`,t}function aR(e){return z`
    <div class='regular-font section-gap--focused-mode' part="section-operations-in-tag">
      ${e}
    </div>`}function oR(){var e;if("true"===this.showInfo)return aR(KI.call(this));const t=this.resolvedSpec.tags[0],r=null===(e=this.resolvedSpec.tags[0])||void 0===e?void 0:e.paths[0];return aR(t&&r?BI.call(this,r,t.name):"")}function iR(e){return z`
  ...
  `}function sR(){if(!this.focusedElementId||!this.resolvedSpec)return;const e=this.focusedElementId;let t,r=null,n=null,a=0;if(e.startsWith("overview")&&"true"===this.showInfo)t=KI.call(this);else if("auth"===e&&"true"===this.allowAuthentication)t=uI.call(this);else if("servers"===e&&"true"===this.allowServerSelection)t=QI.call(this);else if("operations-top"===e)t=z`
    <div id="operations-top" class="observe-me">
      <slot name="operations-top"></slot>
    </div>`;else if(e.startsWith("cmp--")&&"true"===this.showComponents)t=VI.call(this);else if(e.startsWith("tag--")){const r=e.indexOf("--",4)>0?e.substring(0,e.indexOf("--",5)):e;n=this.resolvedSpec.tags.find((e=>e.elementId===r)),t=n?aR.call(this,iR.call(this,n)):oR.call(this)}else{for(a=0;a<this.resolvedSpec.tags.length&&(n=this.resolvedSpec.tags[a],r=this.resolvedSpec.tags[a].paths.find((t=>`${t.elementId}`===e)),!r);a+=1);if(r){XI(this.shadowRoot.getElementById(`link-${e}`),"expand"),t=aR.call(this,BI.call(this,r,n.name))}else t=oR.call(this)}return t}function lR(e){if(e.expanded)e.expanded=!1,"true"===this.updateRoute&&window.history.replaceState(null,null,`${window.location.href.split("#")[0]}${"#"===this.routePrefix?"":`${this.routePrefix}`}`);else if(e.expanded=!0,"true"===this.updateRoute){const t=`${this.routePrefix||"#"}${e.elementId}`;window.location.hash!==t&&window.history.replaceState(null,null,`${window.location.href.split("#")[0]}${t}`)}this.requestUpdate()}function cR(e,t="expand-all"){const r=[...e.querySelectorAll(".section-tag")];"expand-all"===t?r.map((e=>{e.classList.replace("collapsed","expanded")})):r.map((e=>{e.classList.replace("expanded","collapsed")}))}function pR(e,t="expand-all"){cR.call(this,e.target.closest(".operations-root"),t)}function dR(e,t=!1){return z`
  <summary @click="${t=>{lR.call(this,e,t)}}" part="section-endpoint-head-${e.expanded?"expanded":"collapsed"}" class='endpoint-head ${e.method} ${e.deprecated?"deprecated":""} ${t||e.expanded?"expanded":"collapsed"}'>
  ...
  <div part="section-endpoint-body-${e.expanded?"expanded":"collapsed"}" class='endpoint-body ${e.method} ${e.deprecated?"deprecated":""}'>
    <div class="summary">
      ...
      ${null!==(r=e.externalDocs)&&void 0!==r&&r.url||null!==(n=e.externalDocs)&&void 0!==n&&n.description?z`<div style="background-color:var(--bg3); padding:2px 8px 8px 8px; margin:8px 0; border-radius:var(--border-radius)"> 
            ...
            ${null!==(o=e.externalDocs)&&void 0!==o&&o.url?z`<div> <a href="${null===(i=e.externalDocs)||void 0===i?void 0:i.url}"> 
  ...
  </div>`}function hR(e=!0,t=!0,r=!1){return this.resolvedSpec?z`
    ${e?z`
        <div style="display:flex; justify-content:flex-end;"> 
          <span @click="${e=>pR(e,"expand-all")}" style="color:var(--primary-color); cursor:pointer;">
            Expand all
          </span> 
          &nbsp;|&nbsp; 
          <span @click="${e=>pR(e,"collapse-all")}" style="color:var(--primary-color); cursor:pointer;" >
            Collapse all
          </span> 
          &nbsp; sections
        </div>`:""}
...
`;function yR(){var e;return document.addEventListener("close",(()=>{this.showAdvancedSearchDialog=!1})),document.addEventListener("open",this.onOpenSearchDialog),z`
    <dialog-box 
      heading="Search" 
  ...
  *, *:before, *:after { box-sizing: border-box; }
  ...
  :host {
    ...
    <!-- Header -->
    ${"false"===this.showHeader?"":fR.call(this)}
    
    <!-- Advanced Search -->
    ${"false"===this.allowAdvancedSearch?"":yR.call(this)}

    <div id='the-main-body' class="body ${this.cssClasses}" dir= ${this.pageDirection} >
      <!-- Side Nav -->
      ${"read"!==this.renderStyle&&"focused"!==this.renderStyle||"true"!==this.showSideNav||!this.resolvedSpec?"":rR.call(this)}
        ...
        <div class="main-content-inner--${this.renderStyle}-mode">
          ${!0===this.loading?z`<div class="loader"></div>`:z`
              ${!0===this.loadFailed?z`<div style="text-align: center;margin: 16px;"> Unable to load the Spec</div>`:z`
                  ...
                  ${"focused"===this.renderStyle?z`${sR.call(this)}`:z`
                      ${"true"===this.showInfo?KI.call(this):""}
                      ${"true"===this.allowServerSelection?QI.call(this):""}
                      ${"true"===this.allowAuthentication?uI.call(this):""}
                      <div id="operations-top" class="observe-me">
                        <slot name="operations-top"></slot>
                      </div>  
                      ${"read"===this.renderStyle?MI.call(this):hR.call(this,t,r,n)}
                    `}
                  </div>
                `}`}
        </div>
  ...
  `}function AR(e=!1){if(!this.resolvedSpec)return"";const t={bg1:vR(this.bgColor)?this.bgColor:"",fg1:vR(this.textColor)?this.textColor:"",headerColor:vR(this.headerColor)?this.headerColor:"",primaryColor:vR(this.primaryColor)?this.primaryColor:"",navBgColor:vR(this.navBgColor)?this.navBgColor:"",navTextColor:vR(this.navTextColor)?this.navTextColor:"",navHoverBgColor:vR(this.navHoverBgColor)?this.navHoverBgColor:"",navHoverTextColor:vR(this.navHoverTextColor)?this.navHoverTextColor:"",navAccentColor:vR(this.navAccentColor)?this.navAccentColor:""};return this.resolvedSpec.specLoadError?e?z`
        ${"dark"===this.theme?bR.call(this,"dark",t):bR.call(this,"light",t)}
        <div style="display:flex; align-items:center; border:1px dashed var(--border-color); height:42px; padding:5px; font-size:var(--font-size-small); color:var(--red); font-family:var(--font-mono)"> ${this.resolvedSpec.info.description} </div>
      `:z`
      ${"dark"===this.theme?bR.call(this,"dark",t):bR.call(this,"light",t)}
      <!-- Header -->
