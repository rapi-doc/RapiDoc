    ...
    ${r.length>0?F`<span style="font-weight:bold">Example: </span>
      ...
      <div class="param-name ${r.deprecated?"deprecated":""}" >
        ...
        <div class="param-type">
          ...
          ${r.deprecated?F`<span style='color:#DC5A41;'>deprecated</span>`:""}
          ${r.required?F`<span style='color:#DC5A41;'>required</span>`:""}
        </div>
      </div>
