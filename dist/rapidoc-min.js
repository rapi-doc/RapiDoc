...
`}function YR(e){const t=new Be.Renderer;return t.heading=(t,r,n,a)=>`<h${r} class="observe-me" id="${e}--${a.slug(n)}">${t}</h${r}>`,t}function QR(e){return D`
    <div class='regular-font section-gap--focused-mode' part="section-operations-in-tag">
      ${e}
    </div>`}function XR(){var e;if("true"===this.showInfo)return QR(VR.call(this));const t=this.resolvedSpec.tags[0],r=null===(e=this.resolvedSpec.tags[0])||void 0===e?void 0:e.paths[0];return QR(t&&r?NR.call(this,r,t.name):"")}function eF(e){return D`
  ...
  `}function tF(){if(!this.focusedElementId||!this.resolvedSpec)return;const e=this.focusedElementId;let t,r=null,n=null,a=0;if(e.startsWith("overview")&&"true"===this.showInfo)t=VR.call(this);else if("auth"===e&&"true"===this.allowAuthentication)t=yR.call(this);else if("servers"===e&&"true"===this.allowServerSelection)t=CR.call(this);else if("operations-top"===e)t=D`
    <div id="operations-top" class="observe-me">
      <slot name="operations-top"></slot>
    </div>`;else if(e.startsWith("cmp--")&&"true"===this.showComponents)t=HR.call(this);else if(e.startsWith("tag--")){const r=e.indexOf("--",4)>0?e.substring(0,e.indexOf("--",5)):e;n=this.resolvedSpec.tags.find((e=>e.elementId===r)),t=n?QR.call(this,eF.call(this,n)):XR.call(this)}else{for(a=0;a<this.resolvedSpec.tags.length&&(n=this.resolvedSpec.tags[a],r=this.resolvedSpec.tags[a].paths.find((t=>`${t.elementId}`===e)),!r);a+=1);if(r){GR(this.shadowRoot.getElementById(`link-${e}`),"expand"),t=QR.call(this,NR.call(this,r,n.name))}else t=XR.call(this)}return t}function rF(e){if(e.expanded)e.expanded=!1,"true"===this.updateRoute&&window.history.replaceState(null,null,`${window.location.href.split("#")[0]}${"#"===this.routePrefix?"":`${this.routePrefix}`}`);else if(e.expanded=!0,"true"===this.updateRoute){const t=`${this.routePrefix||"#"}${e.elementId}`;window.location.hash!==t&&window.history.replaceState(null,null,`${window.location.href.split("#")[0]}${t}`)}this.requestUpdate()}function nF(e,t="expand-all"){const r=[...e.querySelectorAll(".section-tag")];"expand-all"===t?r.map((e=>{e.classList.replace("collapsed","expanded")})):r.map((e=>{e.classList.replace("expanded","collapsed")}))}function aF(e,t="expand-all"){nF.call(this,e.target.closest(".operations-root"),t)}function oF(e,t=!1){return D`
  <summary @click="${t=>{rF.call(this,e,t)}}" part="section-endpoint-head-${e.expanded?"expanded":"collapsed"}" class='endpoint-head ${e.method} ${e.deprecated?"deprecated":""} ${t||e.expanded?"expanded":"collapsed"}'>
  ...
  `}function iF(e){var t;const r=new Set;for(const t in e.responses)for(const a in null===(n=e.responses[t])||void 0===n?void 0:n.content){var n;r.add(a.trim())}const a=[...r].join(", "),o=this.resolvedSpec.securitySchemes.filter((t=>{var r;return t.finalKeyValue&&(null===(r=e.security)||void 0===r?void 0:r.some((e=>t.securitySchemeId in e)))}))||[],i=this.resolvedSpec.securitySchemes.find((e=>e.securitySchemeId===tt&&"-"!==e.value));i&&o.push(i);const s=e.xCodeSamples?bR(e.xCodeSamples):"";return e.description=zR(e.description),D`
  <style>
      .label-operation-container {
        text-align: left;
        direction: ltr;
  ...
  </div>`}function sF(e=!0,t=!0,r=!1){return this.resolvedSpec?D`
    ${e?D`
        <div style="display:flex; justify-content:flex-end;"> 
          <span @click="${e=>aF(e,"expand-all")}" style="color:var(--primary-color); cursor:pointer;">
            Expand all
          </span> 
          &nbsp;|&nbsp; 
          <span @click="${e=>aF(e,"collapse-all")}" style="color:var(--primary-color); cursor:pointer;" >
            Collapse all
          </span> 
          &nbsp; sections
        </div>`:""}
...
`}
    ...
    </header>`;var e}!function(e,t,r){t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r}(LR,"properties",{id:{type:String},content:{type:String},copied:{type:Boolean},showButton:{type:Boolean},showToast:{type:Boolean}}),customElements.define("content-copy-button",LR);const cF=l`
  *, *:before, *:after { box-sizing: border-box; }
...
`;function pF(){var e;return document.addEventListener("close",(()=>{this.showAdvancedSearchDialog=!1})),document.addEventListener("open",this.onOpenSearchDialog),D`
    <dialog-box 
      heading="Search" 
  ...
  `}customElements.define("dialog-box",class extends re{static get properties(){return{heading:{type:String,attribute:"heading"},show:{type:String,attribute:"show"}}}static get styles(){return[cF]}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",(e=>{"Escape"===e.code&&this.onClose()}))}attributeChangedCallback(e,t,r){t!==r&&("heading"===e&&(this.heading=r),"show"===e&&(this.show=r,"true"===r&&document.dispatchEvent(new CustomEvent("open",{bubbles:!0,composed:!0,detail:this})))),super.attributeChangedCallback(e,t,r)}render(){return D`
    ${"true"===this.show?D`
        ...
        </div>`:""}`}onClose(){document.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}});const dF={color:{inputReverseFg:"#fff",inputReverseBg:"#333",headerBg:"#444",getRgb(e){if(0===e.indexOf("#")&&(e=e.slice(1,7)),3!==e.length&&4!==e.length||(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),6!==e.length)throw new Error("Invalid HEX color.");return{r:parseInt(e.slice(0,2),16),g:parseInt(e.slice(2,4),16),b:parseInt(e.slice(4,6),16)}},luminanace(e){const t=this.getRgb(e);return.299*t.r+.587*t.g+.114*t.b},invert(e){return this.luminanace(e)>135?"#000":"#fff"},opacity(e,t){const r=this.getRgb(e);return`rgba(${r.r}, ${r.g}, ${r.b}, ${t})`},brightness(e,t){const r=this.getRgb(e);return r.r+=t,r.g+=t,r.b+=t,r.r>255?r.r=255:r.r<0&&(r.r=0),r.g>255?r.g=255:r.g<0&&(r.g=0),r.b>255?r.b=255:r.b<0&&(r.b=0),`#${r.r.toString(16).padStart(2,"0")}${r.g.toString(16).padStart(2,"0")}${r.b.toString(16).padStart(2,"0")}`},hasGoodContrast(e,t){return this.luminanace(e)-this.luminanace(t)}}};function uF(e){return/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3}|[A-Fa-f0-9]{8}|[A-Fa-f0-9]{4})$/i.test(e)}function hF(e,t={}){let r={};const n=t.primaryColor?t.primaryColor:"dark"===e?"#f76b39":"#ff591e",a=dF.color.invert(n),o=dF.color.opacity(n,"0.8");if("dark"===e){const e=t.bg1?t.bg1:"#2a2b2c",i=t.fg1?t.fg1:"#bbb",s=t.bg2?t.bg2:dF.color.brightness(e,5),l=t.bg3?t.bg3:dF.color.brightness(e,17),c=t.bg3?t.bg3:dF.color.brightness(e,35),p=t.fg2?t.fg2:dF.color.brightness(i,-15),d=t.fg3?t.fg3:dF.color.brightness(i,-20),u=t.fg3?t.fg3:dF.color.brightness(i,-65),h=t.inlineCodeFg?t.inlineCodeFg:"#aaa",f="#bbb",m="#eee",g=t.headerColor?t.headerColor:dF.color.brightness(e,10),y=t.navBgColor?t.navBgColor:dF.color.brightness(e,10);r={bg1:e,bg2:s,bg3:l,lightBg:c,fg1:i,fg2:p,fg3:d,lightFg:u,inlineCodeFg:h,primaryColor:n,primaryColorTrans:o,primaryColorInvert:a,selectionBg:f,selectionFg:m,overlayBg:"rgba(80, 80, 80, 0.4)",navBgColor:y,navTextColor:t.navTextColor?t.navTextColor:dF.color.opacity(dF.color.invert(y),"0.50"),navHoverBgColor:t.navHoverBgColor?t.navHoverBgColor:dF.color.brightness(y,-15),navHoverTextColor:t.navHoverTextColor?t.navHoverTextColor:dF.color.invert(y),navAccentColor:t.navAccentColor?t.navAccentColor:dF.color.brightness(n,25),headerColor:g,headerColorInvert:dF.color.invert(g),headerColorDarker:dF.color.brightness(g,-20),headerColorBorder:dF.color.brightness(g,10),borderColor:t.borderColor||dF.color.brightness(e,20),lightBorderColor:t.lightBorderColor||dF.color.brightness(e,15),codeBorderColor:t.codeBorderColor||dF.color.brightness(e,30),inputBg:t.inputBg||dF.color.brightness(e,-5),placeHolder:t.placeHolder||dF.color.opacity(i,"0.3"),hoverColor:t.hoverColor||dF.color.brightness(e,-10),red:t.red?t.red:"#F06560",lightRed:t.lightRed?t.lightRed:dF.color.brightness(e,-10),pink:t.pink?t.pink:"#ffb2b2",lightPink:t.lightPink||dF.color.brightness(e,-10),green:t.green||"#7ec699",lightGreen:t.lightGreen||dF.color.brightness(e,-10),blue:t.blue||"#71b7ff",lightBlue:t.lightBlue||dF.color.brightness(e,-10),orange:t.orange?t.orange:"#f08d49",lightOrange:t.lightOrange||dF.color.brightness(e,-10),yellow:t.yellow||"#827717",lightYellow:t.lightYellow||dF.color.brightness(e,-10),purple:t.purple||"#786FF1",brown:t.brown||"#D4AC0D",codeBg:t.codeBg||dF.color.opacity(dF.color.brightness(e,-15),.7),codeFg:t.codeFg||"#aaa",codePropertyColor:t.codePropertyColor||"#f8c555",codeKeywordColor:t.codeKeywordColor||"#cc99cd",codeOperatorColor:t.codeOperatorColor||"#67cdcc"}}else{const e=t.bg1?t.bg1:"#fafbfc",i=t.fg1?t.fg1:"#444444",s=t.bg2?t.bg2:dF.color.brightness(e,-5),l=t.bg3?t.bg3:dF.color.brightness(e,-15),c=t.bg3?t.bg3:dF.color.brightness(e,-45),p=t.fg2?t.fg2:"#545454",d=t.fg3?t.fg3:dF.color.brightness(i,30),u=t.fg3?t.fg3:dF.color.brightness(i,70),h=t.inlineCodeFg?t.inlineCodeFg:"brown",f="#444",m="#eee",g=t.headerColor?t.headerColor:dF.color.brightness(e,-180),y=t.navBgColor?t.navBgColor:dF.color.brightness(e,-200);r={bg1:e,bg2:s,bg3:l,lightBg:c,fg1:i,fg2:p,fg3:d,lightFg:u,inlineCodeFg:h,primaryColor:n,primaryColorTrans:o,primaryColorInvert:a,selectionBg:f,selectionFg:m,overlayBg:"rgba(0, 0, 0, 0.4)",navBgColor:y,navTextColor:t.navTextColor?t.navTextColor:dF.color.opacity(dF.color.invert(y),"0.65"),navHoverBgColor:t.navHoverBgColor?t.navHoverBgColor:dF.color.brightness(y,-15),navHoverTextColor:t.navHoverTextColor?t.navHoverTextColor:dF.color.invert(y),navAccentColor:t.navAccentColor?t.navAccentColor:dF.color.brightness(n,25),headerColor:g,headerColorInvert:dF.color.invert(g),headerColorDarker:dF.color.brightness(g,-20),headerColorBorder:dF.color.brightness(g,10),borderColor:t.borderColor||"#B9B9B9",lightBorderColor:t.lightBorderColor||dF.color.brightness(e,-23),codeBorderColor:t.codeBorderColor||"transparent",inputBg:t.inputBg||"rgba(255, 255, 255, 0.0001)",placeHolder:t.placeHolder||dF.color.brightness(u,20),hoverColor:t.hoverColor||dF.color.brightness(e,-5),red:t.red||"#F06560",lightRed:t.lightRed||"#fff0f0",pink:t.pink?t.pink:"#990055",lightPink:t.lightPink?t.lightPink:"#ffb2b2",green:t.green||"#690",lightGreen:t.lightGreen||"#fbfff0",blue:t.blue||"#47AFE8",lightBlue:t.lightBlue||"#eff8fd",orange:t.orange||"#FF9900",lightOrange:t.lightOrange||"#fff5e6",yellow:t.yellow||"#827717",lightYellow:t.lightYellow||"#fff5cc",purple:t.purple||"#786FF1",brown:t.brown||"#D4AC0D",fgPositive:"#38853C",bgPositive:"#DFF1E0",borderPositive:"#83D187",fgWarning:"#D56A00",bgWarning:"#FFEBD7",borderWarning:"#F5AE70",fgInfo:"#2978B5",bgInfo:"#DEECF7",borderInfo:"#7CBBEA",fgCritical:"#CC3D3D",bgCritical:"#F8E3E3",borderCritical:"#F49494",codeBg:t.codeBg||dF.color.opacity(dF.color.brightness(e,-15),.7),codeFg:t.codeFg||"#666",codePropertyColor:t.codePropertyColor||"#905",codeKeywordColor:t.codeKeywordColor||"#07a",codeOperatorColor:t.codeOperatorColor||"#9a6e3a"}}return D`
  <style>
  *, *:before, *:after { box-sizing: border-box; }
  ...
  :host {
  ...
  </style>`}function fF(e=!1,t=!0,r=!0,n=!1){if(!this.resolvedSpec)return"";"true"===this.persistAuth&&lR.call(this);const a={bg1:uF(this.bgColor)?this.bgColor:"",fg1:uF(this.textColor)?this.textColor:"",headerColor:uF(this.headerColor)?this.headerColor:"",primaryColor:uF(this.primaryColor)?this.primaryColor:"",navBgColor:uF(this.navBgColor)?this.navBgColor:"",navTextColor:uF(this.navTextColor)?this.navTextColor:"",navHoverBgColor:uF(this.navHoverBgColor)?this.navHoverBgColor:"",navHoverTextColor:uF(this.navHoverTextColor)?this.navHoverTextColor:"",navAccentColor:uF(this.navAccentColor)?this.navAccentColor:""};return this.resolvedSpec.specLoadError?e?D`
        ${"dark"===this.theme?hF.call(this,"dark",a):hF.call(this,"light",a)}
    ...
    <!-- Header -->
    ${"false"===this.showHeader?"":lF.call(this)}

    <!-- Advanced Search -->
    ${"false"===this.allowAdvancedSearch?"":pF.call(this)}
        ...
        <div class="main-content-inner--${this.renderStyle}-mode">
          ${!0===this.loading?D`<div class="loader"></div>`:D`
              ${!0===this.loadFailed?D`<div style="text-align: center;margin: 16px;"> Unable to load the Spec</div>`:D`
                  ...
                  ${"focused"===this.renderStyle?D`${tF.call(this)}`:D`
                      ${"true"===this.showInfo?VR.call(this):""}
                      <div id="operations-top" class="observe-me">
                        <slot name="operations-top"></slot>
                      </div>  
                      ${"read"===this.renderStyle?BR.call(this):sF.call(this,t,r,n)}
                    `}
                  </div>
                `}`}
        </div>
  ...
  `}function bF(e=!1){if(!this.resolvedSpec)return"";const t={bg1:uF(this.bgColor)?this.bgColor:"",fg1:uF(this.textColor)?this.textColor:"",headerColor:uF(this.headerColor)?this.headerColor:"",primaryColor:uF(this.primaryColor)?this.primaryColor:"",navBgColor:uF(this.navBgColor)?this.navBgColor:"",navTextColor:uF(this.navTextColor)?this.navTextColor:"",navHoverBgColor:uF(this.navHoverBgColor)?this.navHoverBgColor:"",navHoverTextColor:uF(this.navHoverTextColor)?this.navHoverTextColor:"",navAccentColor:uF(this.navAccentColor)?this.navAccentColor:""};return this.resolvedSpec.specLoadError?e?D`
        ${"dark"===this.theme?hF.call(this,"dark",t):hF.call(this,"light",t)}
        <div style="display:flex; align-items:center; border:1px dashed var(--border-color); height:42px; padding:5px; font-size:var(--font-size-small); color:var(--red); font-family:var(--font-mono)"> ${this.resolvedSpec.info.description} </div>
      `:D`
      ${"dark"===this.theme?hF.call(this,"dark",t):hF.call(this,"light",t)}
      <!-- Header -->
