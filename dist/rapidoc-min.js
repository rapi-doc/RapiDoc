...
`:void 0}function fP(e){var t;if((null===(t=this.resolvedSpec)||void 0===t?void 0:t.securitySchemes)&&e){const t=[];return Array.isArray(e)?0===e.length?"":(e.forEach((e=>{const r=[],n=[];0===Object.keys(e).length?t.push({securityTypes:"None",securityDefs:[]}):(Object.keys(e).forEach((t=>{var o,a;let i="";const s=null===(a=null===(o=this.resolvedSpec)||void 0===o?void 0:o.securitySchemes)||void 0===a?void 0:a.find((e=>e.securitySchemeId===t));e[t]&&Array.isArray(e[t])&&(i=e[t].join(", ")),s&&(n.push(s.typeDisplay),r.push({...s,scopes:i}))})),t.push({securityTypes:n.length>1?`${n[0]} + ${n.length-1} more`:n[0],securityDefs:r}))})),q`<div class="security-scheme" style="position:absolute; top:3px; right:2px; font-size:var(--font-size-small); line-height: 1.5;">
  ...
  <div class="tab-panel col"
    ...
    <div class="tab-buttons row" style="width:100;">
      ${e.map(((e,t)=>q`<button class="tab-btn ${0===t?"active":""}" data-tab = '${e.lang}${t}' part="btn-tab"> ${e.label||e.lang} </button>`))}
    </div>
...
`;var KP=function(e,t,r,n){var o,a=arguments.length,i=a<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(e,t,r,n);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(i=(a<3?o(i):a>3?o(t,r,i):o(t,r))||i);return a>3&&i&&Object.defineProperty(t,r,i),i};let JP=class extends ie{constructor(){super(...arguments),this.schemaExpandLevel=999}connectedCallback(){super.connectedCallback(),(!this.schemaExpandLevel||this.schemaExpandLevel<1)&&(this.schemaExpandLevel=99999),this.schemaDescriptionExpanded&&"true false".includes(this.schemaDescriptionExpanded)||(this.schemaDescriptionExpanded="false"),this.schemaHideReadOnly&&"true false".includes(this.schemaHideReadOnly)||(this.schemaHideReadOnly="true"),this.schemaHideWriteOnly&&"true false".includes(this.schemaHideWriteOnly)||(this.schemaHideWriteOnly="true")}static get styles(){return[Ke,GP,SP,c`
    ...
    `}renderShortFormatExamples(e,t,r){return q`${e.map(((e,n)=>q`
      ...
      <tr title="${o.deprecated?"Deprecated":""}"> 
        <td rowspan="${"true"===this.allowTry?"1":"2"}" style="vertical-align:middle; width:${f}; min-width:100px;">
                  ...
                  >
                    ...
                    <div class="tab-panel col" style="border-width:0 0 1px 0;">
                      <div class="tab-buttons row" @click="${e=>{if("button"===e.target.tagName.toLowerCase()){const t={...this.activeParameterSchemaTabs};t[o.name]=e.target.dataset.tab,this.activeParameterSchemaTabs=t}}}">
                        <button class="tab-btn ${"example"===this.activeParameterSchemaTabs[o.name]?"active":""}" data-tab = 'example' part="btn-tab">EXAMPLE </button>
                        <button class="tab-btn ${"example"!==this.activeParameterSchemaTabs[o.name]?"active":""}" data-tab = 'schema' part="btn-tab">SCHEMA</button>
                      </div>
                      ${"example"===this.activeParameterSchemaTabs[o.name]?q`<div class="tab-content col">
                          <textarea 
                            ...
                            data-x-fill-example = "${o["x-fill-example"]||"yes"}"
                            spellcheck = "false"
                            .textContent="${"no"===o["x-fill-example"]?"":wP("true"===this.fillRequestFieldsWithExample?"object"==typeof h.exampleVal?JSON.stringify(h.exampleVal,null,2):h.exampleVal:"")}"
        ...
        ${this.selectedRequestBodyType.includes("json")||this.selectedRequestBodyType.includes("xml")||this.selectedRequestBodyType.includes("text")||this.selectedRequestBodyType.includes("jose")?q`
            <div class="tab-panel col" style="border-width:0 0 1px 0;">
              <div class="tab-buttons row" @click="${e=>{"button"===e.target.tagName.toLowerCase()&&(this.activeSchemaTab=e.target.dataset.tab)}}">
                <button class="tab-btn ${"example"===this.activeSchemaTab?"active":""}" data-tab = 'example' part="btn-tab">EXAMPLE</button>
                <button class="tab-btn ${"example"!==this.activeSchemaTab?"active":""}" data-tab = 'schema' part="btn-tab">SCHEMA</button>
              </div>
    ...
    `}curlSyntaxTemplate(e="flex"){return q`
      <div class="col m-markdown" style="flex:1; display:${e}; position:relative; max-width: 100%;">
        <button  class="toolbar-btn" style = "position:absolute; top:12px; right:8px" @click='${e=>{st(this.curlSyntax.replace(/\\$/,""),e)}}' part="btn btn-copy"> Copy </button>
      ...
      ${"success"!==this.responseStatus?"":q`
        <div class="tab-panel col" style="border-width:0 0 1px 0;">
          <div id="tab_buttons" class="tab-buttons row" @click="${e=>{!1!==e.target.classList.contains("tab-btn")&&(this.activeResponseTab=e.target.dataset.tab)}}">
            <button class="tab-btn ${"response"===this.activeResponseTab?"active":""}" data-tab = 'response' part="btn-tab"> RESPONSE</button>
            <button class="tab-btn ${"headers"===this.activeResponseTab?"active":""}"  data-tab = 'headers' part="btn-tab"> RESPONSE HEADERS</button>
            ${"true"===this.showCurlBeforeTry?"":q`<button class="tab-btn ${"curl"===this.activeResponseTab?"active":""}" data-tab = 'curl' part="btn-tab">CURL</button>`}
          </div>
          ${this.responseIsBlob?q`
              ...
              <div class="tab-content col m-markdown" style="flex:1; display:${"response"===this.activeResponseTab?"flex":"none"};" >
                <button class="toolbar-btn" style="position:absolute; top:12px; right:8px" @click='${e=>{st(this.responseText,e)}}' part="btn btn-copy"> Copy </button>
          ...
          <div class="tab-content col m-markdown" style="flex:1; display:${"headers"===this.activeResponseTab?"flex":"none"};" >
            <button  class="toolbar-btn" style = "position:absolute; top:12px; right:8px" @click='${e=>{st(this.responseHeaders,e)}}' part="btn btn-copy"> Copy </button>
  ...
  `}function cR(){var e,t;return this.resolvedSpec?q`
  ${null===(t=null===(e=this.resolvedSpec)||void 0===e?void 0:e.tags)||void 0===t?void 0:t.map((e=>q`
    <section id="${e.elementId}" part="section-tag" class="regular-font section-gap--read-mode observe-me" style="border-top:1px solid var(--primary-color);">
      ...
      ${Q_(`\n          <div class="m-markdown regular-font">\n          ${We(e.description||"","true"===this.infoDescriptionHeadingsInNavBar?{renderer:iR(e.elementId)}:void 0)}\n        </div>`)}
      </div>
    </section>
    <section class="regular-font section-gap--read-mode" part="section-operations-in-tag">
      ${e.paths.map((e=>lR.call(this,e)))}
    </section>
    `))}
`:""}function pR(e){return q`
  ...
  ${"table"===this.schemaStyle?q`
      ...
      <schema-tree
        ...
        exportparts = "schema-description:schema-description, schema-multiline-toggle:schema-multiline-toggle"
      > </schema-tree>`}
  </div>`}function dR(e,t){return-1!==e.id.indexOf("schemas-")?pR.call(this,e):q`
  <div class='divider'></div>
  <div class='expanded-endpoint-body observe-me ${e.name}' id='cmp--${e.id}' >
    ${q`
  ...
  `}function uR(){var e;return this.resolvedSpec?q`
  ${null===(e=this.resolvedSpec.components)||void 0===e?void 0:e.map((e=>q`
    ...
    `))}
`:""}function hR(){const e=new We.Renderer;return aR(e,((e,t)=>`overview--${t.slug(e)}`)),oR(e),e}function fR(){var e,t,r,n;return q`
    <section id="overview" part="section-overview"
      ...
      ${(null===(e=this.resolvedSpec)||void 0===e?void 0:e.info)?q`
          ...
          ${this.resolvedSpec.info.description?q`${Q_(`\n                <div class="m-markdown regular-font">\n                ${We(this.resolvedSpec.info.description,"true"===this.infoDescriptionHeadingsInNavBar?{renderer:hR(),baseUrl:"/toto"}:{baseUrl:"/toto"})}\n              </div>`)}`:""}
          </div>
        `:""}
    </section>
  `}function mR(e){var t,r;const n=null===(r=null===(t=this.resolvedSpec)||void 0===t?void 0:t.servers)||void 0===r?void 0:r.find((t=>t.url===e));return!!n&&(this.selectedServer=n,this.requestUpdate(),this.dispatchEvent(new CustomEvent("api-server-change",{bubbles:!0,composed:!0,detail:{selectedServer:n}})),!0)}function yR(e,t){const r=[...e.currentTarget.closest("table").querySelectorAll("input, select")];let n=t.url;r.forEach((e=>{const t=new RegExp(`{${e.dataset.var}}`,"g");n=n.replace(t,e.value)})),t.computedUrl=n,this.requestUpdate()}function vR(){return this.selectedServer&&this.selectedServer.variables?q`
      ...
      ${Object.entries(this.selectedServer.variables).map((e=>q`
        <tr>
          ...
          <td>
            ...
            <select
              data-var = "${e[0]}"
              @input = ${e=>{yR.call(this,e,this.selectedServer)}}
            >
    ...
    `:""}function gR(){var e,t,r;return!this.resolvedSpec||this.resolvedSpec.specLoadError?"":q`
  ...
  <nav class='nav-bar ${this.renderStyle}' part='section-navbar'>
    ...
    ${"false"===this.allowSearch&&"false"===this.allowAdvancedSearch?"":q`
      ...
      `}
    ${q`<nav class='nav-scroll' tabindex='-1' part='section-navbar-scroll' @click='${e=>xR.call(this,e)}' @keyup='${e=>xR.call(this,e)}' >
...
`}function $R(e){const t=new We.Renderer;return aR(t,((t,r)=>`${e}--${r.slug(t)}`)),oR(t),t}function kR(e){return q`
    <div class='regular-font section-gap--focused-mode' part="section-operations-in-tag">
      ${e}
    </div>`}function SR(){var e,t,r,n,o;if("true"===this.showInfo)return kR(fR.call(this));const a=null===(t=null===(e=this.resolvedSpec)||void 0===e?void 0:e.tags)||void 0===t?void 0:t[0],i=null===(o=null===(n=null===(r=this.resolvedSpec)||void 0===r?void 0:r.tags)||void 0===n?void 0:n[0])||void 0===o?void 0:o.paths[0];return kR(a&&i?lR.call(this,i,a.name):"")}function AR(e){return q`
    <h1 id="${e.elementId}">${e.name}</h1>
    ${"show-description"===this.onNavTagClick&&e.description?q`
        <div class="m-markdown">
          ${Q_(`\n            <div class="m-markdown regular-font">\n              ${We(e.description||"","true"===this.infoDescriptionHeadingsInNavBar?{renderer:$R(e.elementId)}:void 0)}\n            </div>`)}
        </div>`:""}
  `}function OR(){var e,t,r,n,o;if(!this.focusedElementId||!this.resolvedSpec)return;const a=this.focusedElementId;let i,s=null,l=null,c=0;if(a.startsWith("overview")&&"true"===this.showInfo)i=fR.call(this);else if("auth"===a&&"true"===this.allowAuthentication)i=hP.call(this);else if("servers"===a&&"true"===this.allowServerSelection)i=gR.call(this);else if("operations-top"===a)i=q`
    <div id="operations-top" class="observe-me">
      <slot name="operations-top"></slot>
    </div>`;else if(a.startsWith("cmp--")&&"true"===this.showComponents)i=uR.call(this);else if(a.startsWith("tag--")){const t=a.indexOf("--",4)>0?a.substring(0,a.indexOf("--",5)):a;l=null===(e=this.resolvedSpec.tags)||void 0===e?void 0:e.find((e=>e.elementId===t)),i=l?kR.call(this,AR.call(this,l)):SR.call(this)}else{for(c=0;c<((null===(t=this.resolvedSpec.tags)||void 0===t?void 0:t.length)||0)&&(l=null===(r=this.resolvedSpec.tags)||void 0===r?void 0:r[c],s=null===(n=this.resolvedSpec.tags)||void 0===n?void 0:n[c].paths.find((e=>`${e.elementId}`===a)),!s);c+=1);if(s){bR(null===(o=this.shadowRoot)||void 0===o?void 0:o.getElementById(`link-${a}`),"expand"),i=kR.call(this,lR.call(this,s,(null==l?void 0:l.name)||"",(null==l?void 0:l.description)||""))}else i=SR.call(this)}return i}function ER(e){if(e.expanded)e.expanded=!1,"true"===this.updateRoute&&this.replaceHistoryState("");else if(e.expanded=!0,"true"===this.updateRoute){const t=`${this.routePrefix||"#"}${e.elementId}`;window.location.hash!==t&&this.replaceHistoryState(e.elementId)}this.requestUpdate()}function TR(e,t="expand-all"){!function(e,t="expand-all"){const r=[...e.querySelectorAll(".section-tag")];"expand-all"===t?r.map((e=>{e.classList.replace("collapsed","expanded")})):r.map((e=>{e.classList.replace("expanded","collapsed")}))}(e.target.closest(".operations-root"),t)}function CR(e,t=!1){return q`
  <summary @click="${()=>{ER.call(this,e)}}" part="section-endpoint-head-${e.expanded?"expanded":"collapsed"}" class='endpoint-head ${e.method} ${e.deprecated?"deprecated":""} ${t||e.expanded?"expanded":"collapsed"}'>
  ...
  `}function jR(e){var t,r,n,o,a,i,s,l,c,p,d,u,h;const f=new Set;for(const r in e.responses)for(const n in null===(t=e.responses[r])||void 0===t?void 0:t.content)f.add(n.trim());const m=[...f].join(", "),y=(null===(n=null===(r=this.resolvedSpec)||void 0===r?void 0:r.securitySchemes)||void 0===n?void 0:n.filter((t=>{var r;return t.finalKeyValue&&(null===(r=e.security)||void 0===r?void 0:r.some((e=>t.securitySchemeId in e)))})))||[],v=null===(a=null===(o=this.resolvedSpec)||void 0===o?void 0:o.securitySchemes)||void 0===a?void 0:a.find((e=>e.securitySchemeId===at&&"-"!==e.value));v&&y.push(v);const g=e.xCodeSamples?mP(e.xCodeSamples):"";return q`
  ...
  </div>`}function IR(e=!0,t=!0,r=!1){var n;return this.resolvedSpec?q`
    ${e?q`
        <div style="display:flex; justify-content:flex-end;"> 
          <span @click="${e=>TR(e,"expand-all")}" style="color:var(--primary-color); cursor:pointer;">
            Expand all
          </span> 
          &nbsp;|&nbsp; 
          <span @click="${e=>TR(e,"collapse-all")}" style="color:var(--primary-color); cursor:pointer;" >
            Collapse all
          </span> 
          &nbsp; sections
        </div>`:""}
...
`;var RR=function(e,t,r,n){var o,a=arguments.length,i=a<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(e,t,r,n);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(i=(a<3?o(i):a>3?o(t,r,i):o(t,r))||i);return a>3&&i&&Object.defineProperty(t,r,i),i};let LR=class extends ie{static get styles(){return[PR]}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",(e=>{"Escape"===e.code&&this.onClose()}))}attributeChangedCallback(e,t,r){t!==r&&("heading"===e&&(this.heading=r),"show"===e&&(this.show=r,"true"===r&&document.dispatchEvent(new CustomEvent("open",{bubbles:!0,composed:!0,detail:this})))),super.attributeChangedCallback(e,t,r)}render(){return q`
    ${"true"===this.show?q`
        ...
        </div>`:""}`}onClose(){document.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}};RR([MP({type:String,attribute:"heading"})],LR.prototype,"heading",void 0),RR([MP({type:String,attribute:"show"})],LR.prototype,"show",void 0),LR=RR([zP("dialog-box")],LR);function DR(){var e;return document.addEventListener("close",(()=>{this.showAdvancedSearchDialog=!1})),document.addEventListener("open",(e=>this.onOpenSearchDialog(e))),q`
    <dialog-box 
      heading="Search" 
  ...
  `}const FR={color:{inputReverseFg:"#fff",inputReverseBg:"#333",headerBg:"#444",getRgb(e){if(0===e.indexOf("#")&&(e=e.slice(1,7)),3!==e.length&&4!==e.length||(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),6!==e.length)throw new Error("Invalid HEX color.");return{r:parseInt(e.slice(0,2),16),g:parseInt(e.slice(2,4),16),b:parseInt(e.slice(4,6),16)}},luminanace(e){const t=this.getRgb(e);return.299*t.r+.587*t.g+.114*t.b},invert(e){return this.luminanace(e)>135?"#000":"#fff"},opacity(e,t){const r=this.getRgb(e);return`rgba(${r.r}, ${r.g}, ${r.b}, ${t})`},brightness(e,t){const r=this.getRgb(e);return r.r+=t,r.g+=t,r.b+=t,r.r>255?r.r=255:r.r<0&&(r.r=0),r.g>255?r.g=255:r.g<0&&(r.g=0),r.b>255?r.b=255:r.b<0&&(r.b=0),`#${r.r.toString(16).padStart(2,"0")}${r.g.toString(16).padStart(2,"0")}${r.b.toString(16).padStart(2,"0")}`},hasGoodContrast(e,t){return this.luminanace(e)-this.luminanace(t)}}};function NR(e){return!!e&&/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3}|[A-Fa-f0-9]{8}|[A-Fa-f0-9]{4})$/i.test(e)}function BR(e,t={}){let r={};const n=t.primaryColor?t.primaryColor:"dark"===e?"#f76b39":"#ff591e",o=FR.color.invert(n),a=FR.color.opacity(n,.4);if("dark"===e){const e=t.bg1?t.bg1:"#2a2b2c",i=t.fg1?t.fg1:"#bbb",s=t.bg2?t.bg2:FR.color.brightness(e,5),l=t.bg3?t.bg3:FR.color.brightness(e,17),c=t.bg3?t.bg3:FR.color.brightness(e,35),p=t.fg2?t.fg2:FR.color.brightness(i,-15),d=t.fg3?t.fg3:FR.color.brightness(i,-20),u=t.fg3?t.fg3:FR.color.brightness(i,-65),h=t.inlineCodeFg?t.inlineCodeFg:"#aaa",f="#bbb",m="#eee",y=t.headerColor?t.headerColor:FR.color.brightness(e,10),v=t.navBgColor?t.navBgColor:FR.color.brightness(e,10),g=t.navTextColor?t.navTextColor:FR.color.opacity(FR.color.invert(v),.5),b=t.navHoverBgColor?t.navHoverBgColor:FR.color.brightness(v,-15),x=t.navHoverTextColor?t.navHoverTextColor:FR.color.invert(v),w=t.navAccentColor?t.navAccentColor:FR.color.brightness(n,25);r={bg1:e,bg2:s,bg3:l,lightBg:c,fg1:i,fg2:p,fg3:d,lightFg:u,inlineCodeFg:h,primaryColor:n,primaryColorTrans:a,primaryColorInvert:o,selectionBg:f,selectionFg:m,overlayBg:"rgba(80, 80, 80, 0.4)",navBgColor:v,navTextColor:g,navHoverBgColor:b,navHoverTextColor:x,navAccentColor:w,navAccentTextColor:t.navAccentTextColor?t.navAccentTextColor:FR.color.invert(w),headerColor:y,headerColorInvert:FR.color.invert(y),headerColorDarker:FR.color.brightness(y,-20),headerColorBorder:FR.color.brightness(y,10),borderColor:t.borderColor||FR.color.brightness(e,20),lightBorderColor:t.lightBorderColor||FR.color.brightness(e,15),codeBorderColor:t.codeBorderColor||FR.color.brightness(e,30),inputBg:t.inputBg||FR.color.brightness(e,-5),placeHolder:t.placeHolder||FR.color.opacity(i,.3),hoverColor:t.hoverColor||FR.color.brightness(e,-10),red:t.red?t.red:"#F06560",lightRed:t.lightRed?t.lightRed:FR.color.brightness(e,-10),pink:t.pink?t.pink:"#ffb2b2",lightPink:t.lightPink||FR.color.brightness(e,-10),green:t.green||"#7ec699",lightGreen:t.lightGreen||FR.color.brightness(e,-10),blue:t.blue||"#71b7ff",lightBlue:t.lightBlue||FR.color.brightness(e,-10),orange:t.orange?t.orange:"#f08d49",lightOrange:t.lightOrange||FR.color.brightness(e,-10),yellow:t.yellow||"#827717",lightYellow:t.lightYellow||FR.color.brightness(e,-10),purple:t.purple||"#786FF1",brown:t.brown||"#D4AC0D",codeBg:t.codeBg||FR.color.opacity(FR.color.brightness(e,-15),.7),codeFg:t.codeFg||"#aaa",codePropertyColor:t.codePropertyColor||"#f8c555",codeKeywordColor:t.codeKeywordColor||"#cc99cd",codeOperatorColor:t.codeOperatorColor||"#67cdcc"}}else{const e=t.bg1?t.bg1:"#fafbfc",i=t.fg1?t.fg1:"#444444",s=t.bg2?t.bg2:FR.color.brightness(e,-5),l=t.bg3?t.bg3:FR.color.brightness(e,-15),c=t.bg3?t.bg3:FR.color.brightness(e,-45),p=t.fg2?t.fg2:FR.color.brightness(i,17),d=t.fg3?t.fg3:FR.color.brightness(i,30),u=t.fg3?t.fg3:FR.color.brightness(i,70),h=t.inlineCodeFg?t.inlineCodeFg:"brown",f="#444",m="#eee",y=t.headerColor?t.headerColor:FR.color.brightness(e,-180),v=t.navBgColor?t.navBgColor:FR.color.brightness(e,-200),g=t.navTextColor?t.navTextColor:FR.color.opacity(FR.color.invert(v),.65),b=t.navHoverBgColor?t.navHoverBgColor:FR.color.brightness(v,-15),x=t.navHoverTextColor?t.navHoverTextColor:FR.color.invert(v),w=t.navAccentColor?t.navAccentColor:FR.color.brightness(n,25);r={bg1:e,bg2:s,bg3:l,lightBg:c,fg1:i,fg2:p,fg3:d,lightFg:u,inlineCodeFg:h,primaryColor:n,primaryColorTrans:a,primaryColorInvert:o,selectionBg:f,selectionFg:m,overlayBg:"rgba(0, 0, 0, 0.4)",navBgColor:v,navTextColor:g,navHoverBgColor:b,navHoverTextColor:x,navAccentColor:w,navAccentTextColor:t.navAccentTextColor?t.navAccentTextColor:FR.color.invert(w),headerColor:y,headerColorInvert:FR.color.invert(y),headerColorDarker:FR.color.brightness(y,-20),headerColorBorder:FR.color.brightness(y,10),borderColor:t.borderColor||FR.color.brightness(e,-38),lightBorderColor:t.lightBorderColor||FR.color.brightness(e,-23),codeBorderColor:t.codeBorderColor||"transparent",inputBg:t.inputBg||FR.color.brightness(e,10),placeHolder:t.placeHolder||FR.color.brightness(u,20),hoverColor:t.hoverColor||FR.color.brightness(e,-5),red:t.red||"#F06560",lightRed:t.lightRed||"#fff0f0",pink:t.pink?t.pink:"#990055",lightPink:t.lightPink?t.lightPink:"#ffb2b2",green:t.green||"#690",lightGreen:t.lightGreen||"#fbfff0",blue:t.blue||"#47AFE8",lightBlue:t.lightBlue||"#eff8fd",orange:t.orange||"#FF9900",lightOrange:t.lightOrange||"#fff5e6",yellow:t.yellow||"#827717",lightYellow:t.lightYellow||"#fff5cc",purple:t.purple||"#786FF1",brown:t.brown||"#D4AC0D",codeBg:t.codeBg||FR.color.opacity(FR.color.brightness(e,-15),.7),codeFg:t.codeFg||"#666",codePropertyColor:t.codePropertyColor||"#905",codeKeywordColor:t.codeKeywordColor||"#07a",codeOperatorColor:t.codeOperatorColor||"#9a6e3a"}}return q`
  <style>
  *, *:before, *:after { box-sizing: border-box; }
  ...
  :host {
  ...
  </style>`}function qR(e=!1,t=!0,r=!0,n=!1){var o,a,i;if(!this.resolvedSpec)return"";"true"===this.persistAuth&&aP.call(this);const s={bg1:NR(this.bgColor)?this.bgColor:"",fg1:NR(this.textColor)?this.textColor:"",headerColor:NR(this.headerColor)?this.headerColor:"",primaryColor:NR(this.primaryColor)?this.primaryColor:"",navBgColor:NR(this.navBgColor)?this.navBgColor:"",navTextColor:NR(this.navTextColor)?this.navTextColor:"",navHoverBgColor:NR(this.navHoverBgColor)?this.navHoverBgColor:"",navHoverTextColor:NR(this.navHoverTextColor)?this.navHoverTextColor:"",navAccentColor:NR(this.navAccentColor)?this.navAccentColor:"",navAccentTextColor:NR(this.navAccentTextColor)?this.navAccentTextColor:""};return this.resolvedSpec.specLoadError?e?q`
        ${"dark"===this.theme?BR.call(this,"dark",s):BR.call(this,"light",s)}
    ...
    <!-- Header -->
    ${"false"===this.showHeader?"":_R.call(this)}
    
    <!-- Advanced Search -->
    ${"false"===this.allowAdvancedSearch?"":DR.call(this)}
        ...
        <div class='main-content-inner--${this.renderStyle}-mode'>
          ${!0===this.loading?q`<div class='loader'></div>`:q`
              ${!0===this.loadFailed?q`<div style='text-align: center;margin: 16px;'> Unable to load the Spec</div>`:q`
                  ...
                  ${"focused"===this.renderStyle?q`${OR.call(this)}`:q`
                      ${"true"===this.showInfo?fR.call(this):""}
                      ${"true"===this.allowServerSelection?gR.call(this):""}
                      ${"true"===this.allowAuthentication?hP.call(this):""}
                      <div id='operations-top' class='observe-me'>
                        <slot name='operations-top'></slot>
                      </div>  
                      ${"read"===this.renderStyle?cR.call(this):IR.call(this,t,r,n)}
                    `}
                  </div>
                `}`}
        </div>
  ...
  `}var zR=function(e,t,r,n){var o,a=arguments.length,i=a<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(e,t,r,n);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(i=(a<3?o(i):a>3?o(t,r,i):o(t,r))||i);return a>3&&i&&Object.defineProperty(t,r,i),i};let UR=class extends ie{constructor(){super();const e={root:this.getRootNode().host,rootMargin:"-50px 0px -50px 0px",threshold:0};this.showSummaryWhenCollapsed=!0,this.isIntersectionObserverActive=!1,this.intersectionObserver=new IntersectionObserver((e=>{this.onIntersect(e)}),e)}static get styles(){return[Ke,Je,Ye,Ze,Qe,Xe,et,tt,rt,c`
      :host {
        display:flex;
        flex-direction: column;
        min-width:360px;
  ...
  `}function GR(e=!1){var t,r,n;if(!this.resolvedSpec)return"";const o={bg1:NR(this.bgColor)?this.bgColor:"",fg1:NR(this.textColor)?this.textColor:"",headerColor:NR(this.headerColor)?this.headerColor:"",primaryColor:NR(this.primaryColor)?this.primaryColor:"",navBgColor:NR(this.navBgColor)?this.navBgColor:"",navTextColor:NR(this.navTextColor)?this.navTextColor:"",navHoverBgColor:NR(this.navHoverBgColor)?this.navHoverBgColor:"",navHoverTextColor:NR(this.navHoverTextColor)?this.navHoverTextColor:"",navAccentColor:NR(this.navAccentColor)?this.navAccentColor:"",navAccentTextColor:NR(this.navAccentTextColor)?this.navAccentTextColor:""};return this.resolvedSpec.specLoadError?e?q`
        ${"dark"===this.theme?BR.call(this,"dark",o):BR.call(this,"light",o)}
