          ...
          <div>
            ...
            ${"authorizationCode"===e||"clientCredentials"===e||"implicit"===e||"password"===e?q`
                <button class="m-btn thin-border" part="btn btn-outline"
                  @click="${t=>{pP.call(this,n,e,p,d,t)}}"
                > GET TOKEN </button>`:""}
          </div>
          <div class="oauth-resp-display red-text small-font-size"></div>
          `:""}
    </div>
  `}function uP(e){var t,r;const n=null===(r=null===(t=this.resolvedSpec)||void 0===t?void 0:t.securitySchemes)||void 0===r?void 0:r.find((t=>t.securitySchemeId===e));if(n){if(n.user="",n.password="",n.value="",n.finalKeyValue="","true"===this.persistAuth){const e=nP.call(this);delete e[n.securitySchemeId],oP.call(this,e)}this.requestUpdate()}}function hP(){var e;if(!this.resolvedSpec)return"";const t=null===(e=this.resolvedSpec.securitySchemes)||void 0===e?void 0:e.filter((e=>e.finalKeyValue));return t?q`
          ...
          ${this.resolvedSpec.securitySchemes.map((e=>q`
            <tr id="security-scheme-${e.securitySchemeId}" class="${e.type.toLowerCase()}">
              <td style="max-width:500px; overflow-wrap: break-word;">
                ...
                ${"apiKey"===e.type||"http"===e.type&&"bearer"===e.scheme?q`
                    <div style="margin-bottom:5px">
                      ${"apiKey"===e.type?q`Send <code>${e.name}</code> in <code>${e.in}</code>`:q`Send <code>Authorization</code> in <code>header</code> containing the word <code>Bearer</code> followed by a space and a Token String.`}
                    </div>
                    <div style="max-height:28px;">
                      ${"apiKey"===e.type&&"cookie"!==e.in?q`
                          ...
                          <button class="m-btn thin-border" style = "margin-left:5px;"
                            ...
                            @click="${()=>{iP.call(this,e.securitySchemeId)}}">
            ...
            ${"oauth2"===e.type?q`
                <tr>
                  <td style="border:none; padding-left:48px">
                    ${Object.keys(e.flows).map((t=>{const r=e.flows[t];return dP.call(this,t,r["x-client-id"]||e["x-client-id"]||"",r["x-client-secret"]||e["x-client-secret"]||"",e.securitySchemeId,r,r["x-default-scopes"]||e["x-default-scopes"],r["x-receive-token-in"]||e["x-receive-token-in"])}))}
                  </td>
                </tr>
                `:""}
          `))}
...
`:void 0}function fP(e){var t;if((null===(t=this.resolvedSpec)||void 0===t?void 0:t.securitySchemes)&&e){const t=[];return Array.isArray(e)?0===e.length?"":(e.forEach((e=>{const r=[],n=[];0===Object.keys(e).length?t.push({securityTypes:"None",securityDefs:[]}):(Object.keys(e).forEach((t=>{var o,a;let i="";const s=null===(a=null===(o=this.resolvedSpec)||void 0===o?void 0:o.securitySchemes)||void 0===a?void 0:a.find((e=>e.securitySchemeId===t));e[t]&&Array.isArray(e[t])&&(i=e[t].join(", ")),s&&(n.push(s.typeDisplay),r.push({...s,scopes:i}))})),t.push({securityTypes:n.length>1?`${n[0]} + ${n.length-1} more`:n[0],securityDefs:r}))})),q`<div class="security-scheme" style="position:absolute; top:3px; right:2px; font-size:var(--font-size-small); line-height: 1.5;">
...
`;function AP(e){return void 0===e?"":null===e?"null":""===e?"∅":"boolean"==typeof e||"number"==typeof e?`${e}`:Array.isArray(e)?e.map((e=>null===e?"null":""===e?"∅":e.toString().replace(/^ +| +$/g,(e=>"●".repeat(e.length)))||"")).join(", "):e.toString().replace(/^ +| +$/g,(e=>"●".repeat(e.length)))||""}function OP(e){if(!e)return;let t="",r="";const n="$ref"in e;if(n){const r=e.$ref.lastIndexOf("/");t=`{recursive: ${e.$ref.substring(r+1)}} `}else e.type?(t=Array.isArray(e.type)?e.type.join(2===e.length?" or ":"┃"):e.type,(e.format||e.enum||e.const)&&(t=t.replace("string",e.enum?"enum":e.const?"const":e.format||"")),e.nullable&&(t+="┃null")):t=e.const?"const":0===Object.keys(e).length?"any":"{missing-type-info}";const o={type:t,format:n?"":e.format||"",pattern:n?"":e.pattern&&!e.enum?e.pattern:"",readOrWriteOnly:n?"":e.readOnly?"🆁":e.writeOnly?"🆆":"",deprecated:n?"":e.deprecated?"❌":"",examples:n?"":e.examples||e.example,default:n?"":AP(e.default),description:n?"":e.description||"",constrain:"",allowedValues:"",arrayType:"",html:""};if(n?o.description=e.$ref.substring(e.$ref.lastIndexOf("/")+1):"{missing-type-info}"!==o.type&&"any"!==o.type||(o.description=o.description||""),n||(o.allowedValues=e.const?e.const:Array.isArray(e.enum)?e.enum.map((e=>AP(e))).join("┃"):""),"array"===t&&"items"in e){const t=e.items;if(t){const r="type"in t&&(null==t?void 0:t.type),n=AP("default"in t&&t.default);o.arrayType=`${e.type} of ${Array.isArray(r)?r.join(""):r}`,o.default=n,o.allowedValues="const"in t&&t.const?e.const:"enum"in t&&Array.isArray(null==t?void 0:t.enum)?t.enum.map((e=>AP(e))).join("┃"):""}}return t.match(/integer|number/g)&&(("minimum"in e&&void 0!==e.minimum||"exclusiveMinimum"in e&&void 0!==e.exclusiveMinimum)&&(r+=void 0!==e.minimum?`Min ${e.minimum}`:`More than ${e.exclusiveMinimum}`),("maximum"in e&&void 0!==e.maximum||"exclusiveMaximum"in e&&void 0!==e.exclusiveMaximum)&&(r+=void 0!==e.maximum?`${r?"┃":""}Max ${e.maximum}`:`${r?"┃":""}Less than ${e.exclusiveMaximum}`),"multipleOf"in e&&void 0!==e.multipleOf&&(r+=`${r?"┃":""} multiple of ${e.multipleOf}`)),t.match(/string/g)&&("minLength"in e&&void 0!==e.minLength&&"maxLength"in e&&void 0!==e.maxLength?r+=`${r?"┃":""}${e.minLength} to ${e.maxLength} chars`:"minLength"in e&&void 0!==e.minLength?r+=`${r?"┃":""}Min ${e.minLength} chars`:"maxLength"in e&&void 0!==e.maxLength&&(r+=`Max ${r?"┃":""}${e.maxLength} chars`)),o.constrain=r,o.html=`${o.type}~|~${o.readOrWriteOnly}~|~${o.constrain}~|~${o.default}~|~${o.allowedValues}~|~${o.pattern}~|~${o.description}~|~${"title"in e&&e.title||""}~|~${o.deprecated?"deprecated":""}`,o}function EP(e){return"boolean"==typeof e||"number"==typeof e?{Example:{value:`${e}`}}:""===e?{Example:{value:""}}:e?{Example:{value:e}}:e}function TP(e,t="string"){if(!e)return{exampleVal:"",exampleList:[]};if(e.constructor===Object){const t=Object.values(e).filter((e=>!1!==e["x-example-show-value"])).map((e=>({value:"boolean"==typeof e.value||"number"==typeof e.value?`${e.value}`:e.value||"",printableValue:AP(e.value),summary:e.summary||"",description:e.description||""})));return{exampleVal:t.length>0?t[0].value.toString():"",exampleList:t}}if(Array.isArray(e)||(e=e?[e]:[]),0===e.length)return{exampleVal:"",exampleList:[]};if("array"===t){const[t]=e,r=e.map((e=>({value:e,printableValue:AP(e)})));return{exampleVal:t,exampleList:r}}const r=e[0].toString(),n=e.map((e=>({value:e.toString(),printableValue:AP(e)})));return{exampleVal:r,exampleList:n}}function CP(e){var t;const r=e.examples?e.examples[0]:null===e.example?null:e.example||void 0;if(""===r)return"";if(null===r)return null;if(0===r)return 0;if(!1===r)return!1;if(r instanceof Date)switch(null===(t=e.format)||void 0===t?void 0:t.toLowerCase()){case"date":return r.toISOString().split("T")[0];case"time":return r.toISOString().split("T")[1];default:return r.toISOString()}if(r)return r;if(0===Object.keys(e).length)return null;if("$ref"in e)return e.$ref;if(!1===e.const||0===e.const||null===e.const||""===e.const)return e.const;if(e.const)return e.const;const n=Array.isArray(e.type)?e.type[0]:e.type;if(!n)return"?";if(n.match(/^integer|^number/g)){const t=Number.isNaN(Number(e.multipleOf))?void 0:Number(e.multipleOf),r=Number.isNaN(Number(e.maximum))?void 0:Number(e.maximum),o=Number.isNaN(Number(e.minimum))?Number.isNaN(Number(e.exclusiveMinimum))?r||0:Number(e.exclusiveMinimum)+(n.startsWith("integer")?1:.001):Number(e.minimum);return t?t>=o?t:o%t==0?o:Math.ceil(o/t)*t:o}if(n.match(/^boolean/g))return!1;if(n.match(/^null/g))return null;if(n.match(/^string/g)){if(e.enum)return e.enum[0];if(e.const)return e.const;if(e.pattern)return e.pattern;if(!e.format){const t=Number.isNaN(e.minLength)?void 0:Number(e.minLength),r=Number.isNaN(e.maxLength)?0:Number(e.maxLength),n=t||(r>6?6:r||void 0);return n?"A".repeat(n):"string"}{const t=`${Date.now().toString(16)}${Math.random().toString(16)}0`.repeat(16);switch(e.format.toLowerCase()){case"url":case"uri":return"http://example.com";case"date":return new Date(0).toISOString().split("T")[0];case"time":return new Date(0).toISOString().split("T")[1];case"date-time":return new Date(0).toISOString();case"duration":return"P3Y6M4DT12H30M5S";case"email":case"idn-email":return"user@example.com";case"hostname":case"idn-hostname":return"www.example.com";case"ipv4":return"198.51.100.42";case"ipv6":return"2001:0db8:5b96:0000:0000:426f:8e17:642a";case"uuid":return[t.substr(0,8),t.substr(8,4),`4000-8${t.substr(13,3)}`,t.substr(16,12)].join("-");default:return""}}}return"?"}function jP(e,t=1){const r="  ".repeat(t);let n="";if(1===t&&"object"!=typeof e)return`\n${r}${e.toString()}`;for(const o in e){const a=e[o]["::XML_TAG"]||o;let i="";i=Array.isArray(e[o])?a[0]["::XML_TAG"]||`${o}`:a,o.startsWith("::")||(n=Array.isArray(e[o])||"object"==typeof e[o]?`${n}\n${r}<${i}> ${jP(e[o],t+1)}\n${r}</${i}>`:`${n}\n${r}<${i}> ${e[o].toString()} </${i}>`)}return n}function IP(e,t){var r,n,o,a;"object"==typeof t&&null!==t&&(e.title&&(t["::TITLE"]=e.title),e.description&&(t["::DESCRIPTION"]=e.description),(null===(r=e.xml)||void 0===r?void 0:r.name)&&(t["::XML_TAG"]=null===(n=e.xml)||void 0===n?void 0:n.name),(null===(o=e.xml)||void 0===o?void 0:o.wrapped)&&(t["::XML_WRAP"]=null===(a=e.xml)||void 0===a?void 0:a.wrapped.toString()))}function _P(e){if("object"==typeof e&&null!==e){delete e["::TITLE"],delete e["::DESCRIPTION"],delete e["::XML_TAG"],delete e["::XML_WRAP"];for(const t in e){const r=e[t];"object"==typeof r&&_P(r)}}}function PP(e,t,r){for(const n in t)t[n][r]=e}function RP(e,t,r){let n=0;const o={};for(const a in e){for(const i in r)if(o[`example-${n}`]={...e[a]},o[`example-${n}`][t]=r[i],n++,n>=10)break;if(n>=10)break}return o}function LP(e,t={}){var r,n,o,a,i;let s={};if(e){if(e.allOf){const r={};if(1===e.allOf.length&&!("properties"in e.allOf[0])&&!("items"in e.allOf[0])){if("$ref"in e.allOf[0])return"{  }";if(e.allOf[0].readOnly&&t.includeReadOnly){return CP(e.allOf[0])}return}e.allOf.forEach((e=>{if("type"in e&&"object"===e.type||"properties"in e||"allOf"in e||"anyOf"in e||"oneOf"in e){const n=LP(e,t);Object.assign(r,n)}else if("type"in e&&"array"===e.type||"items"in e){const n=[LP(e,t)];Object.assign(r,n)}else if("type"in e){const t=`prop${Object.keys(r).length}`;r[t]=CP(e)}})),s=r}else if(e.oneOf){const r={};if(e.properties)for(const n in e.properties){const o=e.properties[n];"properties"in o&&o.properties?r[n]=LP(o,t):r[n]=CP(o)}if(e.oneOf.length>0){let n=0;for(const o in e.oneOf){const a=LP(e.oneOf[o],t);for(const t in a){let i;if(Object.keys(r).length>0){if(null===a[t]||"object"!=typeof a[t])continue;i=Object.assign(a[t],r)}else i=a[t];s[`example-${n}`]=i,IP(e.oneOf[o],s[`example-${n}`]),n++}}}}else if(e.anyOf){let r;if("object"===e.type||e.properties){r={"example-0":{}};for(const n in e.properties){if(e.example){r=e;break}e.properties[n].deprecated&&!t.includeDeprecated||(e.properties[n].readOnly&&!t.includeReadOnly||e.properties[n].writeOnly&&!t.includeWriteOnly||(r=RP(r,n,LP(e.properties[n],t))))}}let n=0;for(const o in e.anyOf){const a=LP(e.anyOf[o],t);for(const t in a){if(void 0!==r)for(const e in r)s[`example-${n}`]={...r[e],...a[t]};else s[`example-${n}`]=a[t];IP(e.anyOf[o],s[`example-${n}`]),n++}}}else if("object"===e.type||e.properties)if(s["example-0"]={},IP(e,s["example-0"]),e.example)s["example-0"]=e.example;else for(const i in e.properties){const l=e.properties[i];if((!(null==l?void 0:l.deprecated)||t.includeDeprecated)&&((!(null==l?void 0:l.readOnly)||t.includeReadOnly)&&(!(null==l?void 0:l.writeOnly)||t.includeWriteOnly)))if("array"===(null==l?void 0:l.type)||(null===(r=e.properties[i])||void 0===r?void 0:r.items))if(l.example)PP(l.example,s,i);else if(null===(n=null==l?void 0:l.items)||void 0===n?void 0:n.example)PP([l.items.example],s,i);else{const e=LP(l.items,t);if(t.useXmlTagForProp){const t=(null===(o=l.xml)||void 0===o?void 0:o.name)||i;if(null===(a=l.xml)||void 0===a?void 0:a.wrapped){s=RP(s,t,JSON.parse(`{ "${t}" : { "${t}" : ${JSON.stringify(e["example-0"])} } }`))}else s=RP(s,t,e)}else{const t=[];for(const r in e)t[r]=[e[r]];s=RP(s,i,t)}}else s=RP(s,i,LP(e.properties[i],t))}else{if("array"!==e.type&&!e.items)return{"example-0":CP(e)};if(e.items||e.example)if(e.example)s["example-0"]=e.example;else if(null===(i=e.items)||void 0===i?void 0:i.example)s["example-0"]=[e.items.example];else{const r=LP(e.items,t);let n=0;for(const t in r)s[`example-${n}`]=[r[t]],IP(e.items,s[`example-${n}`]),n++}else s["example-0"]=[]}return s}}function DP(e,t=0){var r;let n=(e.description||e.title)&&(e.minItems||e.maxItems)?'<span class="descr-expand-toggle">➔</span>':"";if(e.title?n=e.description?`${n} <b>${e.title}:</b> ${e.description}<br/>`:`${n} ${e.title}<br/>`:e.description&&(n=`${n} ${e.description}<br/>`),e.minItems&&(n=`${n} <b>Min Items:</b> ${e.minItems}`),e.maxItems&&(n=`${n} <b>Max Items:</b> ${e.maxItems}`),t>0&&(null===(r=e.items)||void 0===r?void 0:r.description)){let t="";e.items.minProperties&&(t=`<b>Min Properties:</b> ${e.items.minProperties}`),e.items.maxProperties&&(t=`${t} <b>Max Properties:</b> ${e.items.maxProperties}`),n=`${n} ⮕ ${t} [ ${e.items.description} ] `}return n}function FP(e,t,r=0,n=""){var o,a;if(e){if(e.allOf){const n={};if(1===e.allOf.length&&!e.allOf[0].properties&&!e.allOf[0].items){return`${null===(o=OP(e.allOf[0]))||void 0===o?void 0:o.html}`}e.allOf.forEach(((e,t)=>{if("object"===e.type||e.properties||e.allOf||e.anyOf||e.oneOf){const o=(e.anyOf||e.oneOf)&&t>0?t:"",a=FP(e,{},r+1,o);Object.assign(n,a)}else if("array"===e.type||e.items){const t=FP(e,{},r+1);Object.assign(n,t)}else if(e.type){const t=`prop${Object.keys(n).length}`,r=OP(e);n[t]=`${null==r?void 0:r.html}`}})),t=n}else if(e.anyOf||e.oneOf){if(t["::description"]=e.description||"","object"===e.type||e.properties){t["::description"]=e.description||"",t["::type"]="object";for(const n in e.properties)e.required&&e.required.includes(n)?t[`${n}*`]=FP(e.properties[n],{},r+1):t[n]=FP(e.properties[n],{},r+1)}const o={},a=e.anyOf?"anyOf":"oneOf";e[a].forEach(((e,t)=>{var r;if("object"===e.type||e.properties||e.allOf||e.anyOf||e.oneOf){const r=FP(e,{});o[`::OPTION~${t+1}${e.title?`~${e.title}`:""}`]=r,o[`::OPTION~${t+1}${e.title?`~${e.title}`:""}`]["::readwrite"]="",o["::type"]="xxx-of-option"}else if("array"===e.type||e.items){const r=FP(e,{});o[`::OPTION~${t+1}${e.title?`~${e.title}`:""}`]=r,o[`::OPTION~${t+1}${e.title?`~${e.title}`:""}`]["::readwrite"]="",o["::type"]="xxx-of-array"}else{const n=`::OPTION~${t+1}${e.title?`~${e.title}`:""}`;o[n]=`${null===(r=OP(e))||void 0===r?void 0:r.html}`,o["::type"]="xxx-of-option"}})),t[e.anyOf?`::ANY~OF ${n}`:`::ONE~OF ${n}`]=o,t["::type"]="object"}else if(Array.isArray(e.type)){const n=JSON.parse(JSON.stringify(e)),o=[],a=[];let i;if(n.type.forEach((e=>{var t,r;e.match(/integer|number|string|null|boolean/g)?o.push(e):"array"===e&&"string"==typeof(null===(t=n.items)||void 0===t?void 0:t.type)&&(null===(r=n.items)||void 0===r?void 0:r.type.match(/integer|number|string|null|boolean/g))?"string"===n.items.type&&n.items.format?o.push(`[${n.items.format}]`):o.push(`[${n.items.type}]`):a.push(e)})),o.length>0&&(n.type=o.join(2===o.length?" or ":"┃"),i=OP(n),0===a.length))return`${(null==i?void 0:i.html)||""}`;if(a.length>0){t["::type"]="object";const o={"::type":"xxx-of-option"};a.forEach(((t,a)=>{if("null"===t)o[`::OPTION~${a+1}`]="NULL~|~~|~~|~~|~~|~~|~~|~~|~";else if("integer, number, string, boolean,".includes(`${t},`)){n.type=Array.isArray(t)?t.join("┃"):t;const e=OP(n);o[`::OPTION~${a+1}`]=null==e?void 0:e.html}else if("object"===t){const t={"::title":e.title||"","::description":e.description||"","::type":"object","::deprecated":e.deprecated||!1};for(const n in e.properties)e.required&&e.required.includes(n)?t[`${n}*`]=FP(e.properties[n],{},r+1):t[n]=FP(e.properties[n],{},r+1);o[`::OPTION~${a+1}`]=t}else"array"===t&&(o[`::OPTION~${a+1}`]={"::title":e.title||"","::description":e.description||"","::type":"array","::props":FP(e.items,{},r+1)})})),o[`::OPTION~${a.length+1}`]=(null==i?void 0:i.html)||"",t["::ONE~OF"]=o}}else if("object"===e.type||e.properties){t["::title"]=e.title||"",t["::description"]=DP(e,r),t["::type"]="object",(Array.isArray(e.type)&&e.type.includes("null")||e.nullable)&&(t["::dataTypeLabel"]="object or null"),t["::deprecated"]=e.deprecated||!1,t["::readwrite"]=e.readOnly?"readonly":e.writeOnly?"writeonly":"";for(const n in e.properties)e.required&&e.required.includes(n)?t[`${n}*`]=FP(e.properties[n],{},r+1):t[n]=FP(e.properties[n],{},r+1);for(const n in e.patternProperties)t[`[pattern: ${n}]`]=FP(e.patternProperties[n],t,r+1);e.additionalProperties&&(t["[any-key]"]=FP(e.additionalProperties,{}))}else{if("array"!==e.type&&!e.items){const t=OP(e);return(null==t?void 0:t.html)?`${t.html}`:""}t["::title"]=e.title||"",t["::description"]=DP(e,r),t["::type"]="array",(Array.isArray(e.type)&&e.type.includes("null")||e.nullable)&&(t["::dataTypeLabel"]="array or null"),t["::deprecated"]=e.deprecated||!1,t["::readwrite"]=e.readOnly?"readonly":e.writeOnly?"writeonly":"",(null===(a=e.items)||void 0===a?void 0:a.items)&&(t["::array-type"]=e.items.items.type),t["::props"]=FP(e.items,{},r+1)}return t}}function NP(e,t,r,n="",o=!0,a=!0,i="json",s=!1){var l,c;const p=[];if(r)for(const e in r){let n="",o="json";if(null==t?void 0:t.toLowerCase().includes("json")){if("text"===i)n="string"==typeof r[e].value?r[e].value:JSON.stringify(r[e].value,void 0,2),o="text";else if(n=r[e].value,"string"==typeof r[e].value)try{const t=r[e].value;n=JSON.parse(t),o="json"}catch(t){o="text",n=r[e].value}}else n=r[e].value,o="text";p.push({exampleId:e,exampleSummary:r[e].summary||e,exampleDescription:r[e].description||"",exampleType:t,exampleValue:n,exampleFormat:o})}else if(n){let e="",r="json";if(null==t?void 0:t.toLowerCase().includes("json")){if("text"===i)e="string"==typeof n?n:JSON.stringify(n,void 0,2),r="text";else if("object"==typeof n)e=n,r="json";else if("string"==typeof n)try{e=JSON.parse(n),r="json"}catch(t){r="text",e=n}}else e=n,r="text";p.push({exampleId:"Example",exampleSummary:"",exampleDescription:"",exampleType:t,exampleValue:e,exampleFormat:r})}if(0===p.length||!0===s)if(e)if(e.example)p.push({exampleId:"Example",exampleSummary:"",exampleDescription:"",exampleType:t,exampleValue:e.example,exampleFormat:(null==t?void 0:t.toLowerCase().includes("json"))&&"object"==typeof e.example?"json":"text"});else if((null==t?void 0:t.toLowerCase().includes("json"))||(null==t?void 0:t.toLowerCase().includes("text"))||(null==t?void 0:t.toLowerCase().includes("*/*"))||(null==t?void 0:t.toLowerCase().includes("xml"))){let r="",n="",s="",d="";(null==t?void 0:t.toLowerCase().includes("xml"))?(r=(null===(l=e.xml)||void 0===l?void 0:l.name)?`<${e.xml.name} ${e.xml.namespace?`xmlns="${e.xml.namespace}"`:""}>`:"<root>",n=(null===(c=e.xml)||void 0===c?void 0:c.name)?`</${e.xml.name}>`:"</root>",s="text"):s=i;const u=LP(e,{includeReadOnly:o,includeWriteOnly:a,deprecated:!0,useXmlTagForProp:null==t?void 0:t.toLowerCase().includes("xml")});let h=0;for(const e in u){if(!u[e])continue;const o=u[e]["::TITLE"]||"Example "+ ++h,a=u[e]["::DESCRIPTION"]||"";(null==t?void 0:t.toLowerCase().includes("xml"))?d=`<?xml version="1.0" encoding="UTF-8"?>\n${r}${jP(u[e],1)}\n${n}`:(_P(u[e]),d="text"===i?JSON.stringify(u[e],null,2):u[e]),p.push({exampleId:e,exampleSummary:o,exampleDescription:a,exampleType:t,exampleFormat:s,exampleValue:d})}}else(null==t?void 0:t.toLowerCase().includes("jose"))?p.push({exampleId:"Example",exampleSummary:"Base64 Encoded",exampleDescription:"",exampleType:t,exampleValue:e.pattern||"bXJpbg==",exampleFormat:"text"}):p.push({exampleId:"Example",exampleSummary:"",exampleDescription:"",exampleType:t,exampleValue:"",exampleFormat:"text"});else p.push({exampleId:"Example",exampleSummary:"",exampleDescription:"",exampleType:t,exampleValue:"",exampleFormat:"text"});return p}function BP(e){return"application/json"===e?"json":"application/xml"===e?"xml":null}function qP(e){if(e.schema)return[e.schema,null,null];if(e.content)for(const t of Object.keys(e.content)){const r=e.content[t];if(r.schema)return[r.schema,BP(t),e.content[t]]}return[null,null,null]}const zP=e=>t=>"function"==typeof t?((e,t)=>(customElements.define(e,t),t))(e,t):((e,t)=>{const{kind:r,elements:n}=t;return{kind:r,elements:n,finisher(t){customElements.define(e,t)}}})(e,t),UP=(e,t)=>"method"===t.kind&&t.descriptor&&!("value"in t.descriptor)?{...t,finisher(r){r.createProperty(t.key,e)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:t.key,initializer(){"function"==typeof t.initializer&&(this[t.key]=t.initializer.call(this))},finisher(r){r.createProperty(t.key,e)}};function MP(e){return(t,r)=>void 0!==r?((e,t,r)=>{t.constructor.createProperty(r,e)})(e,t,r):UP(e,t)}var HP;null===(HP=window.HTMLSlotElement)||void 0===HP||HP.prototype.assignedElements;var WP=function(e,t,r,n){var o,a=arguments.length,i=a<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(e,t,r,n);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(i=(a<3?o(i):a>3?o(t,r,i):o(t,r))||i);return a>3&&i&&Object.defineProperty(t,r,i),i};let VP=class extends ie{static get styles(){return[Ke,SP,Je,c`
      :host{
        display:flex;
      }
    ...
    `}generateTree(e,t=!1){if(null===e)return q`<div class="null" style="display:inline;">null</div>`;if("object"==typeof e&&e instanceof Date==!1){const r=Array.isArray(e)?"array":"pure_object";return 0===Object.keys(e).length?q`${Array.isArray(e)?"[ ],":"{ },"}`:q`
      ...
      `}return"string"==typeof e||e instanceof Date?q`<span class="${typeof e}">"${e}"</span>${t?"":","}`:q`<span class="${typeof e}">${e}</span>${t?"":","}`}toggleExpand(e){const t=e.target;t.classList.contains("open-bracket")&&(t.classList.contains("expanded")?(t.classList.replace("expanded","collapsed"),t.innerHTML=t.classList.contains("array")?"[...]":"{...}"):(t.classList.replace("collapsed","expanded"),t.innerHTML=t.classList.contains("array")?"[":"{"))}};WP([MP({type:Object})],VP.prototype,"data",void 0),WP([MP({type:String,attribute:"render-style"})],VP.prototype,"renderStyle",void 0),VP=WP([zP("json-tree")],VP);const GP=c`
...
`;var KP=function(e,t,r,n){var o,a=arguments.length,i=a<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(e,t,r,n);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(i=(a<3?o(i):a>3?o(t,r,i):o(t,r))||i);return a>3&&i&&Object.defineProperty(t,r,i),i};let JP=class extends ie{constructor(){super(...arguments),this.schemaExpandLevel=999}connectedCallback(){super.connectedCallback(),(!this.schemaExpandLevel||this.schemaExpandLevel<1)&&(this.schemaExpandLevel=99999),this.schemaDescriptionExpanded&&"true false".includes(this.schemaDescriptionExpanded)||(this.schemaDescriptionExpanded="false"),this.schemaHideReadOnly&&"true false".includes(this.schemaHideReadOnly)||(this.schemaHideReadOnly="true"),this.schemaHideWriteOnly&&"true false".includes(this.schemaHideWriteOnly)||(this.schemaHideWriteOnly="true")}static get styles(){return[Ke,GP,SP,c`
      .tree {
        font-size:var(--font-size-small);
        text-align: left;
        direction: ltr;
      ...
      <div class="tree ${"true"===this.schemaDescriptionExpanded?"expanded-all-descr":"collapsed-all-descr"}" @click="${e=>this.handleAllEvents(e)}">
        ...
        <span part="schema-description" class='m-markdown'> ${Q_(We(this.data&&"::description"in this.data?this.data["::description"]:""))}</span>
        ${this.data?q`
            ${this.generateTree("array"===this.data["::type"]?this.data["::props"]:this.data,this.data["::type"],"array"===this.data["::type"]?this.data["::array-type"]:"")}`:q`<span class='mono-font' style='color:var(--red)'> Schema not found </span>`}
      </div>  
    `}generateTree(e,t="object",r="",n="",o="",a=0,i=0,s=""){var l,c;if("true"===this.schemaHideReadOnly){if("array"===t&&"readonly"===s)return;if("readonly"===(null==e?void 0:e["::readwrite"]))return}if("true"===this.schemaHideWriteOnly){if("array"===t&&"writeonly"===s)return;if("writeonly"===(null==e?void 0:e["::readwrite"]))return}if(!e)return q`<div class="null" style="display:inline;">
      ...
      </div>`;if(0===Object.keys(e).length)return q`<span class="key object">${n}:{ }</span>`;let p="",d="";if(n.startsWith("::ONE~OF")||n.startsWith("::ANY~OF"))p=n.replace("::","").replace("~"," ");else if(n.startsWith("::OPTION")){const e=n.split("~");[,p,d]=e}else p=n;const u=400-12*i;let h=q``,f="";const m=(null===(l=e["::type"])||void 0===l?void 0:l.startsWith("xxx-of"))?a:a+1,y="xxx-of-option"===t||"xxx-of-option"===e["::type"]||n.startsWith("::OPTION")?i:i+1;if("object"===e["::type"])"array"===t?(h=a<this.schemaExpandLevel?q`<span class="open-bracket array-of-object" >[{</span>`:q`<span class="open-bracket array-of-object">[{...}]</span>`,f="}]"):(h=a<this.schemaExpandLevel?q`<span class="open-bracket object">{</span>`:q`<span class="open-bracket object">{...}</span>`,f="}");else if("array"===e["::type"])if("array"===t){const e="object"!==r?r:"";h=a<this.schemaExpandLevel?q`<span class="open-bracket array-of-array" data-array-type="${e}">[[ ${e} </span>`:q`<span class="open-bracket array-of-array"  data-array-type="${e}">[[...]]</span>`,f="]]"}else h=a<this.schemaExpandLevel?q`<span class="open-bracket array">[</span>`:q`<span class="open-bracket array">[...]</span>`,f="]";if("object"==typeof e)return q`
        <div class="tr ${a<this.schemaExpandLevel||(null===(c=e["::type"])||void 0===c?void 0:c.startsWith("xxx-of"))?"expanded":"collapsed"} ${e["::type"]||"no-type-info"}" title="${e["::deprecated"]?"Deprecated":""}">
          <div class="td key ${e["::deprecated"]?"deprecated":""}" style='min-width:${u}px'>
            ${"xxx-of-option"===e["::type"]||"xxx-of-array"===e["::type"]||n.startsWith("::OPTION")?q`<span class='key-label xxx-of-key'> ${p}</span><span class="xxx-of-descr">${d}</span>`:"::props"===p||"::ARRAY~OF"===p?"":a>0?q`<span class="key-label" title="${"readonly"===s?"Read-Only":"writeonly"===s?"Write-Only":""}">
                      ${e["::deprecated"]?"✗":""}
                      ${p.replace(/\*$/,"")}${p.endsWith("*")?q`<span style="color:var(--red)">*</span>`:""}${"readonly"===s?q` 🆁`:"writeonly"===s?q` 🆆`:s}:
                    </span>`:""}
            ${h}
          </div>
        ...
        <div class='inside-bracket ${e["::type"]||"no-type-info"}' style='padding-left:${"xxx-of-option"===e["::type"]||"xxx-of-array"===e["::type"]?0:12}px;'>
          ${Array.isArray(e)&&e[0]?q`${this.generateTree(e[0],"xxx-of-option","","::ARRAY~OF","",m,y,e[0]["::readwrite"])}`:q`
              ${Object.keys(e).map((t=>{var r;return q`
                ${["::title","::description","::type","::props","::deprecated","::array-type","::readwrite","::dataTypeLabel"].includes(t)?"array"===e[t]["::type"]||"object"===e[t]["::type"]?q`${this.generateTree("array"===e[t]["::type"]?e[t]["::props"]:e[t],e[t]["::type"],e[t]["::array-type"]||"",t,e[t]["::description"],m,y,e[t]["::readwrite"]?e[t]["::readwrite"]:"")}`:"":q`${this.generateTree("array"===e[t]["::type"]?e[t]["::props"]:e[t],e[t]["::type"],e[t]["::array-type"]||"",t,(null===(r=e[t])||void 0===r?void 0:r["::description"])||"",m,y,e[t]["::readwrite"]?e[t]["::readwrite"]:"")}`}
              `}))}
            `}
        </div>
        ${e["::type"]&&e["::type"].includes("xxx-of")?"":q`<div class='close-bracket'> ${f} </div>`}
      `;const[v,g,b,x,w,$,k,S,A]=e.split("~|~");if("🆁"===g&&"true"===this.schemaHideReadOnly)return;if("🆆"===g&&"true"===this.schemaHideWriteOnly)return;const O=v.replace(/┃.*/g,"").replace(/[^a-zA-Z0-9+]/g,"").substring(0,4).toLowerCase(),E=""+(b||x||w||$?`<span class="descr-expand-toggle ${"true"===this.schemaDescriptionExpanded?"expanded-descr":""}">➔</span>`:"");let T="",C="";return"array"===t?"readonly"===s?(T="🆁",C="Read-Only"):"writeonly"===s&&(T="🆆",C="Write-Only"):"🆁"===g?(T="🆁",C="Read-Only"):"🆆"===g&&(T="🆆",C="Write-Only"),q`
      <div class = "tr primitive" title="${A?"Deprecated":""}">
        <div class="td key ${A}" style='min-width:${u}px'>
          ${A?q`<span style='color:var(--red);'>✗</span>`:""}
          ${p.endsWith("*")?q`<span class="key-label">${p.substring(0,p.length-1)}</span><span style='color:var(--red);'>*</span>:`:n.startsWith("::OPTION")?q`<span class='key-label xxx-of-key'>${p}</span><span class="xxx-of-descr">${d}</span>`:q`<span class="key-label">${p}:</span>`}
          <span class="${O}" title="${C}"> 
            ${"array"===t?`[${v}]`:`${v}`}
            ${T}
          </span>
        </div>
        <div class='td key-descr'>
          ${o||S||k?q`${q`<span class="m-markdown-small">
                ${Q_(We("array"===t?`${E} ${o}`:S?`${E} <b>${S}:</b> ${k}`:`${E} ${k}`))}
              </span>`}`:""}  
          ...
          ${w?q`<div style='display:inline-block; line-break:anywhere; margin-right:8px'><span class='bold-text'>${"const"===v?"Value":"Allowed"}: </span>${w}</div>`:""}
          ${$?q`<div style='display:inline-block; line-break: anywhere; margin-right:8px'><span class='bold-text'>Pattern: </span>${$}</div>`:""}
        </div>
      </div>
    `}handleAllEvents(e){const t=e.target;if(t.classList.contains("open-bracket"))this.toggleObjectExpand(e);else if(t.classList.contains("schema-multiline-toggle"))this.schemaDescriptionExpanded="true"===this.schemaDescriptionExpanded?"false":"true";else if(t.classList.contains("descr-expand-toggle")){const e=t.closest(".tr");e&&(e.classList.toggle("expanded-descr"),e.style.maxHeight=`${e.scrollHeight}`)}}toggleObjectExpand(e){const t=e.target,r=t.closest(".tr");r.classList.contains("expanded")?(r.classList.replace("expanded","collapsed"),t.innerHTML=t.classList.contains("array-of-object")?"[{...}]":t.classList.contains("array-of-array")?"[[...]]":t.classList.contains("array")?"[...]":"{...}"):(r.classList.replace("collapsed","expanded"),t.innerHTML=t.classList.contains("array-of-object")?"[{":t.classList.contains("array-of-array")?`[[ ${t.dataset.arrayType}`:t.classList.contains("object")?"{":"[")}};KP([MP({type:Object})],JP.prototype,"data",void 0),KP([MP({type:Number,attribute:"schema-expand-level"})],JP.prototype,"schemaExpandLevel",void 0),KP([MP({type:String,attribute:"schema-description-expanded"})],JP.prototype,"schemaDescriptionExpanded",void 0),KP([MP({type:String,attribute:"allow-schema-description-expand-toggle"})],JP.prototype,"allowSchemaDescriptionExpandToggle",void 0),KP([MP({type:String,attribute:"schema-hide-read-only"})],JP.prototype,"schemaHideReadOnly",void 0),KP([MP({type:String,attribute:"schema-hide-write-only"})],JP.prototype,"schemaHideWriteOnly",void 0),JP=KP([zP("schema-tree")],JP);var YP=function(e,t,r,n){var o,a=arguments.length,i=a<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(e,t,r,n);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(i=(a<3?o(i):a>3?o(t,r,i):o(t,r))||i);return a>3&&i&&Object.defineProperty(t,r,i),i};let ZP=class extends ie{render(){let e="";return Array.isArray(this.value)&&(e=q`${this.value.filter((e=>"string"==typeof e&&""!==e.trim())).map((e=>q`<span class='tag'>${e}</span>`))}`),q`
      <div class='tags'>
        ${e}
    ...
    `}attributeChangedCallback(e,t,r){"value"===e&&r&&t!==r&&(this.value=r.split(",").filter((e=>""!==e.trim()))),super.attributeChangedCallback(e,t,r)}afterPaste(e){const t=(e.clipboardData||window.clipboardData).getData("Text"),r=t?t.split(",").filter((e=>""!==e.trim())):"";r&&(Array.isArray(this.value)?this.value=[...this.value,...r]:this.value=r),e.preventDefault()}afterKeyDown(e){13===e.keyCode?(e.stopPropagation(),e.preventDefault(),e.target.value&&(Array.isArray(this.value)?this.value=[...this.value,e.target.value]:this.value=[e.target.value],e.target.value="")):8===e.keyCode&&0===e.target.value.length&&Array.isArray(this.value)&&this.value.length>0&&(this.value.splice(-1),this.value=[...this.value])}onBlur(e){e.target.value&&(Array.isArray(this.value)?this.value=[...this.value,e.target.value]:this.value=[e.target.value],e.target.value="")}static get styles(){return[c`
      .tags {
        display:flex;
        flex-wrap: wrap;
        outline: none;
    ...
    `]}};YP([MP({type:String})],ZP.prototype,"placeholder",void 0),YP([MP({type:Array,attribute:"value"})],ZP.prototype,"value",void 0),ZP=YP([zP("tag-input")],ZP);var QP=function(e,t,r,n){var o,a=arguments.length,i=a<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(e,t,r,n);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(i=(a<3?o(i):a>3?o(t,r,i):o(t,r))||i);return a>3&&i&&Object.defineProperty(t,r,i),i};let XP=class extends ie{constructor(){super(...arguments),this.method="get",this.responseMessage="",this.responseText="",this.responseHeaders="",this.responseStatus="success",this.responseUrl="",this.curlSyntax="",this.renderStyle="read",this.activeParameterSchemaTabs={},this.activeResponseTab="response",this.selectedRequestBodyType="",this.selectedRequestBodyExample="",this.respContentDisposition=""}static get styles(){return[Ze,Je,Ke,Ye,SP,et,Xe,c`
        *, *:before, *:after { box-sizing: border-box; }
        :where(button, input[type="checkbox"], [tabindex="0"]):focus-visible { box-shadow: var(--focus-shadow); }
        :where(input[type="text"], input[type="password"], select, textarea):focus-visible { border-color: var(--primary-color); }
    ...
    <div class="col regular-font request-panel ${"read focused".includes(this.renderStyle)||"true"===this.callback?"read-mode":"view-mode"}">
      ...
      <div>
        ${gP([this.method,this.path,this.allowTry,this.parameters,this.activeParameterSchemaTabs],(()=>this.inputParametersTemplate("path")))}
        ${gP([this.method,this.path,this.allowTry,this.parameters,this.activeParameterSchemaTabs],(()=>this.inputParametersTemplate("query")))}
        ${this.requestBodyTemplate()}
        ${gP([this.method,this.path,this.allowTry,this.parameters,this.activeParameterSchemaTabs],(()=>this.inputParametersTemplate("header")))}
        ${gP([this.method,this.path,this.allowTry,this.parameters,this.activeParameterSchemaTabs],(()=>this.inputParametersTemplate("cookie")))}
        ${"false"===this.allowTry?"":q`${this.apiCallTemplate()}`}
      </div>  
    </div>
    `}async updated(){var e;"true"===this.showCurlBeforeTry&&this.applyCURLSyntax(null===(e=this.shadowRoot)||void 0===e?void 0:e.getRootNode()),"true"===this.webhook&&(this.allowTry="false")}async saveExampleState(){var e,t;if("focused"===this.renderStyle){[...null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelectorAll("textarea.request-body-param-user-input")].forEach((e=>{e.dataset.user_example=e.value}));[...null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelectorAll('textarea[data-ptype="form-data"]')].forEach((e=>{e.dataset.user_example=e.value})),this.requestUpdate()}}async updateExamplesFromDataAttr(){var e,t;if("focused"===this.renderStyle){[...null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelectorAll("textarea.request-body-param-user-input")].forEach((e=>{e.value=e.dataset.user_example||e.dataset.example||""}));[...null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelectorAll('textarea[data-ptype="form-data"]')].forEach((e=>{e.value=e.dataset.user_example||e.dataset.example||""})),this.requestUpdate()}}renderExample(e,t,r){var n;return q`
      ${"array"===t?"[":""}
      <a
        ...
        data-example="${e.value&&Array.isArray(e.value)?null===(n=e.value)||void 0===n?void 0:n.join("@rapidoc|@rapidoc"):e.value||""}"
        @click="${e=>{var t;const n=e.target.closest("table").querySelector(`[data-pname="${r}"]`);n&&(n.value="array"===e.target.dataset.exampleType?null===(t=e.target.dataset.example)||void 0===t?void 0:t.split("@rapidoc|@rapidoc"):e.target.dataset.example)}}"
    ...
    `}renderShortFormatExamples(e,t,r){return q`${e.map(((e,n)=>q`
      ...
      ${e.map((e=>q`
          <li>
            ...
            ${e.summary?q`<span>&lpar;${e.summary}&rpar;</span>`:""}
            ${e.description?q`<p>${Q_(We(e.description))}</p>`:""}
          </li>
        `))}
    </ul>`}exampleListTemplate(e,t,r=[]){return q` ${r.length>0?q`<span style="font-weight:bold">Examples: </span>
          ${n=r,n.some((e=>{var t,r;return((null===(t=e.summary)||void 0===t?void 0:t.length)||0)>0||((null===(r=e.description)||void 0===r?void 0:r.length)||0)>0}))?this.renderLongFormatExamples(r,t,e):this.renderShortFormatExamples(r,t,e)}`:""}`;var n}inputParametersTemplate(e){var t,r;const n=Array.isArray(this.parameters)?this.parameters.filter((t=>t.in===e)):[];if(0===n.length)return"";let o="";"path"===e?o="PATH PARAMETERS":"query"===e?o="QUERY-STRING PARAMETERS":"header"===e?o="REQUEST HEADERS":"cookie"===e&&(o="COOKIES");const a=[];for(const o of n){const[n,i,s]=qP(o);if(!n)continue;const l=OP(n);if(!l)continue;const c=FP(n,{});let p="form",d=!0,u=!1;"query"===e&&(o.style&&"form spaceDelimited pipeDelimited".includes(o.style)?p=o.style:i&&(p=i),"boolean"==typeof o.explode&&(d=o.explode),"boolean"==typeof o.allowReserved&&(u=o.allowReserved));const h=TP(o.examples||EP(o.example)||EP(null==s?void 0:s.example)||(null==s?void 0:s.examples)||EP(l.examples)||EP(l.example),l.type);h.exampleVal||"object"!==l.type||(h.exampleVal=NP(n,i||"json",void 0,"","true"===this.callback||"true"===this.webhook,"true"!==this.callback&&"true"!==this.webhook,"text",!0)[0].exampleValue);const f="read focused".includes(this.renderStyle)?"200px":"160px";a.push(q`
      <tr title="${o.deprecated?"Deprecated":""}"> 
        <td rowspan="${"true"===this.allowTry?"1":"2"}" style="width:${f}; min-width:100px;">
          <div class="param-name ${o.deprecated?"deprecated":""}" >
            ${o.deprecated?q`<span style='color:var(--red);'>✗</span>`:""}
            ${o.required?q`<span style='color:var(--red)'>*</span>`:""}
            ${o.name}
          </div>
          <div class="param-type">
            ${"array"===l.type?`${l.arrayType}`:`${l.format?l.format:l.type}`}
          </div>
        </td>  
            ...
            <td style="min-width:100px;" colspan="${l.default||l.constrain||l.allowedValues||l.pattern?"1":"2"}">
              ${"array"===l.type?q`
                  <tag-input class="request-param" 
                    ...
                    data-ptype = "${e}"
                    data-pname = "${o.name}"
                    data-example = "${Array.isArray(h.exampleVal)?h.exampleVal.join("@rapidoc|@rapidoc"):h.exampleVal}"
                    data-param-serialize-style = "${p}"
                    data-param-serialize-explode = "${d}"
                    data-param-allow-reserved = "${u}"
                    data-x-fill-example = "${o["x-fill-example"]||"yes"}"
                    data-array = "true"
                    placeholder = "add-multiple &#x21a9;"
                    .value="${"no"===o["x-fill-example"]?[]:wP("true"===this.fillRequestFieldsWithExample?Array.isArray(h.exampleVal)?h.exampleVal:[h.exampleVal]:[])}"
                  >
                  </tag-input>`:"object"===l.type?q`
                    <div class="tab-panel col" style="border-width:0 0 1px 0;">
                      <div class="tab-buttons row" @click="${e=>{if("button"===e.target.tagName.toLowerCase()){const t={...this.activeParameterSchemaTabs};t[o.name]=e.target.dataset.tab,this.activeParameterSchemaTabs=t}}}">
                        <button class="tab-btn ${"example"===this.activeParameterSchemaTabs[o.name]?"active":""}" data-tab = 'example'>EXAMPLE </button>
                        <button class="tab-btn ${"example"!==this.activeParameterSchemaTabs[o.name]?"active":""}" data-tab = 'schema'>SCHEMA</button>
                      </div>
                      ${"example"===this.activeParameterSchemaTabs[o.name]?q`<div class="tab-content col">
                          <textarea 
                            class = "textarea request-param"
                            part = "textarea textarea-param"
                            data-ptype = "${e}-object"
                            data-pname = "${o.name}"
                            data-example = "${h.exampleVal}"
                            data-param-serialize-style = "${p}"
                            data-param-serialize-explode = "${d}"
                            data-param-allow-reserved = "${u}"
                            data-x-fill-example = "${o["x-fill-example"]||"yes"}"
                            spellcheck = "false"
                            .textContent="${"no"===o["x-fill-example"]?"":wP("true"===this.fillRequestFieldsWithExample?h.exampleVal:"")}"
                          ...
                          <div class="tab-content col">
                            <schema-tree
                              ...
                              schema-description-expanded = "${this.schemaDescriptionExpanded}"
                              allow-schema-description-expand-toggle = "${this.allowSchemaDescriptionExpandToggle}"
                              schema-hide-read-only = "${null===(t=this.schemaHideReadOnly)||void 0===t?void 0:t.includes(this.method)}"
                              schema-hide-write-only = "${null===(r=this.schemaHideWriteOnly)||void 0===r?void 0:r.includes(this.method)}"
                              exportparts = "wrap-request-btn:wrap-request-btn, btn:btn, btn-fill:btn-fill, btn-outline:btn-outline, btn-try:btn-try, btn-clear:btn-clear, btn-clear-resp:btn-clear-resp,
                                file-input:file-input, textbox:textbox, textbox-param:textbox-param, textarea:textarea, textarea-param:textarea-param, 
                    ...
                    <input type="${"password"===l.format?"password":"text"}" spellcheck="false" style="width:100%" 
                      class="request-param"
                      ...
                      data-x-fill-example = "${o["x-fill-example"]||"yes"}"
                      data-array="false"
                      .value="${"no"===o["x-fill-example"]?"":wP("true"===this.fillRequestFieldsWithExample?h.exampleVal:"")}"
                      @input=${e=>{const t=this.getRequestPanel(e);this.liveCURLSyntaxUpdate(t)}}
                    />`}
            </td>`:""}
        ${l.default||l.constrain||l.allowedValues||l.pattern?q`
            <td colspan="${"true"===this.allowTry?"1":"2"}">
              <div class="param-constraint">
                ${l.default?q`<span style="font-weight:bold">Default: </span>${l.default}<br/>`:""}
                ${l.pattern?q`<span style="font-weight:bold">Pattern: </span>${l.pattern}<br/>`:""}
                ${l.constrain?q`${l.constrain}<br/>`:""}
                ${l.allowedValues&&`${l.allowedValues}`.split("┃").map(((e,t)=>q`
                  ...
                  ${q`
                    <a part="anchor anchor-param-constraint" class = "${"true"===this.allowTry?"":"inactive-link"}"
                      ...
                      data-enum="${e.trim()}"
                      @click="${e=>{const t=e.target.closest("table").querySelector(`[data-pname="${o.name}"]`);t&&("array"===e.target.dataset.type?t.value=[e.target.dataset.enum]:t.value=e.target.dataset.enum)}}"
                    >${e}</a>`}`))}
              </div>
            </td>`:q`<td></td>`}
      </tr>
      <tr>
        ...
        <td colspan="2" style="border:none">
          <span class="m-markdown-small">${Q_(We(o.description||""))}</span>
          ${this.exampleListTemplate.call(this,o.name,l.type,h.exampleList)}
        </td>
      </tr>
    `)}return q`
    <div class="table-title top-gap">${o}</div>
    <div style="display:block; overflow-x:auto; max-width:100%;">
      <table role="presentation" class="m-table" style="width:100%; word-break:break-word;">
        ${a}
      </table>
    </div>`}async beforeNavigationFocusedMode(){}async afterNavigationFocusedMode(){this.selectedRequestBodyType="",this.selectedRequestBodyExample="",this.updateExamplesFromDataAttr(),this.clearResponseData()}onSelectExample(e){const t=e.target;this.selectedRequestBodyExample=t.value,window.setTimeout((e=>{var t,r;const n=null===(t=e.closest(".example-panel"))||void 0===t?void 0:t.querySelector(".request-body-param");(null===(r=e.closest(".example-panel"))||void 0===r?void 0:r.querySelector(".request-body-param-user-input")).value=n.innerText;const o=this.getRequestPanel({target:e});this.liveCURLSyntaxUpdate(o)}),0,t)}onMimeTypeChange(e){const t=e.target;this.selectedRequestBodyType=t.value,this.selectedRequestBodyExample="",window.setTimeout((e=>{var t,r;const n=null===(t=e.closest(".request-body-container"))||void 0===t?void 0:t.querySelector(".request-body-param");if(n){(null===(r=e.closest(".request-body-container"))||void 0===r?void 0:r.querySelector(".request-body-param-user-input")).value=n.innerText}}),0,t)}requestBodyTemplate(){if(!this.request_body)return"";if(0===Object.keys(this.request_body).length)return"";let e="",t="",r="",n="",o="";const a=[],{content:i}=this.request_body;for(const e in i)a.push({mimeType:e,schema:i[e].schema,example:i[e].example,examples:i[e].examples}),this.selectedRequestBodyType||(this.selectedRequestBodyType=e);return e=1===a.length?"":q`
      ...
      `,a.forEach((e=>{let a,i=[];if(this.selectedRequestBodyType.includes("json")||this.selectedRequestBodyType.includes("xml")||this.selectedRequestBodyType.includes("text")||this.selectedRequestBodyType.includes("jose"))e.mimeType===this.selectedRequestBodyType&&(i=NP(e.schema,e.mimeType,e.examples,e.example,"true"===this.callback||"true"===this.webhook,"true"!==this.callback&&"true"!==this.webhook,"text",!1),this.selectedRequestBodyExample||(this.selectedRequestBodyExample=i.length>0?i[0].exampleId:""),o=q`
            ${o}
          ...
          `);else if(this.selectedRequestBodyType.includes("form-urlencoded")||this.selectedRequestBodyType.includes("form-data")){if(e.mimeType===this.selectedRequestBodyType){const t=NP(e.schema,e.mimeType,e.examples,e.example,"true"===this.callback||"true"===this.webhook,"true"!==this.callback&&"true"!==this.webhook,"text",!1);e.schema&&(r=this.formDataTemplate(e.schema,e.mimeType,t[0]?t[0].exampleValue:""))}}else/^audio\/|^image\/|^video\/|^font\/|tar$|zip$|7z$|rtf$|msword$|excel$|\/pdf$|\/octet-stream$/.test(this.selectedRequestBodyType)&&e.mimeType===this.selectedRequestBodyType&&(t=q`
          ...
          `);(e.mimeType.includes("json")||e.mimeType.includes("xml")||e.mimeType.includes("text")||this.selectedRequestBodyType.includes("jose"))&&(a=FP(e.schema,{}),"table"===this.schemaStyle?n=q`
            ${n}
            <schema-table
    ...
    `}formDataParamAsObjectTemplate(e,t,r){var n;const o=FP(t,{}),a=NP(t,"json",t.examples,t.example,"true"===this.callback||"true"===this.webhook,"true"!==this.callback&&"true"!==this.webhook,"text",!1);return q`
    ...
    `}formDataTemplate(e,t,r=""){var n,o,a;const i=[];if(e.properties){for(const r in e.properties){const s=e.properties[r];if(s.readOnly)continue;const l=s.examples||s.example||"",c=s.type,p=OP(s),d="read focused".includes(this.renderStyle)?"200px":"160px",u=TP((null==p?void 0:p.examples)||(null==p?void 0:p.example),null==p?void 0:p.type);i.push(q`
        <tr title="${s.deprecated?"Deprecated":""}"> 
          <td style="width:${d}; min-width:100px;">
            <div class="param-name ${s.deprecated?"deprecated":""}">
              ${r}${(null===(n=e.required)||void 0===n?void 0:n.includes(r))||s.required?q`<span style='color:var(--red);'>*</span>`:""}
            </div>
            <div class="param-type">${null==p?void 0:p.type}</div>
          </td>  
          <td 
            style="${"object"===c?"width:100%; padding:0;":"true"===this.allowTry?"":"display:none;"} min-width:100px;" 
            colspan="${"object"===c?2:1}">
            ${"array"===c?"binary"===(null===(o=s.items)||void 0===o?void 0:o.format)?q`
                ...
                `:q`
                  <tag-input
                    ...
                    data-ptype = "${t.includes("form-urlencode")?"form-urlencode":"form-data"}"
                    data-pname = "${r}"
                    data-example = "${Array.isArray(l)?l.join("@rapidoc|@rapidoc"):l}"
                    data-array = "true"
                    placeholder = "add-multiple &#x21a9;"
                ...
                `:q`
                ${"object"===c?this.formDataParamAsObjectTemplate.call(this,r,s,t):q`
          ...
          ${"object"===c?"":q`
              <td>
                ${(null==p?void 0:p.default)||(null==p?void 0:p.constrain)||(null==p?void 0:p.allowedValues)||(null==p?void 0:p.pattern)?q`
                    <div class="param-constraint">
                      ${(null==p?void 0:p.default)?q`<span style="font-weight:bold">Default: </span>${null==p?void 0:p.default}<br/>`:""}
                      ${(null==p?void 0:p.pattern)?q`<span style="font-weight:bold">Pattern: </span>${null==p?void 0:p.pattern}<br/>`:""}
                      ${(null==p?void 0:p.constrain)?q`${null==p?void 0:p.constrain}<br/>`:""}
                      ${(null==p?void 0:p.allowedValues)&&(null===(a=`${null==p?void 0:p.allowedValues}`)||void 0===a?void 0:a.split("┃").map(((e,t)=>q`
                        ${t>0?"┃":q`<span style="font-weight:bold">Allowed: </span>`}
                        ${q`
                          <a part="anchor anchor-param-constraint" class = "${"true"===this.allowTry?"":"inactive-link"}"
                            data-type="${"array"===(null==p?void 0:p.type)?null==p?void 0:p.type:"string"}"
                            data-enum="${e.trim()}"
        ...
        ${"object"===c?"":q`
            <tr>
              ...
              <td colspan="2" style="border:none; margin-top:0; padding:0 5px 8px 5px;"> 
                <span class="m-markdown-small">${Q_(We(s.description||""))}</span>
                ${this.exampleListTemplate.call(this,r,null==p?void 0:p.type,u.exampleList)}
              </td>
            </tr>
          `}`)}return q`
    ...
    `}curlSyntaxTemplate(e="flex"){return q`
        ...
        <div class="tab-panel col" style="border-width:0 0 1px 0;">
          ...
          ${this.responseIsBlob?q`
              <div class="tab-content col" style="flex:1; display:${"response"===this.activeResponseTab?"flex":"none"};">
                <button class="m-btn thin-border mar-top-8" style="width:135px" @click='${()=>{pt(this.responseBlobUrl,this.respContentDisposition)}}' part="btn btn-outline">
                  DOWNLOAD
                </button>
                ${"view"===this.responseBlobType?q`<button class="m-btn thin-border mar-top-8" style="width:135px"  @click='${()=>{dt(this.responseBlobUrl)}}' part="btn btn-outline">VIEW (NEW TAB)</button>`:""}
              </div>`:q`
      ...
      `}`}apiCallTemplate(){var e,t,r,n;let o="";this.servers&&this.servers.length>0&&(o=q`
    ...
    <div style="display:flex; align-items:flex-end; margin:16px 0; font-size:var(--font-size-small);" part="wrap-request-btn">
      <div class="hide-in-small-screen" style="flex-direction:column; margin:0; width:calc(100% - 60px);">
        ...
        <div style="display:flex;">
          ...
          ${(null===(e=this.security)||void 0===e?void 0:e.length)?q`
              ${(null===(t=this.api_keys)||void 0===t?void 0:t.length)?q`<div style="color:var(--blue); overflow:hidden;"> 
                    ${1===this.api_keys.length?`${null===(r=this.api_keys[0])||void 0===r?void 0:r.typeDisplay} in ${this.api_keys[0].in}`:`${this.api_keys.length} API keys applied`} 
                  </div>`:q`<div class="gray-text">Required  <span style="color:var(--red)">(None Applied)</span>`}`:q`<span class="gray-text"> Not Required </span>`}
        </div>
      </div>
      ${(null===(n=this.parameters)||void 0===n?void 0:n.length)||this.request_body?q`
    ...
    `}async onFillRequestData(e){[...e.target.closest(".request-panel").querySelectorAll("input, tag-input, textarea:not(.is-hidden)")].forEach((e=>{e.dataset.example&&("TAG-INPUT"===e.tagName.toUpperCase()?e.value=e.dataset.example.split("@rapidoc|@rapidoc"):e.value=e.dataset.example)})),this.requestUpdate()}async onClearRequestData(e){[...e.target.closest(".request-panel").querySelectorAll("input, tag-input, textarea:not(.is-hidden)")].forEach((e=>{e.value=""})),this.requestUpdate()}buildFetchURL(e){var t,r;let n;const o=[...e.querySelectorAll("[data-ptype='path']")],a=[...e.querySelectorAll("[data-ptype='query']")],i=[...e.querySelectorAll("[data-ptype='query-object']")];n=this.path,o.map((e=>{n=null==n?void 0:n.replace(`{${e.dataset.pname}}`,encodeURIComponent(e.value))}));const s=new Map,l=[];a.length>0&&a.forEach((e=>{const t=new URLSearchParams;if("true"===e.dataset.paramAllowReserved&&l.push(e.dataset.pname),"false"===e.dataset.array)""!==e.value&&t.append(e.dataset.pname,e.value);else{const{paramSerializeStyle:r,paramSerializeExplode:n}=e.dataset;let o=e.value&&Array.isArray(e.value)?e.value:[],a=Array.isArray(o)?o.filter((e=>""!==e)):[];a.length>0&&("spaceDelimited"===r?t.append(e.dataset.pname,a.join(" ").replace(/^\s|\s$/g,"")):"pipeDelimited"===r?t.append(e.dataset.pname,a.join("|").replace(/^\||\|$/g,"")):"true"===n?a.forEach((r=>{t.append(e.dataset.pname,r)})):t.append(e.dataset.pname,a.join(",").replace(/^,|,$/g,"")))}t.toString()&&s.set(e.dataset.pname,t)})),i.length>0&&i.map((e=>{const t=new URLSearchParams;try{let r={};const{paramSerializeStyle:n,paramSerializeExplode:o}=e.dataset;if(r=Object.assign(r,JSON.parse(e.value.replace(/\s+/g," "))),"true"===e.dataset.paramAllowReserved&&l.push(e.dataset.pname),"json xml".includes(n))"json"===n?t.append(e.dataset.pname,JSON.stringify(r)):"xml"===n&&t.append(e.dataset.pname,jP(r));else for(const e in r)"object"==typeof r[e]?Array.isArray(r[e])&&("spaceDelimited"===n?t.append(e,r[e].join(" ")):"pipeDelimited"===n?t.append(e,r[e].join("|")):"true"===o?r[e].forEach((r=>{t.append(e,r)})):t.append(e,r[e])):t.append(e,r[e])}catch(t){console.error("RapiDoc: unable to parse %s into object",e.value)}t.toString()&&s.set(e.dataset.pname,t)}));let c="";return s.size&&(c="?",s.forEach(((e,t)=>{l.includes(t)?(c+=`${t}=`,c+=e.getAll(t).join(`&${t}=`),c+="&"):c+=`${e.toString()}&`})),c=c.slice(0,-1)),n=`${n}${c}`,null===(t=this.api_keys)||void 0===t||t.filter((e=>"query"===e.in)).forEach((e=>{n=`${n}${(null==n?void 0:n.includes("?"))?"&":"?"}${e.name}=${encodeURIComponent(e.finalKeyValue)}`})),n=`${null===(r=this.serverUrl)||void 0===r?void 0:r.replace(/\/$/,"")}${n}`,n}buildFetchHeaders(e){var t,r;const n=null===(t=this.closest(".expanded-req-resp-container, .req-resp-container"))||void 0===t?void 0:t.getElementsByTagName("api-response")[0],o=[...e.querySelectorAll("[data-ptype='header']")],a=e.querySelector(".request-body-container"),i=null==n?void 0:n.selectedMimeType,s=new Headers;if(i?s.append("Accept",i):this.accept&&s.append("Accept",this.accept),null===(r=this.api_keys)||void 0===r||r.filter((e=>"header"===e.in)).forEach((e=>{s.append(e.name,e.finalKeyValue)})),o.map((e=>{e.value&&s.append(e.dataset.pname,e.value)})),a){const e=a.dataset.selectedRequestBodyType;(null==e?void 0:e.includes("form-data"))||s.append("Content-Type",e)}return s}buildFetchBodyOptions(e){var t;const r=e.querySelector(".request-body-container"),n={method:this.method.toUpperCase()};if(r){const o=r.dataset.selectedRequestBodyType;if(null==o?void 0:o.includes("form-urlencoded")){const t=e.querySelector("[data-ptype='dynamic-form']");if(t){const e=t.value,r=new URLSearchParams;let o,a=!0;if(e)try{o=JSON.parse(e)}catch(e){a=!1,console.warn("RapiDoc: Invalid JSON provided",e)}else a=!1;if(a){for(const e in o)r.append(e,JSON.stringify(o[e]));n.body=r}}else{const t=[...e.querySelectorAll("[data-ptype='form-urlencode']")],r=new URLSearchParams;t.filter((e=>"file"!==e.type)).forEach((e=>{if("false"===e.dataset.array)e.value&&r.append(e.dataset.pname,e.value);else{const t=e.value&&Array.isArray(e.value)?e.value.join(","):"";r.append(e.dataset.pname,t)}})),n.body=r}}else if(null==o?void 0:o.includes("form-data")){const t=new FormData;[...e.querySelectorAll("[data-ptype='form-data']")].forEach((e=>{var r;"false"===e.dataset.array?"file"===e.type&&(null===(r=e.files)||void 0===r?void 0:r[0])?t.append(e.dataset.pname,e.files[0],e.files[0].name):e.value&&t.append(e.dataset.pname,e.value):e.value&&Array.isArray(e.value)&&t.append(e.dataset.pname,e.value.join(","))})),n.body=t}else if(/^audio\/|^image\/|^video\/|^font\/|tar$|zip$|7z$|rtf$|msword$|excel$|\/pdf$|\/octet-stream$/.test(o)){const r=e.querySelector(".request-body-param-file");(null===(t=null==r?void 0:r.files)||void 0===t?void 0:t[0])&&(n.body=r.files[0])}else if((null==o?void 0:o.includes("json"))||(null==o?void 0:o.includes("xml"))||(null==o?void 0:o.includes("text"))){const t=e.querySelector(".request-body-param-user-input");(null==t?void 0:t.value)&&(n.body=t.value)}}return n}async onTryClick(e){const t=e.target,r=t.closest(".request-panel"),n=this.buildFetchURL(r),o=this.buildFetchBodyOptions(r),a=this.buildFetchHeaders(r);this.responseUrl="",this.responseHeaders="",this.curlSyntax=this.generateCURLSyntax(n,a,o,r),this.responseStatus="success",this.responseIsBlob=!1,this.respContentDisposition="",this.responseBlobUrl&&(URL.revokeObjectURL(this.responseBlobUrl),this.responseBlobUrl=""),this.fetchCredentials&&(o.credentials=this.fetchCredentials);const i=new AbortController,{signal:s}=i;o.headers=a;const l={url:n,...o};this.dispatchEvent(new CustomEvent("before-try",{bubbles:!0,composed:!0,detail:{request:l,controller:i}}));const c={method:l.method,headers:l.headers,credentials:l.credentials,body:l.body},p=new Request(l.url,c);let d,u;try{let e,r,n;t.disabled=!0,this.responseText="⌛",this.responseMessage="",this.requestUpdate();const o=performance.now();d=await fetch(p,{signal:s});const a=performance.now();u=d.clone(),t.disabled=!1,this.responseMessage=q`${d.statusText?`${d.statusText}:${d.status}`:d.status} <div style="color:var(--light-fg)"> Took ${Math.round(a-o)} milliseconds </div>`,this.responseUrl=d.url;const i={};d.headers.forEach(((e,t)=>{i[t]=e,this.responseHeaders=`${this.responseHeaders}${t}: ${e}\n`}));const l=d.headers.get("content-type");if(0===(await d.clone().text()).length)this.responseText="";else if(l){if("application/x-ndjson"===l)this.responseText=await d.text();else if(l.includes("json"))if(/charset=[^"']+/.test(l)){const e=l.split("charset=")[1],t=await d.arrayBuffer();try{n=new TextDecoder(e).decode(t)}catch{n=new TextDecoder("utf-8").decode(t)}try{r=JSON.parse(n),this.responseText=JSON.stringify(r,null,2)}catch{this.responseText=n}}else r=await d.json(),this.responseText=JSON.stringify(r,null,2);else/^font\/|tar$|zip$|7z$|rtf$|msword$|excel$|\/pdf$|\/octet-stream$|^application\/vnd\./.test(l)?(this.responseIsBlob=!0,this.responseBlobType="download"):/^audio|^image|^video/.test(l)?(this.responseIsBlob=!0,this.responseBlobType="view"):(n=await d.text(),l.includes("xml")?this.responseText=kP()(n,{textNodesOnSameLine:!0,indentor:"  "}):this.responseText=n);if(this.responseIsBlob){const t=d.headers.get("content-disposition");this.respContentDisposition=t?t.split("filename=")[1].replace(/"|'/g,""):"filename",e=await d.blob(),this.responseBlobUrl=URL.createObjectURL(e)}}else n=await d.text(),this.responseText=n;this.dispatchEvent(new CustomEvent("after-try",{bubbles:!0,composed:!0,detail:{request:p,response:u,responseHeaders:i,responseBody:r||n||e,responseStatus:u.ok}}))}catch(e){t.disabled=!1,this.responseStatus="error","AbortError"===e.name?(this.dispatchEvent(new CustomEvent("request-aborted",{bubbles:!0,composed:!0,detail:{err:e,request:p}})),this.responseMessage="Request Aborted",this.responseText="Request Aborted"):(this.dispatchEvent(new CustomEvent("after-try",{bubbles:!0,composed:!0,detail:{err:e,request:p}})),this.responseMessage=`${e.message} (CORS or Network Issue)`)}this.requestUpdate()}liveCURLSyntaxUpdate(e){this.applyCURLSyntax(e),this.requestUpdate()}onGenerateCURLClick(e){const t=this.getRequestPanel(e);this.applyCURLSyntax(t)}getRequestPanel(e){return e.target.closest(".request-panel")}applyCURLSyntax(e){const t=this.buildFetchURL(e),r=this.buildFetchBodyOptions(e),n=this.buildFetchHeaders(e);this.curlSyntax=this.generateCURLSyntax(t,n,r,e)}generateCURLSyntax(e,t,r,n){let o,a="",i="",s="",l="";const c=n.querySelector(".request-body-container");if(!1===e.startsWith("http")){o=new URL(e,window.location.href).href}else o=e;if(a=`curl -X ${this.method.toUpperCase()} "${o}" \\\n`,i=Array.from(t).map((([e,t])=>` -H "${e}: ${t}"`)).join("\\\n"),i&&(i=`${i} \\\n`),r.body instanceof URLSearchParams)s=` -d ${r.body.toString()} \\\n`;else if(r.body instanceof File)s=` --data-binary @${r.body.name} \\\n`;else if(r.body instanceof FormData)l=Array.from(r.body).reduce(((e,[t,r])=>{if(r instanceof File)return[...e,` -F "${t}=@${r.name}"`];const n=r.match(/([^,],)/gm);if(n){const r=n.map((e=>`-F "${t}[]=${e}"`));return[...e,...r]}return[...e,` -F "${t}=${r}"`]}),[]).join("\\\n");else if(c&&c.dataset.selectedRequestBodyType){const e=c.dataset.selectedRequestBodyType,t=n.querySelector(".request-body-param-user-input");if(null==t?void 0:t.value){if(r.body=t.value,e.includes("json"))try{s=` -d '${JSON.stringify(JSON.parse(t.value))}' \\\n`}catch(e){}s||(s=` -d '${t.value.replace(/'/g,"'\"'\"'")}' \\\n`)}}return`${a}${i}${s}${l}`}onAddRemoveFileInput(e,t,r){if("button"!==e.target.tagName.toLowerCase())return;if(e.target.classList.contains("file-input-remove-btn")){return void e.target.closest(".input-set").remove()}const n=e.target.closest(".file-input-container"),o=document.createElement("div");o.setAttribute("class","input-set row");const a=document.createElement("input");a.type="file",a.style.width="200px",a.style.marginTop="2px",a.setAttribute("data-pname",t),a.setAttribute("data-ptype",r.includes("form-urlencode")?"form-urlencode":"form-data"),a.setAttribute("data-array","false"),a.setAttribute("data-file-array","true");const i=document.createElement("button");i.setAttribute("class","file-input-remove-btn"),i.innerHTML="&#x2715;",o.appendChild(a),o.appendChild(i),n.insertBefore(o,e.target)}clearResponseData(){this.responseUrl="",this.responseHeaders="",this.responseText="",this.responseStatus="success",this.responseMessage="",this.responseIsBlob=!1,this.responseBlobType="",this.respContentDisposition="",this.responseBlobUrl&&(URL.revokeObjectURL(this.responseBlobUrl),this.responseBlobUrl="")}disconnectedCallback(){this.curlSyntax="",this.responseBlobUrl&&(URL.revokeObjectURL(this.responseBlobUrl),this.responseBlobUrl=""),super.disconnectedCallback()}};QP([MP({type:String,attribute:"server-url"})],XP.prototype,"serverUrl",void 0),QP([MP({type:Array})],XP.prototype,"servers",void 0),QP([MP({type:String})],XP.prototype,"method",void 0),QP([MP({type:String})],XP.prototype,"path",void 0),QP([MP({type:Array})],XP.prototype,"security",void 0),QP([MP({type:Array})],XP.prototype,"parameters",void 0),QP([MP({type:Object})],XP.prototype,"request_body",void 0),QP([MP({type:Array})],XP.prototype,"api_keys",void 0),QP([MP({type:Object})],XP.prototype,"parser",void 0),QP([MP({type:String})],XP.prototype,"accept",void 0),QP([MP({type:String})],XP.prototype,"callback",void 0),QP([MP({type:String})],XP.prototype,"webhook",void 0),QP([MP({type:String,attribute:!1})],XP.prototype,"responseMessage",void 0),QP([MP({type:String,attribute:!1})],XP.prototype,"responseText",void 0),QP([MP({type:String,attribute:!1})],XP.prototype,"responseHeaders",void 0),QP([MP({type:String,attribute:!1})],XP.prototype,"responseStatus",void 0),QP([MP({type:String,attribute:!1})],XP.prototype,"responseUrl",void 0),QP([MP({type:String,attribute:!1})],XP.prototype,"curlSyntax",void 0),QP([MP({type:String,attribute:"fill-request-fields-with-example"})],XP.prototype,"fillRequestFieldsWithExample",void 0),QP([MP({type:String,attribute:"allow-try"})],XP.prototype,"allowTry",void 0),QP([MP({type:String,attribute:"show-curl-before-try"})],XP.prototype,"showCurlBeforeTry",void 0),QP([MP({type:String,attribute:"render-style"})],XP.prototype,"renderStyle",void 0),QP([MP({type:String,attribute:"schema-style"})],XP.prototype,"schemaStyle",void 0),QP([MP({type:String,attribute:"active-schema-tab"})],XP.prototype,"activeSchemaTab",void 0),QP([MP({type:Object,converter:{fromAttribute:e=>JSON.parse(e),toAttribute:e=>JSON.stringify(e)},attribute:"active-parameter-schema-tabs"})],XP.prototype,"activeParameterSchemaTabs",void 0),QP([MP({type:Number,attribute:"schema-expand-level"})],XP.prototype,"schemaExpandLevel",void 0),QP([MP({type:String,attribute:"schema-description-expanded"})],XP.prototype,"schemaDescriptionExpanded",void 0),QP([MP({type:String,attribute:"allow-schema-description-expand-toggle"})],XP.prototype,"allowSchemaDescriptionExpandToggle",void 0),QP([MP({type:String,attribute:"schema-hide-read-only"})],XP.prototype,"schemaHideReadOnly",void 0),QP([MP({type:String,attribute:"schema-hide-write-only"})],XP.prototype,"schemaHideWriteOnly",void 0),QP([MP({type:String,attribute:"fetch-credentials"})],XP.prototype,"fetchCredentials",void 0),QP([MP({type:String})],XP.prototype,"activeResponseTab",void 0),QP([MP({type:String,attribute:"selected-request-body-type"})],XP.prototype,"selectedRequestBodyType",void 0),QP([MP({type:String,attribute:"selected-request-body-example"})],XP.prototype,"selectedRequestBodyExample",void 0),XP=QP([zP("api-request")],XP);var eR=function(e,t,r,n){var o,a=arguments.length,i=a<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(e,t,r,n);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(i=(a<3?o(i):a>3?o(t,r,i):o(t,r))||i);return a>3&&i&&Object.defineProperty(t,r,i),i};let tR=class extends ie{constructor(){super(...arguments),this.schemaExpandLevel=999}connectedCallback(){super.connectedCallback(),(!this.schemaExpandLevel||this.schemaExpandLevel<1)&&(this.schemaExpandLevel=99999),this.schemaDescriptionExpanded&&"true false".includes(this.schemaDescriptionExpanded)||(this.schemaDescriptionExpanded="false"),this.schemaHideReadOnly&&"true false".includes(this.schemaHideReadOnly)||(this.schemaHideReadOnly="true"),this.schemaHideWriteOnly&&"true false".includes(this.schemaHideWriteOnly)||(this.schemaHideWriteOnly="true")}static get styles(){return[Ke,GP,c`
      .table {
        font-size: var(--font-size-small);
        text-align: left;
        line-height: calc(var(--font-size-small) + 6px);
    ...
    `}generateTree(e,t="object",r="",n="",o="",a=0,i=0,s=""){var l;if("true"===this.schemaHideReadOnly){if("array"===t&&"readonly"===s)return;if(e&&"readonly"===e["::readwrite"])return}if("true"===this.schemaHideWriteOnly){if("array"===t&&"writeonly"===s)return;if(e&&"writeonly"===e["::readwrite"])return}if(!e)return q`<div class="null" style="display:inline;">
        <span style='margin-left:${16*(a+1)}px'> &nbsp; </span>
        <span class="key-label xxx-of-key"> ${n.replace("::OPTION~","")}</span>
        ${"array"===t?q`<span class='mono-font'> [ ] </span>`:"object"===t?q`<span class='mono-font'> { } </span>`:q`<span class='mono-font'> schema undefined </span>`}
      </div>`;const c=(null===(l=e["::type"])||void 0===l?void 0:l.startsWith("xxx-of"))?a:a+1,p="xxx-of-option"===t||"xxx-of-option"===e["::type"]||n.startsWith("::OPTION")?i:i+1,d=16*p;if(0===Object.keys(e).length)return q`<span class="td key object" style='padding-left:${d}px'>${n}</span>`;let u="",h="",f=!1;if(n.startsWith("::ONE~OF")||n.startsWith("::ANY~OF"))u=n.replace("::","").replace("~"," "),f=!0;else if(n.startsWith("::OPTION")){const e=n.split("~");u=e[1],h=e[2]}else u=n;let m="";if("object"===e["::type"]?m="array"===t?"array of object":e["::dataTypeLabel"]||e["::type"]:"array"===e["::type"]&&(m="array"===t?"array of array "+("object"!==r?`of ${r}`:""):e["::dataTypeLabel"]||e["::type"]),"object"==typeof e)return q`
        ${c>=0&&n?q`
            <div class='tr ${c<=this.schemaExpandLevel?"expanded":"collapsed"} ${e["::type"]}' data-obj='${u}' title="${e["::deprecated"]?"Deprecated":""}">
              <div class="td key ${e["::deprecated"]?"deprecated":""}" style='padding-left:${d}px'>
                ${u||h?q`
                    <span class='obj-toggle ${c<this.schemaExpandLevel?"expanded":"collapsed"}' data-obj='${u}'>
                      ${a<this.schemaExpandLevel?"-":"+"}
                    </span>`:""}
                ${"xxx-of-option"===e["::type"]||"xxx-of-array"===e["::type"]||n.startsWith("::OPTION")?q`<span class="xxx-of-key" style="margin-left:-6px">${u}</span><span class="${f?"xxx-of-key":"xxx-of-descr"}">${h}</span>`:u.endsWith("*")?q`<span class="key-label" style="display:inline-block; margin-left:-6px;">${e["::deprecated"]?"✗":""} ${u.substring(0,u.length-1)}</span><span style='color:var(--red);'>*</span>`:q`<span class="key-label" style="display:inline-block; margin-left:-6px;">${e["::deprecated"]?"✗":""} ${"::props"===u?"":u}</span>`}
        ...
        ${Array.isArray(e)&&e[0]?q`${this.generateTree(e[0],"xxx-of-option","","::ARRAY~OF","",c,p,"")}`:q`
            ${Object.keys(e).map((t=>{var r;return q`
              ${["::title","::description","::type","::props","::deprecated","::array-type","::readwrite","::dataTypeLabel"].includes(t)?"array"===e[t]["::type"]||"object"===e[t]["::type"]?q`${this.generateTree("array"===e[t]["::type"]?e[t]["::props"]:e[t],e[t]["::type"],e[t]["::array-type"]||"",t,e[t]["::description"],c,p,e[t]["::readwrite"]?e[t]["::readwrite"]:"")}`:"":q`${this.generateTree("array"===e[t]["::type"]?e[t]["::props"]:e[t],e[t]["::type"],e[t]["::array-type"]||"",t,(null===(r=e[t])||void 0===r?void 0:r["::description"])||"",c,p,e[t]["::readwrite"]?e[t]["::readwrite"]:"")}`}
            `}))}
          `}
        <div>
      `;const[y,v,g,b,x,w,$,k,S]=e.split("~|~");if("🆁"===v&&"true"===this.schemaHideReadOnly)return;if("🆆"===v&&"true"===this.schemaHideWriteOnly)return;const A=y.replace(/┃.*/g,"").replace(/[^a-zA-Z0-9+]/g,"").substring(0,4).toLowerCase(),O=""+(g||b||x||w?'<span class="descr-expand-toggle">➔</span>':"");let E=q``;return E="array"===t?q` 
      ...
      <div class = "tr primitive" title="${S?"Deprecated":""}">
        <div class="td key ${S}" style='padding-left:${d}px'>
          ${S?q`<span style='color:var(--red);'>✗</span>`:""}
          ${(null==u?void 0:u.endsWith("*"))?q`
              <span class="key-label">${u.substring(0,u.length-1)}</span>
              <span style='color:var(--red);'>*</span>`:n.startsWith("::OPTION")?q`<span class='xxx-of-key'>${u}</span><span class="xxx-of-descr">${h}</span>`:q`${u?q`<span class="key-label"> ${u}</span>`:q`<span class="xxx-of-descr">${k}</span>`}`}
        </div>
        ${E}
        <div class='td key-descr' style='font-size: var(--font-size-small)'>
          ${q`<span class="m-markdown-small">
            ${Q_(We("array"===t?`${O} ${o}`:k?`${O} <b>${k}:</b> ${$}`:`${O} ${$}`))}
          </span>`}
          ${g?q`<div class='' style='display:inline-block; line-break:anywhere; margin-right:8px;'> <span class='bold-text'>Constraints: </span> ${g}</div>`:""}
          ${b?q`<div style='display:inline-block; line-break:anywhere; margin-right:8px;'> <span class='bold-text'>Default: </span>${b}</div>`:""}
          ${x?q`<div style='display:inline-block; line-break:anywhere; margin-right:8px;'> <span class='bold-text'>${"const"===y?"Value":"Allowed"}: </span>${x}</div>`:""}
          ${w?q`<div style='display:inline-block; line-break:anywhere; margin-right:8px;'> <span class='bold-text'>Pattern: </span>${w}</div>`:""}
        </div>
      </div>
    `}handleAllEvents(e){const t=e.target;if(t.classList.contains("obj-toggle"))this.toggleObjectExpand(e);else if(t.classList.contains("schema-multiline-toggle"))this.schemaDescriptionExpanded="true"===this.schemaDescriptionExpanded?"false":"true";else if(t.classList.contains("descr-expand-toggle")){const e=t.closest(".tr");e&&(e.classList.toggle("expanded-descr"),e.style.maxHeight=`${e.scrollHeight}`)}}toggleObjectExpand(e){const t=e.target,r=t.closest(".tr");r.classList.contains("expanded")?(r.classList.add("collapsed"),r.classList.remove("expanded"),t.innerText="+"):(r.classList.remove("collapsed"),r.classList.add("expanded"),t.innerText="-")}};eR([MP({type:Number,attribute:"schema-expand-level"})],tR.prototype,"schemaExpandLevel",void 0),eR([MP({type:String,attribute:"schema-description-expanded"})],tR.prototype,"schemaDescriptionExpanded",void 0),eR([MP({type:String,attribute:"allow-schema-description-expand-toggle"})],tR.prototype,"allowSchemaDescriptionExpandToggle",void 0),eR([MP({type:String,attribute:"schema-hide-read-only"})],tR.prototype,"schemaHideReadOnly",void 0),eR([MP({type:String,attribute:"schema-hide-write-only"})],tR.prototype,"schemaHideWriteOnly",void 0),eR([MP({type:Object})],tR.prototype,"data",void 0),tR=eR([zP("schema-table")],tR);var rR=function(e,t,r,n){var o,a=arguments.length,i=a<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(e,t,r,n);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(i=(a<3?o(i):a>3?o(t,r,i):o(t,r))||i);return a>3&&i&&Object.defineProperty(t,r,i),i};let nR=class extends ie{constructor(){super(...arguments),this.selectedStatus="",this.activeSchemaTab="schema",this.headersForEachRespStatus={},this.mimeResponsesForEachStatus={}}static get styles(){return[Ke,Ye,et,Ze,Je,SP,c`
      :where(button, input[type="checkbox"], [tabindex="0"]):focus-visible { box-shadow: var(--focus-shadow); }
      :where(input[type="text"], input[type="password"], select, textarea):focus-visible { border-color: var(--primary-color); }
      .resp-head{
        vertical-align: middle;
    ...
    `}resetSelection(){this.selectedStatus="",this.selectedMimeType=""}responseTemplate(){var e,t,r,n,o;if(!this.responses)return"";for(const a in this.responses){this.selectedStatus||(this.selectedStatus=a);const i={},s=this.responses[a],l=null==s?void 0:s.content;for(const t in l){const r=l[t];this.selectedMimeType||(this.selectedMimeType=t);const n=FP(r.schema,{}),o=NP(r.schema,t,r.examples,r.example,"true"!==this.callback&&"true"!==this.webhook,"true"===this.callback||"true"===this.webhook,t.includes("json")?"json":"text");i[t]={description:this.responses[a].description,examples:o,selectedExample:(null===(e=o[0])||void 0===e?void 0:e.exampleId)||"",schemaTree:n}}const c=[];for(const e in null===(t=this.responses[a])||void 0===t?void 0:t.headers)c.push({name:e,...null===(o=null===(n=null===(r=this.responses)||void 0===r?void 0:r[a])||void 0===n?void 0:n.headers)||void 0===o?void 0:o[e]});this.headersForEachRespStatus[a]=c,this.mimeResponsesForEachStatus[a]=i}return q`
      ${Object.keys(this.responses).length>1?q`<div class='row' style='flex-wrap:wrap'>
          ${Object.keys(this.responses).map((e=>q`
            ${"$$ref"===e?"":q`
                <button 
                  @click="${()=>{var t,r;this.selectedStatus=e,(null===(t=this.responses)||void 0===t?void 0:t[e].content)&&Object.keys(null===(r=this.responses)||void 0===r?void 0:r[e].content)[0]?this.selectedMimeType=Object.keys(this.responses[e].content)[0]:this.selectedMimeType=void 0}}"
      ...
      ${Object.keys(this.responses).map((e=>{var t,r,n;return q`
        <div style = 'display: ${e===this.selectedStatus?"block":"none"}' >
          <div class="top-gap">
            <span class="resp-descr m-markdown ">${Q_(We((null===(r=null===(t=this.responses)||void 0===t?void 0:t[e])||void 0===r?void 0:r.description)||""))}</span>
            ${this.headersForEachRespStatus[e]&&(null===(n=this.headersForEachRespStatus[e])||void 0===n?void 0:n.length)>0?q`${this.responseHeaderListTemplate(this.headersForEachRespStatus[e])}`:""}
          </div>
          ${0===Object.keys(this.mimeResponsesForEachStatus[e]).length?"":q`  
              <div class="tab-panel col">
                ...
                ${"example"===this.activeSchemaTab?q`<div class ='tab-content col' style = 'flex:1;'>
                      ${this.selectedMimeType&&this.mimeExampleTemplate(this.mimeResponsesForEachStatus[e][this.selectedMimeType])}
                    </div>`:q`<div class ='tab-content col' style = 'flex:1;'>
                      ${this.selectedMimeType&&this.mimeSchemaTemplate(this.mimeResponsesForEachStatus[e][this.selectedMimeType])}
                    </div>`}
              </div>
            `}`}))}
    ...
    `:q`
      ...
      `}};rR([MP({type:String})],nR.prototype,"callback",void 0),rR([MP({type:String})],nR.prototype,"webhook",void 0),rR([MP({type:Object})],nR.prototype,"responses",void 0),rR([MP({type:Object})],nR.prototype,"parser",void 0),rR([MP({type:String,attribute:"schema-style"})],nR.prototype,"schemaStyle",void 0),rR([MP({type:String,attribute:"render-style"})],nR.prototype,"renderStyle",void 0),rR([MP({type:String,attribute:"selected-status"})],nR.prototype,"selectedStatus",void 0),rR([MP({type:String,attribute:"selected-mime-type"})],nR.prototype,"selectedMimeType",void 0),rR([MP({type:String,attribute:"active-schema-tab"})],nR.prototype,"activeSchemaTab",void 0),rR([MP({type:Number,attribute:"schema-expand-level"})],nR.prototype,"schemaExpandLevel",void 0),rR([MP({type:String,attribute:"schema-description-expanded"})],nR.prototype,"schemaDescriptionExpanded",void 0),rR([MP({type:String,attribute:"allow-schema-description-expand-toggle"})],nR.prototype,"allowSchemaDescriptionExpandToggle",void 0),rR([MP({type:String,attribute:"schema-hide-read-only"})],nR.prototype,"schemaHideReadOnly",void 0),rR([MP({type:String,attribute:"schema-hide-write-only"})],nR.prototype,"schemaHideWriteOnly",void 0),nR=rR([zP("api-response")],nR);function oR(e){const t=new We.Renderer;return t.heading=(t,r,n,o)=>`<h${r} class="observe-me" id="${e}--${o.slug(n)}">${t}</h${r}>`,t}function aR(e){const t=e.target.closest(".tag-container").querySelector(".tag-description"),r=e.target.closest(".tag-container").querySelector(".tag-icon");if(t&&r){t.classList.contains("expanded")?(t.style.maxHeight="0",t.classList.replace("expanded","collapsed"),r.classList.replace("expanded","collapsed")):(t.style.maxHeight=`${t.scrollHeight}px`,t.classList.replace("collapsed","expanded"),r.classList.replace("collapsed","expanded"))}}function iR(e,t="",r=""){var n,o,a,i,s,l,c,p,d,u,h,f,m,y,v;const g=new Set;for(const t in e.responses)for(const r in null===(n=e.responses[t])||void 0===n?void 0:n.content)g.add(r.trim());const b=[...g].join(", "),x=(null===(a=null===(o=this.resolvedSpec)||void 0===o?void 0:o.securitySchemes)||void 0===a?void 0:a.filter((t=>{var r;return t.finalKeyValue&&(null===(r=e.security)||void 0===r?void 0:r.some((e=>t.securitySchemeId in e)))})))||[],w=null===(s=null===(i=this.resolvedSpec)||void 0===i?void 0:i.securitySchemes)||void 0===s?void 0:s.find((e=>e.securitySchemeId===at&&"-"!==e.value));w&&x.push(w);const $=e.xCodeSamples?mP.call(this,e.xCodeSamples):"";return q`
    ...
    <div class='expanded-endpoint-body observe-me ${e.method} ${e.deprecated?"deprecated":""} ' part="section-operation ${e.elementId}" id='${e.elementId}'>
      ...
      ${q`
        ${e.xBadges&&(null===(l=e.xBadges)||void 0===l?void 0:l.length)>0?q`
      ...
      ${(null===(c=e.externalDocs)||void 0===c?void 0:c.url)||(null===(p=e.externalDocs)||void 0===p?void 0:p.description)?q`<div style="background-color:var(--bg3); padding:2px 8px 8px 8px; margin:8px 0; border-radius:var(--border-radius)"> 
            <div class="m-markdown"> ${Q_(We((null===(d=e.externalDocs)||void 0===d?void 0:d.description)||""))} </div>
            ${(null===(u=e.externalDocs)||void 0===u?void 0:u.url)?q`<a style="font-family:var(--font-mono); font-size:var(--font-size-small)" href="${null===(h=e.externalDocs)||void 0===h?void 0:h.url}" target="_blank">
                  ${null===(f=e.externalDocs)||void 0===f?void 0:f.url} <div style="transform: rotate(270deg) scale(1.5); display: inline-block; margin-left:5px">⇲</div>
                </a>`:""}
          </div>`:""}
      ${$}
      <div class='expanded-req-resp-container'>
        <api-request
          ...
          .api_keys = "${x}"
          .servers = "${e.servers}"
          server-url = "${(null===(y=null===(m=e.servers)||void 0===m?void 0:m[0])||void 0===y?void 0:y.url)||(null===(v=this.selectedServer)||void 0===v?void 0:v.computedUrl)}"
          fill-request-fields-with-example = "${this.fillRequestFieldsWithExample}"
  ...
  `}function sR(){var e,t;return this.resolvedSpec?q`
  ${null===(t=null===(e=this.resolvedSpec)||void 0===e?void 0:e.tags)||void 0===t?void 0:t.map((e=>q`
    ...
    <section class="regular-font section-gap--read-mode" part="section-operations-in-tag">
      ${e.paths.map((e=>iR.call(this,e)))}
    </section>
    `))}
`:""}function lR(e){return q`
  ...
  ${"table"===this.schemaStyle?q`
      ...
      <schema-tree
        ...
        exportparts = "schema-description:schema-description, schema-multiline-toggle:schema-multiline-toggle"
      > </schema-tree>`}
  </div>`}function cR(e,t){return-1!==e.id.indexOf("schemas-")?lR.call(this,e):q`
  <div class='divider'></div>
  <div class='expanded-endpoint-body observe-me ${e.name}' id='cmp--${e.id}' >
    ${q`
  ...
  `}function pR(){var e;return this.resolvedSpec?q`
  ${null===(e=this.resolvedSpec.components)||void 0===e?void 0:e.map((e=>q`
    ...
    <div class='regular-font section-gap--read-mode'>
      ${e.subComponents.filter((e=>!1!==e.expanded)).map((t=>cR.call(this,t,e.name)))}
    </div>
    `))}
`:""}function dR(){const e=new We.Renderer;return e.heading=(e,t,r,n)=>`<h${t} class="observe-me" id="overview--${n.slug(r)}">${e}</h${t}>`,e}function uR(){var e,t,r,n;return q`
    <section id="overview" part="section-overview"
      class="observe-me ${"view"===this.renderStyle?"section-gap":"section-gap--read-mode"}">
      ${(null===(e=this.resolvedSpec)||void 0===e?void 0:e.info)?q`
          ...
          <div id="api-info" style="font-size:calc(var(--font-size-regular) - 1px); margin-top:8px;">
            ${(null===(t=this.resolvedSpec.info.contact)||void 0===t?void 0:t.email)?q`<span>${this.resolvedSpec.info.contact.name||"Email"}: 
                <a href="mailto:${this.resolvedSpec.info.contact.email}" part="anchor anchor-overview">${this.resolvedSpec.info.contact.email}</a>
              </span>`:""}
            ${(null===(r=this.resolvedSpec.info.contact)||void 0===r?void 0:r.url)?q`<span>URL: <a href="${this.resolvedSpec.info.contact.url}" part="anchor anchor-overview">${this.resolvedSpec.info.contact.url}</a></span>`:""}
            ...
            ${this.specUrl&&"true"===this.allowSpecFileDownload?q`
                <div style="display:flex; margin:12px 0; gap:8px; justify-content: start;">
                  <button class="m-btn thin-border" style="min-width:170px" part="btn btn-outline" @click='${()=>{pt(this.specUrl,"openapi-spec")}}'>Download OpenAPI spec</button>
                  ${(null===(n=this.specUrl)||void 0===n?void 0:n.trim().toLowerCase().endsWith("json"))?q`<button class="m-btn thin-border" style="width:200px" part="btn btn-outline" @click='${()=>{dt(this.specUrl)}}'>View OpenAPI spec (New Tab)</button>`:""}
                </div>`:""}
          </div>
          <slot name="overview"></slot>
          <div id="api-description">
          ${this.resolvedSpec.info.description?q`${Q_(`\n                <div class="m-markdown regular-font">\n                ${We(this.resolvedSpec.info.description,"true"===this.infoDescriptionHeadingsInNavBar?{renderer:dR()}:void 0)}\n              </div>`)}`:""}
          </div>
        `:""}
    </section>
  `}function hR(e){var t,r;const n=null===(r=null===(t=this.resolvedSpec)||void 0===t?void 0:t.servers)||void 0===r?void 0:r.find((t=>t.url===e));return!!n&&(this.selectedServer=n,this.requestUpdate(),this.dispatchEvent(new CustomEvent("api-server-change",{bubbles:!0,composed:!0,detail:{selectedServer:n}})),!0)}function fR(e,t){const r=[...e.currentTarget.closest("table").querySelectorAll("input, select")];let n=t.url;r.forEach((e=>{const t=new RegExp(`{${e.dataset.var}}`,"g");n=n.replace(t,e.value)})),t.computedUrl=n,this.requestUpdate()}function mR(){return this.selectedServer&&this.selectedServer.variables?q`
      ...
      ${Object.entries(this.selectedServer.variables).map((e=>q`
        <tr>
          ...
          <td>
            ...
            <select
              data-var = "${e[0]}"
              @input = ${e=>{fR.call(this,e,this.selectedServer)}}
            >
    ...
    `:""}function yR(){var e,t,r;return!this.resolvedSpec||this.resolvedSpec.specLoadError?"":q`
  <section id = 'servers' part="section-servers" style="text-align:left; direction:ltr; margin-top:24px; margin-bottom:24px;" class='regular-font observe-me ${this.renderStyle&&"read focused".includes(this.renderStyle)?"section-gap--read-mode":"section-gap"}'>
    ...
    <div class = 'mono-font' style='margin: 12px 0; font-size:calc(var(--font-size-small) + 1px);'>
      ${this.resolvedSpec.servers&&0!==(null===(e=this.resolvedSpec.servers)||void 0===e?void 0:e.length)?q`
          ${null===(t=this.resolvedSpec)||void 0===t?void 0:t.servers.map(((e,t)=>{var r;return q`
            <input type = 'radio'
              name = 'api_server'
              id = 'srvr-opt-${t}'
              value = '${e.url}'
              @change = ${()=>{hR.call(this,e.url)}}
              .checked = '${(null===(r=this.selectedServer)||void 0===r?void 0:r.url)===e.url}'
  ...
  <nav class='nav-bar ${this.renderStyle}' part='section-navbar'>
    ...
    ${"false"===this.allowSearch&&"false"===this.allowAdvancedSearch?"":q`
      ...
      `}
    ${q`<nav class='nav-scroll' tabindex='-1' part='section-navbar-scroll' @click='${e=>gR.call(this,e)}' @keyup='${e=>gR.call(this,e)}' >
      ${"false"!==this.showInfo&&this.resolvedSpec.info?q`
          ${"true"===this.infoDescriptionHeadingsInNavBar?q`
              ${(null===(t=null===(e=this.resolvedSpec)||void 0===e?void 0:e.infoDescriptionHeaders)||void 0===t?void 0:t.length)?q`<div class='nav-bar-info ${this.navActiveItemMarker}' id='link-overview' data-content-id='overview' data-action='navigate' tabindex='0' part='section-navbar-item section-navbar-overview'> 
                    ${(null===(n=null===(r=this.resolvedSpec.info)||void 0===r?void 0:r.title)||void 0===n?void 0:n.trim())||"Overview"}
                  </div>`:""}
              <div class='overview-headers'>
                ${null===(a=null===(o=this.resolvedSpec)||void 0===o?void 0:o.infoDescriptionHeaders)||void 0===a?void 0:a.map((e=>q`
                  <div
              ...
              ${(null===(s=null===(i=this.resolvedSpec)||void 0===i?void 0:i.infoDescriptionHeaders)||void 0===s?void 0:s.length)?q`<hr style='border-top: 1px solid var(--nav-hover-bg-color); border-width:1px 0 0 0; margin: 15px 0 0 0'/>`:""}
            `:q`<div class='nav-bar-info ${this.navActiveItemMarker}' id='link-overview' data-action='navigate' data-content-id='overview' tabindex='0'> 
              ${(null===(c=null===(l=this.resolvedSpec.info)||void 0===l?void 0:l.title)||void 0===c?void 0:c.trim())||"Overview"}
            </div>`}
        `:""}
      ...
      <!-- TAGS AND PATHS-->
      ${null===(d=null===(p=this.resolvedSpec)||void 0===p?void 0:p.tags)||void 0===d?void 0:d.filter((e=>e.paths.filter((e=>lt(this.matchPaths,e,this.matchType))).length)).map((e=>{var t;return q`
...
`}function xR(e){const t=new We.Renderer;return t.heading=(t,r,n,o)=>`<h${r} class="observe-me" id="${e}--${o.slug(n)}">${t}</h${r}>`,t}function wR(e){return q`
    <div class='regular-font section-gap--focused-mode' part="section-operations-in-tag">
      ${e}
    </div>`}function $R(){var e,t,r,n,o;if("true"===this.showInfo)return wR(uR.call(this));const a=null===(t=null===(e=this.resolvedSpec)||void 0===e?void 0:e.tags)||void 0===t?void 0:t[0],i=null===(o=null===(n=null===(r=this.resolvedSpec)||void 0===r?void 0:r.tags)||void 0===n?void 0:n[0])||void 0===o?void 0:o.paths[0];return wR(a&&i?iR.call(this,i,a.name):"")}function kR(e){return q`
    <h1 id="${e.elementId}">${e.name}</h1>
    ${"show-description"===this.onNavTagClick&&e.description?q`
        <div class="m-markdown">
          ${Q_(`\n            <div class="m-markdown regular-font">\n              ${We(e.description||"","true"===this.infoDescriptionHeadingsInNavBar?{renderer:xR(e.elementId)}:void 0)}\n            </div>`)}
        </div>`:""}
  `}function SR(){var e,t,r,n,o;if(!this.focusedElementId||!this.resolvedSpec)return;const a=this.focusedElementId;let i,s=null,l=null,c=0;if(a.startsWith("overview")&&"true"===this.showInfo)i=uR.call(this);else if("auth"===a&&"true"===this.allowAuthentication)i=hP.call(this);else if("servers"===a&&"true"===this.allowServerSelection)i=yR.call(this);else if("operations-top"===a)i=q`
    <div id="operations-top" class="observe-me">
      <slot name="operations-top"></slot>
    </div>`;else if(a.startsWith("cmp--")&&"true"===this.showComponents)i=pR.call(this);else if(a.startsWith("tag--")){const t=a.indexOf("--",4)>0?a.substring(0,a.indexOf("--",5)):a;l=null===(e=this.resolvedSpec.tags)||void 0===e?void 0:e.find((e=>e.elementId===t)),i=l?wR.call(this,kR.call(this,l)):$R.call(this)}else{for(c=0;c<((null===(t=this.resolvedSpec.tags)||void 0===t?void 0:t.length)||0)&&(l=null===(r=this.resolvedSpec.tags)||void 0===r?void 0:r[c],s=null===(n=this.resolvedSpec.tags)||void 0===n?void 0:n[c].paths.find((e=>`${e.elementId}`===a)),!s);c+=1);if(s){vR(null===(o=this.shadowRoot)||void 0===o?void 0:o.getElementById(`link-${a}`),"expand"),i=wR.call(this,iR.call(this,s,(null==l?void 0:l.name)||"",(null==l?void 0:l.description)||""))}else i=$R.call(this)}return i}function AR(e){if(e.expanded)e.expanded=!1,"true"===this.updateRoute&&this.replaceHistoryState("");else if(e.expanded=!0,"true"===this.updateRoute){const t=`${this.routePrefix||"#"}${e.elementId}`;window.location.hash!==t&&this.replaceHistoryState(e.elementId)}this.requestUpdate()}function OR(e,t="expand-all"){!function(e,t="expand-all"){const r=[...e.querySelectorAll(".section-tag")];"expand-all"===t?r.map((e=>{e.classList.replace("collapsed","expanded")})):r.map((e=>{e.classList.replace("expanded","collapsed")}))}(e.target.closest(".operations-root"),t)}function ER(e,t=!1){return q`
  <summary @click="${()=>{AR.call(this,e)}}" part="section-endpoint-head-${e.expanded?"expanded":"collapsed"}" class='endpoint-head ${e.method} ${e.deprecated?"deprecated":""} ${t||e.expanded?"expanded":"collapsed"}'>
  ...
  `}function TR(e){var t,r,n,o,a,i,s,l,c,p,d,u,h;const f=new Set;for(const r in e.responses)for(const n in null===(t=e.responses[r])||void 0===t?void 0:t.content)f.add(n.trim());const m=[...f].join(", "),y=(null===(n=null===(r=this.resolvedSpec)||void 0===r?void 0:r.securitySchemes)||void 0===n?void 0:n.filter((t=>{var r;return t.finalKeyValue&&(null===(r=e.security)||void 0===r?void 0:r.some((e=>t.securitySchemeId in e)))})))||[],v=null===(a=null===(o=this.resolvedSpec)||void 0===o?void 0:o.securitySchemes)||void 0===a?void 0:a.find((e=>e.securitySchemeId===at&&"-"!==e.value));v&&y.push(v);const g=e.xCodeSamples?mP(e.xCodeSamples):"";return q`
  <div part="section-endpoint-body-${e.expanded?"expanded":"collapsed"}" class='endpoint-body ${e.method} ${e.deprecated?"deprecated":""}'>
    <div class="summary">
      ...
      ${e.xBadges&&(null===(i=e.xBadges)||void 0===i?void 0:i.length)>0?q`
      ...
      ${(null===(s=e.externalDocs)||void 0===s?void 0:s.url)||(null===(l=e.externalDocs)||void 0===l?void 0:l.description)?q`<div style="background-color:var(--bg3); padding:2px 8px 8px 8px; margin:8px 0; border-radius:var(--border-radius)"> 
            <div class="m-markdown"> ${Q_(We((null===(c=e.externalDocs)||void 0===c?void 0:c.description)||""))} </div>
            ${(null===(p=e.externalDocs)||void 0===p?void 0:p.url)?q`<a style="font-family:var(--font-mono); font-size:var(--font-size-small)" href="${null===(d=e.externalDocs)||void 0===d?void 0:d.url}" target="_blank"> 
                  ${null===(u=e.externalDocs)||void 0===u?void 0:u.url} <div style="transform: rotate(270deg) scale(1.5); display: inline-block; margin-left:5px">⇲</div>
                </a>`:""}
          </div>`:""}
      <slot name="${e.elementId}"></slot>
      ${fP.call(this,e.security)}
    ...
    <div class='req-resp-container'> 
      <div style="display:flex; flex-direction:column" class="view-mode-request ${this.layout}-layout">
        <api-request
          ...
          .api_keys = "${y}"
          .servers = "${e.servers}" 
          server-url = "${Array.isArray(e.servers)&&e.servers.length>0?e.servers[0].url:null===(h=this.selectedServer)||void 0===h?void 0:h.computedUrl}" 
          active-schema-tab = "${this.defaultSchemaTab}"
          fill-request-fields-with-example = "${this.fillRequestFieldsWithExample}"
          allow-try = "${this.allowTry}"
          show-curl-before-try = "${this.showCurlBeforeTry}"
  ...
  </div>`}function CR(e=!0,t=!0,r=!1){var n;return this.resolvedSpec?q`
    ${e?q`
        <div style="display:flex; justify-content:flex-end;"> 
          <span @click="${e=>OR(e,"expand-all")}" style="color:var(--primary-color); cursor:pointer;">
            Expand all
          </span> 
          &nbsp;|&nbsp; 
          <span @click="${e=>OR(e,"collapse-all")}" style="color:var(--primary-color); cursor:pointer;" >
            Collapse all
          </span> 
          &nbsp; sections
        </div>`:""}
    ${null===(n=this.resolvedSpec.tags)||void 0===n?void 0:n.map((e=>q`
      ${t?q` 
...
`}
    ...
    <div style="margin: 0px 8px;display:flex;flex:1">
      ...
      ${"false"===this.allowSearch||this.renderStyle&&"read focused".includes(this.renderStyle)?"":q`  
      ...
      ${"false"===this.allowAdvancedSearch||this.renderStyle&&"read focused".includes(this.renderStyle)?"":q`
...
`;var _R=function(e,t,r,n){var o,a=arguments.length,i=a<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(e,t,r,n);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(i=(a<3?o(i):a>3?o(t,r,i):o(t,r))||i);return a>3&&i&&Object.defineProperty(t,r,i),i};let PR=class extends ie{static get styles(){return[IR]}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",(e=>{"Escape"===e.code&&this.onClose()}))}attributeChangedCallback(e,t,r){t!==r&&("heading"===e&&(this.heading=r),"show"===e&&(this.show=r,"true"===r&&document.dispatchEvent(new CustomEvent("open",{bubbles:!0,composed:!0,detail:this})))),super.attributeChangedCallback(e,t,r)}render(){return q`
    ${"true"===this.show?q`
        ...
        </div>`:""}`}onClose(){document.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}};_R([MP({type:String,attribute:"heading"})],PR.prototype,"heading",void 0),_R([MP({type:String,attribute:"show"})],PR.prototype,"show",void 0),PR=_R([zP("dialog-box")],PR);function RR(){var e;return document.addEventListener("close",(()=>{this.showAdvancedSearchDialog=!1})),document.addEventListener("open",(e=>this.onOpenSearchDialog(e))),q`
    <dialog-box 
      heading="Search" 
  ...
  `}const LR={color:{inputReverseFg:"#fff",inputReverseBg:"#333",headerBg:"#444",getRgb(e){if(0===e.indexOf("#")&&(e=e.slice(1,7)),3!==e.length&&4!==e.length||(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),6!==e.length)throw new Error("Invalid HEX color.");return{r:parseInt(e.slice(0,2),16),g:parseInt(e.slice(2,4),16),b:parseInt(e.slice(4,6),16)}},luminanace(e){const t=this.getRgb(e);return.299*t.r+.587*t.g+.114*t.b},invert(e){return this.luminanace(e)>135?"#000":"#fff"},opacity(e,t){const r=this.getRgb(e);return`rgba(${r.r}, ${r.g}, ${r.b}, ${t})`},brightness(e,t){const r=this.getRgb(e);return r.r+=t,r.g+=t,r.b+=t,r.r>255?r.r=255:r.r<0&&(r.r=0),r.g>255?r.g=255:r.g<0&&(r.g=0),r.b>255?r.b=255:r.b<0&&(r.b=0),`#${r.r.toString(16).padStart(2,"0")}${r.g.toString(16).padStart(2,"0")}${r.b.toString(16).padStart(2,"0")}`},hasGoodContrast(e,t){return this.luminanace(e)-this.luminanace(t)}}};function DR(e){return!!e&&/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3}|[A-Fa-f0-9]{8}|[A-Fa-f0-9]{4})$/i.test(e)}function FR(e,t={}){let r={};const n=t.primaryColor?t.primaryColor:"dark"===e?"#f76b39":"#ff591e",o=LR.color.invert(n),a=LR.color.opacity(n,.4);if("dark"===e){const e=t.bg1?t.bg1:"#2a2b2c",i=t.fg1?t.fg1:"#bbb",s=t.bg2?t.bg2:LR.color.brightness(e,5),l=t.bg3?t.bg3:LR.color.brightness(e,17),c=t.bg3?t.bg3:LR.color.brightness(e,35),p=t.fg2?t.fg2:LR.color.brightness(i,-15),d=t.fg3?t.fg3:LR.color.brightness(i,-20),u=t.fg3?t.fg3:LR.color.brightness(i,-65),h=t.inlineCodeFg?t.inlineCodeFg:"#aaa",f="#bbb",m="#eee",y=t.headerColor?t.headerColor:LR.color.brightness(e,10),v=t.navBgColor?t.navBgColor:LR.color.brightness(e,10),g=t.navTextColor?t.navTextColor:LR.color.opacity(LR.color.invert(v),.5),b=t.navHoverBgColor?t.navHoverBgColor:LR.color.brightness(v,-15),x=t.navHoverTextColor?t.navHoverTextColor:LR.color.invert(v),w=t.navAccentColor?t.navAccentColor:LR.color.brightness(n,25);r={bg1:e,bg2:s,bg3:l,lightBg:c,fg1:i,fg2:p,fg3:d,lightFg:u,inlineCodeFg:h,primaryColor:n,primaryColorTrans:a,primaryColorInvert:o,selectionBg:f,selectionFg:m,overlayBg:"rgba(80, 80, 80, 0.4)",navBgColor:v,navTextColor:g,navHoverBgColor:b,navHoverTextColor:x,navAccentColor:w,navAccentTextColor:t.navAccentTextColor?t.navAccentTextColor:LR.color.invert(w),headerColor:y,headerColorInvert:LR.color.invert(y),headerColorDarker:LR.color.brightness(y,-20),headerColorBorder:LR.color.brightness(y,10),borderColor:t.borderColor||LR.color.brightness(e,20),lightBorderColor:t.lightBorderColor||LR.color.brightness(e,15),codeBorderColor:t.codeBorderColor||LR.color.brightness(e,30),inputBg:t.inputBg||LR.color.brightness(e,-5),placeHolder:t.placeHolder||LR.color.opacity(i,.3),hoverColor:t.hoverColor||LR.color.brightness(e,-10),red:t.red?t.red:"#F06560",lightRed:t.lightRed?t.lightRed:LR.color.brightness(e,-10),pink:t.pink?t.pink:"#ffb2b2",lightPink:t.lightPink||LR.color.brightness(e,-10),green:t.green||"#7ec699",lightGreen:t.lightGreen||LR.color.brightness(e,-10),blue:t.blue||"#71b7ff",lightBlue:t.lightBlue||LR.color.brightness(e,-10),orange:t.orange?t.orange:"#f08d49",lightOrange:t.lightOrange||LR.color.brightness(e,-10),yellow:t.yellow||"#827717",lightYellow:t.lightYellow||LR.color.brightness(e,-10),purple:t.purple||"#786FF1",brown:t.brown||"#D4AC0D",codeBg:t.codeBg||LR.color.opacity(LR.color.brightness(e,-15),.7),codeFg:t.codeFg||"#aaa",codePropertyColor:t.codePropertyColor||"#f8c555",codeKeywordColor:t.codeKeywordColor||"#cc99cd",codeOperatorColor:t.codeOperatorColor||"#67cdcc"}}else{const e=t.bg1?t.bg1:"#fafbfc",i=t.fg1?t.fg1:"#444444",s=t.bg2?t.bg2:LR.color.brightness(e,-5),l=t.bg3?t.bg3:LR.color.brightness(e,-15),c=t.bg3?t.bg3:LR.color.brightness(e,-45),p=t.fg2?t.fg2:LR.color.brightness(i,17),d=t.fg3?t.fg3:LR.color.brightness(i,30),u=t.fg3?t.fg3:LR.color.brightness(i,70),h=t.inlineCodeFg?t.inlineCodeFg:"brown",f="#444",m="#eee",y=t.headerColor?t.headerColor:LR.color.brightness(e,-180),v=t.navBgColor?t.navBgColor:LR.color.brightness(e,-200),g=t.navTextColor?t.navTextColor:LR.color.opacity(LR.color.invert(v),.65),b=t.navHoverBgColor?t.navHoverBgColor:LR.color.brightness(v,-15),x=t.navHoverTextColor?t.navHoverTextColor:LR.color.invert(v),w=t.navAccentColor?t.navAccentColor:LR.color.brightness(n,25);r={bg1:e,bg2:s,bg3:l,lightBg:c,fg1:i,fg2:p,fg3:d,lightFg:u,inlineCodeFg:h,primaryColor:n,primaryColorTrans:a,primaryColorInvert:o,selectionBg:f,selectionFg:m,overlayBg:"rgba(0, 0, 0, 0.4)",navBgColor:v,navTextColor:g,navHoverBgColor:b,navHoverTextColor:x,navAccentColor:w,navAccentTextColor:t.navAccentTextColor?t.navAccentTextColor:LR.color.invert(w),headerColor:y,headerColorInvert:LR.color.invert(y),headerColorDarker:LR.color.brightness(y,-20),headerColorBorder:LR.color.brightness(y,10),borderColor:t.borderColor||LR.color.brightness(e,-38),lightBorderColor:t.lightBorderColor||LR.color.brightness(e,-23),codeBorderColor:t.codeBorderColor||"transparent",inputBg:t.inputBg||LR.color.brightness(e,10),placeHolder:t.placeHolder||LR.color.brightness(u,20),hoverColor:t.hoverColor||LR.color.brightness(e,-5),red:t.red||"#F06560",lightRed:t.lightRed||"#fff0f0",pink:t.pink?t.pink:"#990055",lightPink:t.lightPink?t.lightPink:"#ffb2b2",green:t.green||"#690",lightGreen:t.lightGreen||"#fbfff0",blue:t.blue||"#47AFE8",lightBlue:t.lightBlue||"#eff8fd",orange:t.orange||"#FF9900",lightOrange:t.lightOrange||"#fff5e6",yellow:t.yellow||"#827717",lightYellow:t.lightYellow||"#fff5cc",purple:t.purple||"#786FF1",brown:t.brown||"#D4AC0D",codeBg:t.codeBg||LR.color.opacity(LR.color.brightness(e,-15),.7),codeFg:t.codeFg||"#666",codePropertyColor:t.codePropertyColor||"#905",codeKeywordColor:t.codeKeywordColor||"#07a",codeOperatorColor:t.codeOperatorColor||"#9a6e3a"}}return q`
  <style>
  *, *:before, *:after { box-sizing: border-box; }
  ...
  :host {
    ...
    --code-operator-color:${r.codeOperatorColor};
  ...
  </style>`}function NR(e=!1,t=!0,r=!0,n=!1){var o,a,i;if(!this.resolvedSpec)return"";"true"===this.persistAuth&&aP.call(this);const s={bg1:DR(this.bgColor)?this.bgColor:"",fg1:DR(this.textColor)?this.textColor:"",headerColor:DR(this.headerColor)?this.headerColor:"",primaryColor:DR(this.primaryColor)?this.primaryColor:"",navBgColor:DR(this.navBgColor)?this.navBgColor:"",navTextColor:DR(this.navTextColor)?this.navTextColor:"",navHoverBgColor:DR(this.navHoverBgColor)?this.navHoverBgColor:"",navHoverTextColor:DR(this.navHoverTextColor)?this.navHoverTextColor:"",navAccentColor:DR(this.navAccentColor)?this.navAccentColor:"",navAccentTextColor:DR(this.navAccentTextColor)?this.navAccentTextColor:""};return this.resolvedSpec.specLoadError?e?q`
        ${"dark"===this.theme?FR.call(this,"dark",s):FR.call(this,"light",s)}
        <div style='display:flex; align-items:center; border:1px dashed var(--border-color); height:42px; padding:5px; font-size:var(--font-size-small); color:var(--red); font-family:var(--font-mono)'> ${null===(o=this.resolvedSpec.info)||void 0===o?void 0:o.description} </div>
      `:q`
      ${"dark"===this.theme?FR.call(this,"dark",s):FR.call(this,"light",s)}
      <!-- Header -->
      ${jR.call(this)}
      <main class='main-content regular-font' part='section-main-content'>
        ...
        <div style='margin:24px; text-align: center;'>
          <h1 style='color: var(--red)'> ${null===(a=this.resolvedSpec.info)||void 0===a?void 0:a.title} </h1>
          <div style='font-family:var(--font-mono)'> ${null===(i=this.resolvedSpec.info)||void 0===i?void 0:i.description} </div>
        </div>
      </main>  
    ...
    <!-- Header -->
    ${"false"===this.showHeader?"":jR.call(this)}
    
    <!-- Advanced Search -->
    ${"false"===this.allowAdvancedSearch?"":RR.call(this)}

    <div id='the-main-body' class='body ${this.cssClasses}' dir='${this.pageDirection}' >
      <!-- Side Nav -->
      ${"read"!==this.renderStyle&&"focused"!==this.renderStyle||"true"!==this.showSideNav||!this.resolvedSpec?"":bR.call(this)}
        ...
        <div class='main-content-inner--${this.renderStyle}-mode'>
          ${!0===this.loading?q`<div class='loader'></div>`:q`
              ${!0===this.loadFailed?q`<div style='text-align: center;margin: 16px;'> Unable to load the Spec</div>`:q`
                  ...
                  ${"focused"===this.renderStyle?q`${SR.call(this)}`:q`
                      ${"true"===this.showInfo?uR.call(this):""}
                      ${"true"===this.allowServerSelection?yR.call(this):""}
                      ${"true"===this.allowAuthentication?hP.call(this):""}
                      <div id='operations-top' class='observe-me'>
                        <slot name='operations-top'></slot>
                      </div>  
                      ${"read"===this.renderStyle?sR.call(this):CR.call(this,t,r,n)}
                    `}
                  </div>
                `}`}
        </div>
  ...
  `}var BR=function(e,t,r,n){var o,a=arguments.length,i=a<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(e,t,r,n);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(i=(a<3?o(i):a>3?o(t,r,i):o(t,r))||i);return a>3&&i&&Object.defineProperty(t,r,i),i};let qR=class extends ie{constructor(){super();const e={root:this.getRootNode().host,rootMargin:"-50px 0px -50px 0px",threshold:0};this.showSummaryWhenCollapsed=!0,this.isIntersectionObserverActive=!1,this.intersectionObserver=new IntersectionObserver((e=>{this.onIntersect(e)}),e)}static get styles(){return[Ke,Je,Ye,Ze,Qe,Xe,et,tt,rt,c`
      :host {
        display:flex;
        flex-direction: column;
        min-width:360px;
    ...
    .body {
      ...
      }`,nt]}connectedCallback(){super.connectedCallback();const e=this.parentElement;if(e&&(0===e.offsetWidth&&""===e.style.width&&(e.style.width="100vw"),0===e.offsetHeight&&""===e.style.height&&(e.style.height="100vh"),"BODY"===e.tagName&&(e.style.marginTop||(e.style.marginTop="0"),e.style.marginRight||(e.style.marginRight="0"),e.style.marginBottom||(e.style.marginBottom="0"),e.style.marginLeft||(e.style.marginLeft="0"))),"false"!==this.loadFonts){const e={family:"Open Sans",style:"normal",weight:"300",unicodeRange:"U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+2000-206F, U+2074, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD"},t=new FontFace("Open Sans","url(https://fonts.gstatic.com/s/opensans/v18/mem5YaGs126MiZpBA-UN_r8OUuhpKKSTjw.woff2) format('woff2')",e);e.weight="600";const r=new FontFace("Open Sans","url(https://fonts.gstatic.com/s/opensans/v18/mem5YaGs126MiZpBA-UNirkOUuhpKKSTjw.woff2) format('woff2')",e);t.load().then((e=>{document.fonts.add(e)})),r.load().then((e=>{document.fonts.add(e)}))}this.layout&&"row, column,".includes(`${this.layout},`)||(this.layout="row"),this.renderStyle&&"read, view, focused,".includes(`${this.renderStyle},`)||(this.renderStyle="focused"),this.schemaStyle&&"tree, table,".includes(`${this.schemaStyle},`)||(this.schemaStyle="tree"),this.theme&&"light, dark,".includes(`${this.theme},`)||(this.theme=window.matchMedia&&window.matchMedia("(prefers-color-scheme: light)").matches?"light":"dark"),this.defaultSchemaTab&&"example, schema, model,".includes(`${this.defaultSchemaTab},`)?"model"===this.defaultSchemaTab&&(this.defaultSchemaTab="schema"):this.defaultSchemaTab="example",(!this.schemaExpandLevel||this.schemaExpandLevel<1)&&(this.schemaExpandLevel=99999),this.schemaDescriptionExpanded&&"true, false,".includes(`${this.schemaDescriptionExpanded},`)||(this.schemaDescriptionExpanded="false"),this.schemaHideReadOnly&&"default, never,".includes(`${this.schemaHideReadOnly},`)||(this.schemaHideReadOnly="default"),this.schemaHideWriteOnly&&"default, never,".includes(`${this.schemaHideWriteOnly},`)||(this.schemaHideWriteOnly="default"),this.fillRequestFieldsWithExample&&"true, false,".includes(`${this.fillRequestFieldsWithExample},`)||(this.fillRequestFieldsWithExample="true"),this.persistAuth&&"true, false,".includes(`${this.persistAuth},`)||(this.persistAuth="false"),this.responseAreaHeight||(this.responseAreaHeight="400px"),this.allowSearch&&"true, false,".includes(`${this.allowSearch},`)||(this.allowSearch="true"),this.allowAdvancedSearch&&"true, false,".includes(`${this.allowAdvancedSearch},`)||(this.allowAdvancedSearch="true"),this.allowTry&&"true, false,".includes(`${this.allowTry},`)||(this.allowTry="true"),this.apiKeyValue||(this.apiKeyValue="-"),this.apiKeyLocation||(this.apiKeyLocation="header"),this.apiKeyName||(this.apiKeyName=""),this.oauthReceiver||(this.oauthReceiver="oauth-receiver.html"),this.updateRoute&&"true, false,".includes(`${this.updateRoute},`)||(this.updateRoute="true"),this.routePrefix||(this.routePrefix="#"),this.sortTags&&"true, false,".includes(`${this.sortTags},`)||(this.sortTags="false"),this.generateMissingTags&&"true, false,".includes(`${this.generateMissingTags},`)||(this.generateMissingTags="false"),this.sortEndpointsBy&&"method, path, summary, none,".includes(`${this.sortEndpointsBy},`)||(this.sortEndpointsBy="path"),this.onNavTagClick&&"expand-collapse, show-description,".includes(`${this.onNavTagClick},`)||(this.onNavTagClick="expand-collapse"),this.navItemSpacing&&"compact, relaxed, default,".includes(`${this.navItemSpacing},`)||(this.navItemSpacing="default"),this.showMethodInNavBar&&"false, as-plain-text, as-colored-text, as-colored-block,".includes(`${this.showMethodInNavBar},`)||(this.showMethodInNavBar="false"),this.usePathInNavBar&&"true, false,".includes(`${this.usePathInNavBar},`)||(this.usePathInNavBar="false"),this.navActiveItemMarker&&"left-bar, colored-block".includes(`${this.navActiveItemMarker},`)||(this.navActiveItemMarker="left-bar"),this.fontSize&&"default, large, largest,".includes(`${this.fontSize},`)||(this.fontSize="default"),this.showInfo&&"true, false,".includes(`${this.showInfo},`)||(this.showInfo="true"),this.allowServerSelection&&"true, false,".includes(`${this.allowServerSelection},`)||(this.allowServerSelection="true"),this.allowAuthentication&&"true, false,".includes(`${this.allowAuthentication},`)||(this.allowAuthentication="true"),this.allowSchemaDescriptionExpandToggle&&"true, false,".includes(`${this.allowSchemaDescriptionExpandToggle},`)||(this.allowSchemaDescriptionExpandToggle="true"),this.showSideNav&&"true false".includes(this.showSideNav)||(this.showSideNav="true"),this.showComponents&&"true false".includes(this.showComponents)||(this.showComponents="false"),this.infoDescriptionHeadingsInNavBar&&"true, false,".includes(`${this.infoDescriptionHeadingsInNavBar},`)||(this.infoDescriptionHeadingsInNavBar="false"),this.fetchCredentials&&"omit, same-origin, include,".includes(`${this.fetchCredentials},`)||(this.fetchCredentials=""),this.matchType&&"includes regex".includes(this.matchType)||(this.matchType="includes"),this.showAdvancedSearchDialog||(this.showAdvancedSearchDialog=!1),this.cssFile||(this.cssFile=null),this.cssClasses||(this.cssClasses=""),We.setOptions({highlight:(e,t)=>Ge().languages[t]?Ge().highlight(e,Ge().languages[t],t):e}),window.addEventListener("hashchange",(()=>{this.scrollToPath(this.getElementIDFromURL())}),!0)}disconnectedCallback(){this.intersectionObserver&&this.intersectionObserver.disconnect(),super.disconnectedCallback()}infoDescriptionHeadingRenderer(){const e=new We.Renderer;return e.heading=(e,t,r,n)=>`<h${t} class="observe-me" id="${n.slug(r)}">${e}</h${t}>`,e}render(){var e;const t=document.querySelector(`link[href*="${this.cssFile}"]`);return t&&(null===(e=this.shadowRoot)||void 0===e||e.appendChild(t.cloneNode())),NR.call(this)}observeExpandedContent(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelectorAll(".observe-me");null==t||t.forEach((e=>{var t;null===(t=this.intersectionObserver)||void 0===t||t.observe(e)}))}attributeChangedCallback(e,t,r){var n,o,a;if("spec-url"===e&&t!==r&&window.setTimeout((async()=>{await this.loadSpec(r),this.gotoPath&&!window.location.hash&&this.scrollToPath(this.gotoPath)}),0),"render-style"===e&&("read"===r?window.setTimeout((()=>{this.observeExpandedContent()}),100):null===(n=this.intersectionObserver)||void 0===n||n.disconnect()),"api-key-name"===e||"api-key-location"===e||"api-key-value"===e){let t=!1,n="",i="",s="";if("api-key-name"===e?this.getAttribute("api-key-location")&&this.getAttribute("api-key-value")&&(n=r,i=this.getAttribute("api-key-location"),s=this.getAttribute("api-key-value"),t=!0):"api-key-location"===e?this.getAttribute("api-key-name")&&this.getAttribute("api-key-value")&&(i=r,n=this.getAttribute("api-key-name"),s=this.getAttribute("api-key-value"),t=!0):"api-key-value"===e&&this.getAttribute("api-key-name")&&this.getAttribute("api-key-location")&&(s=r,i=this.getAttribute("api-key-location"),n=this.getAttribute("api-key-name"),t=!0),t&&this.resolvedSpec){const e=null===(o=this.resolvedSpec.securitySchemes)||void 0===o?void 0:o.find((e=>e.securitySchemeId===at));e?(e.name=n,e.in=i,e.value=s,e.finalKeyValue=s):null===(a=this.resolvedSpec.securitySchemes)||void 0===a||a.push({securitySchemeId:at,description:"api-key provided in rapidoc element attributes",type:"apiKey",name:n,in:i,value:s,finalKeyValue:s}),this.requestUpdate()}}super.attributeChangedCallback(e,t,r)}onSpecUrlChange(){var e,t;this.setAttribute("spec-url",null===(t=null===(e=this.shadowRoot)||void 0===e?void 0:e.getElementById("spec-url"))||void 0===t?void 0:t.value)}onSpecFileChange(e){var t,r,n;this.setAttribute("spec-file",null===(r=null===(t=this.shadowRoot)||void 0===t?void 0:t.getElementById("spec-file"))||void 0===r?void 0:r.value);const o=null===(n=(null==e?void 0:e.target).files)||void 0===n?void 0:n[0],a=new FileReader;a.onload=()=>{var e;try{const t=JSON.parse(a.result);this.loadSpec(t),(null===(e=this.shadowRoot)||void 0===e?void 0:e.getElementById("spec-url")).value=""}catch(e){console.error("RapiDoc: Unable to read or parse json")}},a.readAsText(o)}onFileLoadClick(){var e,t;null===(t=null===(e=this.shadowRoot)||void 0===e?void 0:e.getElementById("spec-file"))||void 0===t||t.click()}onSearchChange(e){var t,r,n,o;this.matchPaths=e.target.value,null===(r=null===(t=this.resolvedSpec)||void 0===t?void 0:t.tags)||void 0===r||r.forEach((e=>e.paths.filter((t=>{this.matchPaths&&lt(this.matchPaths,t,this.matchType)&&(e.expanded=!0)})))),null===(o=null===(n=this.resolvedSpec)||void 0===n?void 0:n.components)||void 0===o||o.forEach((e=>e.subComponents.filter((e=>{e.expanded=!1,this.matchPaths&&!function(e,t){return t.name.toLowerCase().includes(e.toLowerCase())}(this.matchPaths,e)||(e.expanded=!0)})))),this.requestUpdate()}onClearSearch(){var e,t,r;(null===(e=this.shadowRoot)||void 0===e?void 0:e.getElementById("nav-bar-search")).value="",this.matchPaths="",null===(r=null===(t=this.resolvedSpec)||void 0===t?void 0:t.components)||void 0===r||r.forEach((e=>e.subComponents.filter((e=>{e.expanded=!0}))))}onShowSearchModalClicked(){this.showAdvancedSearchDialog=!0}async onOpenSearchDialog(e){const t=e.detail.querySelector("input");await it(0),t&&t.focus()}async loadSpec(e){if(e){this.matchPaths="";try{this.resolvedSpec={specLoadError:!1,isSpecLoading:!0,tags:[]},this.loading=!0,this.loadFailed=!1;const t=await M_.call(this,e,"true"===this.generateMissingTags,"true"===this.sortTags,this.getAttribute("sort-endpoints-by"),this.getAttribute("api-key-name"),this.getAttribute("api-key-location"),this.getAttribute("api-key-value"),this.getAttribute("server-url"));this.loading=!1,this.afterSpecParsedAndValidated(t)}catch(e){this.loading=!1,this.loadFailed=!0,this.resolvedSpec=null,console.error(`RapiDoc: Unable to resolve the API spec..  ${e.message}`)}}}async afterSpecParsedAndValidated(e){var t,r,n,o,a,i;for(this.resolvedSpec=e,this.selectedServer=void 0,this.defaultApiServerUrl&&(this.defaultApiServerUrl===this.serverUrl?this.selectedServer={url:this.serverUrl,computedUrl:this.serverUrl}:(null===(t=this.resolvedSpec)||void 0===t?void 0:t.servers)&&(this.selectedServer=this.resolvedSpec.servers.find((e=>e.url===this.defaultApiServerUrl)))),this.selectedServer||(null===(r=this.resolvedSpec)||void 0===r?void 0:r.servers)&&(this.selectedServer=this.resolvedSpec.servers[0]),this.requestUpdate();!await this.updateComplete;);const s=new CustomEvent("spec-loaded",{detail:e});this.dispatchEvent(s),null===(n=this.intersectionObserver)||void 0===n||n.disconnect(),"read"===this.renderStyle&&(await it(100),this.observeExpandedContent()),this.isIntersectionObserverActive=!0;const l=this.getElementIDFromURL();if(l)"view"===this.renderStyle?this.expandAndGotoOperation(l,!0):this.scrollToPath(l);else if("focused"===this.renderStyle&&!this.gotoPath){const e=this.showInfo?"overview":null===(i=null===(a=null===(o=this.resolvedSpec)||void 0===o?void 0:o.tags)||void 0===a?void 0:a[0])||void 0===i?void 0:i.paths[0];this.scrollToPath(e)}}getComponentBaseURL(){var e;const{href:t}=window.location,r=null===(e=this.routePrefix)||void 0===e?void 0:e.replace(/(#|\/)$/,"");if(!r)return t.split("#")[0];const n=t.lastIndexOf(r);return-1===n?t:t.slice(0,n)}getElementIDFromURL(){const e=this.getComponentBaseURL();return window.location.href.replace(e+this.routePrefix,"")}replaceHistoryState(e){const t=this.getComponentBaseURL();window.history.replaceState(null,"",`${t}${this.routePrefix||"#"}${e}`)}expandAndGotoOperation(e,t=!0){var r,n,o,a;if(!this.resolvedSpec)return;let i=!0;const s=-1===e.indexOf("#")?e:e.substring(1);if(s.startsWith("overview")||"servers"===s||"auth"===s)i=!1;else for(let t=0;t<((null===(n=null===(r=this.resolvedSpec)||void 0===r?void 0:r.tags)||void 0===n?void 0:n.length)||0);t++){const r=null===(o=this.resolvedSpec.tags)||void 0===o?void 0:o[t],n=null===(a=null==r?void 0:r.paths)||void 0===a?void 0:a.find((t=>t.elementId===e));n&&(n.expanded&&(null==r?void 0:r.expanded)?i=!1:(n.expanded=!0,r&&(r.expanded=!0)))}t&&(i&&this.requestUpdate(),window.setTimeout((()=>{var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.getElementById(s);t&&(t.scrollIntoView({behavior:"auto",block:"start"}),"true"===this.updateRoute&&this.replaceHistoryState(s))}),i?150:0))}isValidTopId(e){return e.startsWith("overview")||"servers"===e||"auth"===e}isValidPathId(e){var t,r,n,o;return!("overview"!==e||!this.showInfo)||(!("servers"!==e||!this.allowServerSelection)||(!("auth"!==e||!this.allowAuthentication)||(e.startsWith("tag--")?null===(r=null===(t=this.resolvedSpec)||void 0===t?void 0:t.tags)||void 0===r?void 0:r.find((t=>t.elementId===e)):null===(o=null===(n=this.resolvedSpec)||void 0===n?void 0:n.tags)||void 0===o?void 0:o.find((t=>t.paths.find((t=>t.elementId===e)))))))}onIntersect(e){!1!==this.isIntersectionObserverActive&&e.forEach((e=>{var t,r;if(e.isIntersecting&&e.intersectionRatio>0){const n=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(".nav-bar-tag.active, .nav-bar-path.active, .nav-bar-info.active, .nav-bar-h1.active, .nav-bar-h2.active, .operations.active"),o=null===(r=this.shadowRoot)||void 0===r?void 0:r.getElementById(`link-${e.target.id}`);o&&("true"===this.updateRoute&&this.replaceHistoryState(e.target.id),o.scrollIntoView({behavior:"auto",block:"center"}),o.classList.add("active"),o.part.add("section-navbar-active-item")),n&&n!==o&&(n.classList.remove("active"),n.part.remove("section-navbar-active-item"))}}))}handleHref(e){var t,r,n;if("a"===e.target.tagName.toLowerCase()&&(null===(t=e.target.getAttribute("href"))||void 0===t?void 0:t.startsWith("#"))){const t=null===(r=this.shadowRoot)||void 0===r?void 0:r.getElementById(null===(n=e.target.getAttribute("href"))||void 0===n?void 0:n.replace("#",""));t&&t.scrollIntoView({behavior:"auto",block:"start"})}}async scrollToEventTarget(e,t=!0){var r;if("click"!==e.type&&("keyup"!==e.type||13!==e.keyCode))return;const n=e.target;if(n.dataset.contentId){if(this.isIntersectionObserverActive=!1,"focused"===this.renderStyle){const e=null===(r=this.shadowRoot)||void 0===r?void 0:r.querySelector("api-request");e&&e.beforeNavigationFocusedMode()}this.scrollToPath(n.dataset.contentId,!0,t),setTimeout((()=>{this.isIntersectionObserverActive=!0}),300)}}async scrollToPath(e,t=!0,r=!0){var n,o,a,i,s;if("focused"===this.renderStyle&&(this.focusedElementId=e,await it(0)),"view"===this.renderStyle)this.expandAndGotoOperation(e,t);else{let t=!1;const l=null===(n=this.shadowRoot)||void 0===n?void 0:n.getElementById(e);if(l?(t=!0,l.scrollIntoView({behavior:"auto",block:"start"})):t=!1,t){if("focused"===this.renderStyle){const e=null===(o=this.shadowRoot)||void 0===o?void 0:o.querySelector("api-request");e&&e.afterNavigationFocusedMode();const t=null===(a=this.shadowRoot)||void 0===a?void 0:a.querySelector("api-response");t&&t.resetSelection()}"true"===this.updateRoute&&this.replaceHistoryState(e);const t=null===(i=this.shadowRoot)||void 0===i?void 0:i.getElementById(`link-${e}`);if(t){r&&t.scrollIntoView({behavior:"auto",block:"center"}),await it(0);const e=null===(s=this.shadowRoot)||void 0===s?void 0:s.querySelector(".nav-bar-tag.active, .nav-bar-path.active, .nav-bar-info.active, .nav-bar-h1.active, .nav-bar-h2.active, .operations.active");e&&(e.classList.remove("active"),e.part.remove("active"),e.part.remove("section-navbar-active-item")),t.classList.add("active"),t.part.add("section-navbar-active-item")}}}}setHttpUserNameAndPassword(e,t,r){return tP.call(this,e,t,r)}setApiKey(e,t){return tP.call(this,e,"","",t)}removeAllSecurityKeys(){return rP.call(this)}setApiServer(e){return hR.call(this,e)}onAdvancedSearch(e,t){const r=e.target;clearTimeout(this.timeoutId),this.timeoutId=setTimeout((()=>{var e;let t;t="text"===r.type?r:r.closest(".advanced-search-options").querySelector("input[type=text]");const n=[...r.closest(".advanced-search-options").querySelectorAll("input:checked")].map((e=>e.id));this.advancedSearchMatches=function(e,t,r=[]){if(!e.trim()||0===r.length)return;const n=[];return null==t||t.forEach((t=>{t.paths.forEach((t=>{var o,a,i,s;let l="";if(r.includes("search-api-path")&&(l=t.path),r.includes("search-api-descr")&&(l=`${l} ${t.summary||t.description||""}`),r.includes("search-api-params")&&(l=`${l} ${(null===(o=t.parameters)||void 0===o?void 0:o.map((e=>e.name)).join(" "))||""}`),r.includes("search-api-request-body")&&t.requestBody){let e=new Set;for(const r in null===(a=t.requestBody)||void 0===a?void 0:a.content)(null===(i=t.requestBody.content[r].schema)||void 0===i?void 0:i.properties)&&(e=ct(null===(s=t.requestBody.content[r].schema)||void 0===s?void 0:s.properties)),l=`${l} ${[...e].join(" ")}`}r.includes("search-api-resp-descr")&&(l=`${l} ${Object.values(t.responses).map((e=>e.description||"")).join(" ")}`),l.toLowerCase().includes(e.trim().toLowerCase())&&n.push({elementId:t.elementId,method:t.method,path:t.path,summary:t.summary||t.description||"",deprecated:t.deprecated})}))})),n}(t.value,null===(e=this.resolvedSpec)||void 0===e?void 0:e.tags,n)}),t)}onSelectExample(e,t){console.info("Not implemented")}};BR([MP({type:String,attribute:"heading-text"})],qR.prototype,"headingText",void 0),BR([MP({type:String,attribute:"goto-path"})],qR.prototype,"gotoPath",void 0),BR([MP({type:String,attribute:"update-route"})],qR.prototype,"updateRoute",void 0),BR([MP({type:String,attribute:"route-prefix"})],qR.prototype,"routePrefix",void 0),BR([MP({type:String,attribute:"spec-url"})],qR.prototype,"specUrl",void 0),BR([MP({type:String,attribute:"sort-tags"})],qR.prototype,"sortTags",void 0),BR([MP({type:String,attribute:"generate-missing-tags"})],qR.prototype,"generateMissingTags",void 0),BR([MP({type:String,attribute:"sort-endpoints-by"})],qR.prototype,"sortEndpointsBy",void 0),BR([MP({type:String,attribute:!1})],qR.prototype,"specFile",void 0),BR([MP({type:String})],qR.prototype,"layout",void 0),BR([MP({type:String,attribute:"render-style"})],qR.prototype,"renderStyle",void 0),BR([MP({type:String,attribute:"default-schema-tab"})],qR.prototype,"defaultSchemaTab",void 0),BR([MP({type:String,attribute:"response-area-height"})],qR.prototype,"responseAreaHeight",void 0),BR([MP({type:String,attribute:"fill-request-fields-with-example"})],qR.prototype,"fillRequestFieldsWithExample",void 0),BR([MP({type:String,attribute:"persist-auth"})],qR.prototype,"persistAuth",void 0),BR([MP({type:String,attribute:"on-nav-tag-click"})],qR.prototype,"onNavTagClick",void 0),BR([MP({type:String,attribute:"schema-style"})],qR.prototype,"schemaStyle",void 0),BR([MP({type:Number,attribute:"schema-expand-level"})],qR.prototype,"schemaExpandLevel",void 0),BR([MP({type:String,attribute:"schema-description-expanded"})],qR.prototype,"schemaDescriptionExpanded",void 0),BR([MP({type:String,attribute:"schema-hide-read-only"})],qR.prototype,"schemaHideReadOnly",void 0),BR([MP({type:String,attribute:"schema-hide-write-only"})],qR.prototype,"schemaHideWriteOnly",void 0),BR([MP({type:String,attribute:"api-key-name"})],qR.prototype,"apiKeyName",void 0),BR([MP({type:String,attribute:"api-key-location"})],qR.prototype,"apiKeyLocation",void 0),BR([MP({type:String,attribute:"api-key-value"})],qR.prototype,"apiKeyValue",void 0),BR([MP({type:String,attribute:"default-api-server"})],qR.prototype,"defaultApiServerUrl",void 0),BR([MP({type:String,attribute:"server-url"})],qR.prototype,"serverUrl",void 0),BR([MP({type:String,attribute:"oauth-receiver"})],qR.prototype,"oauthReceiver",void 0),BR([MP({type:String,attribute:"show-header"})],qR.prototype,"showHeader",void 0),BR([MP({type:String,attribute:"show-side-nav"})],qR.prototype,"showSideNav",void 0),BR([MP({type:String,attribute:"show-info"})],qR.prototype,"showInfo",void 0),BR([MP({type:String,attribute:"allow-authentication"})],qR.prototype,"allowAuthentication",void 0),BR([MP({type:String,attribute:"allow-try"})],qR.prototype,"allowTry",void 0),BR([MP({type:String,attribute:"show-curl-before-try"})],qR.prototype,"showCurlBeforeTry",void 0),BR([MP({type:String,attribute:"allow-spec-url-load"})],qR.prototype,"allowSpecUrlLoad",void 0),BR([MP({type:String,attribute:"allow-spec-file-load"})],qR.prototype,"allowSpecFileLoad",void 0),BR([MP({type:String,attribute:"allow-spec-file-download"})],qR.prototype,"allowSpecFileDownload",void 0),BR([MP({type:String,attribute:"allow-search"})],qR.prototype,"allowSearch",void 0),BR([MP({type:String,attribute:"allow-advanced-search"})],qR.prototype,"allowAdvancedSearch",void 0),BR([MP({type:String,attribute:"allow-server-selection"})],qR.prototype,"allowServerSelection",void 0),BR([MP({type:String,attribute:"allow-schema-description-expand-toggle"})],qR.prototype,"allowSchemaDescriptionExpandToggle",void 0),BR([MP({type:String,attribute:"show-components"})],qR.prototype,"showComponents",void 0),BR([MP({type:String,attribute:"page-direction"})],qR.prototype,"pageDirection",void 0),BR([MP({type:String})],qR.prototype,"theme",void 0),BR([MP({type:String,attribute:"bg-color"})],qR.prototype,"bgColor",void 0),BR([MP({type:String,attribute:"text-color"})],qR.prototype,"textColor",void 0),BR([MP({type:String,attribute:"header-color"})],qR.prototype,"headerColor",void 0),BR([MP({type:String,attribute:"primary-color"})],qR.prototype,"primaryColor",void 0),BR([MP({type:String,attribute:"font-size"})],qR.prototype,"fontSize",void 0),BR([MP({type:String,attribute:"regular-font"})],qR.prototype,"regularFont",void 0),BR([MP({type:String,attribute:"mono-font"})],qR.prototype,"monoFont",void 0),BR([MP({type:String,attribute:"load-fonts"})],qR.prototype,"loadFonts",void 0),BR([MP({type:String,attribute:"css-file"})],qR.prototype,"cssFile",void 0),BR([MP({type:String,attribute:"css-classes"})],qR.prototype,"cssClasses",void 0),BR([MP({type:String,attribute:"nav-bg-color"})],qR.prototype,"navBgColor",void 0),BR([MP({type:String,attribute:"nav-text-color"})],qR.prototype,"navTextColor",void 0),BR([MP({type:String,attribute:"nav-hover-bg-color"})],qR.prototype,"navHoverBgColor",void 0),BR([MP({type:String,attribute:"nav-hover-text-color"})],qR.prototype,"navHoverTextColor",void 0),BR([MP({type:String,attribute:"nav-accent-color"})],qR.prototype,"navAccentColor",void 0),BR([MP({type:String,attribute:"nav-accent-text-color"})],qR.prototype,"navAccentTextColor",void 0),BR([MP({type:String,attribute:"nav-active-item-marker"})],qR.prototype,"navActiveItemMarker",void 0),BR([MP({type:String,attribute:"nav-item-spacing"})],qR.prototype,"navItemSpacing",void 0),BR([MP({type:String,attribute:"show-method-in-nav-bar"})],qR.prototype,"showMethodInNavBar",void 0),BR([MP({type:String,attribute:"use-path-in-nav-bar"})],qR.prototype,"usePathInNavBar",void 0),BR([MP({type:String,attribute:"info-description-headings-in-navbar"})],qR.prototype,"infoDescriptionHeadingsInNavBar",void 0),BR([MP({type:String,attribute:"fetch-credentials"})],qR.prototype,"fetchCredentials",void 0),BR([MP({type:String,attribute:"match-paths"})],qR.prototype,"matchPaths",void 0),BR([MP({type:String,attribute:"match-type"})],qR.prototype,"matchType",void 0),BR([MP({type:Boolean})],qR.prototype,"loading",void 0),BR([MP({type:String})],qR.prototype,"focusedElementId",void 0),BR([MP({type:Boolean})],qR.prototype,"showAdvancedSearchDialog",void 0),BR([MP({type:Array})],qR.prototype,"advancedSearchMatches",void 0),qR=BR([zP("rapi-doc")],qR);var zR=function(e,t,r,n){var o,a=arguments.length,i=a<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)i=Reflect.decorate(e,t,r,n);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(i=(a<3?o(i):a>3?o(t,r,i):o(t,r))||i);return a>3&&i&&Object.defineProperty(t,r,i),i};let UR=class extends ie{connectedCallback(){this.receiveAuthParms()}receiveAuthParms(){let e={};if(document.location.search){const t=new URLSearchParams(document.location.search);e={code:t.get("code"),error:t.get("error"),state:t.get("state"),responseType:"code"}}else if(window.location.hash){e={token_type:this.parseQueryString(window.location.hash.substring(1),"token_type"),access_token:this.parseQueryString(window.location.hash.substring(1),"access_token"),responseType:"token"}}window.opener?window.opener.postMessage(e):sessionStorage.setItem("rapidoc-oauth-data",JSON.stringify(e))}relayAuthParams(e){if(window.parent&&"rapidoc-oauth-data"===e.key){const t=JSON.parse(e.newValue);window.parent.postMessage(t)}}parseQueryString(e,t){const r=e.split("&");for(let e=0;e<r.length;e++){const n=r[e].split("=");if(decodeURIComponent(n[0])===t)return decodeURIComponent(n[1])}return""}};UR=zR([zP("oauth-receiver")],UR);function MR(){var e,t;return q`
  <nav class='nav-bar' part="section-navbar">
    <slot name="nav-logo" class="logo"></slot>
    ...
    <nav style="flex:1" class='nav-scroll' part="section-navbar-scroll">
      ${null===(t=null===(e=this.resolvedSpec)||void 0===e?void 0:e.schemaAndExamples)||void 0===t?void 0:t.map((e=>q`
  ...
  `}function HR(){var e,t;return q`
    ${"true"===this.showInfo?uR.call(this):""}
    <div style="font-size:var(--font-size-regular);">
    ${null===(t=null===(e=this.resolvedSpec)||void 0===e?void 0:e.schemaAndExamples)||void 0===t?void 0:t.map((e=>{var t;const r=NP(e.schema,"json",e.examples,e.example,!0,!1,"json",!0);return e.selectedExample=null===(t=r[0])||void 0===t?void 0:t.exampleId,q`
  ...
  `}function WR(e=!1){var t,r,n;if(!this.resolvedSpec)return"";const o={bg1:DR(this.bgColor)?this.bgColor:"",fg1:DR(this.textColor)?this.textColor:"",headerColor:DR(this.headerColor)?this.headerColor:"",primaryColor:DR(this.primaryColor)?this.primaryColor:"",navBgColor:DR(this.navBgColor)?this.navBgColor:"",navTextColor:DR(this.navTextColor)?this.navTextColor:"",navHoverBgColor:DR(this.navHoverBgColor)?this.navHoverBgColor:"",navHoverTextColor:DR(this.navHoverTextColor)?this.navHoverTextColor:"",navAccentColor:DR(this.navAccentColor)?this.navAccentColor:"",navAccentTextColor:DR(this.navAccentTextColor)?this.navAccentTextColor:""};return this.resolvedSpec.specLoadError?e?q`
        ${"dark"===this.theme?FR.call(this,"dark",o):FR.call(this,"light",o)}
        <div style="display:flex; align-items:center; border:1px dashed var(--border-color); height:42px; padding:5px; font-size:var(--font-size-small); color:var(--red); font-family:var(--font-mono)"> ${null===(t=this.resolvedSpec.info)||void 0===t?void 0:t.description} </div>
      `:q`
      ${"dark"===this.theme?FR.call(this,"dark",o):FR.call(this,"light",o)}
      <!-- Header -->
      ${jR.call(this)}
      ...
      <main class="main-content regular-font" part="section-main-content">
        <slot></slot>
        <div style="margin:24px; text-align: center;">
          <h1 style="color: var(--red)"> ${null===(r=this.resolvedSpec.info)||void 0===r?void 0:r.title} </h1>
          <div style="font-family:var(--font-mono)"> ${null===(n=this.resolvedSpec.info)||void 0===n?void 0:n.description} </div>
        </div>
      </main>  
    `:this.resolvedSpec.isSpecLoading?q`
      ${"dark"===this.theme?FR.call(this,"dark",o):FR.call(this,"light",o)}
