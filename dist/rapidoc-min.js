          ...
          <div>
            ...
            ${"authorizationCode"===e||"clientCredentials"===e||"implicit"===e||"password"===e?z`
                <button class="m-btn thin-border" part="btn btn-outline"
                  @click="${t=>{$P.call(this,n,e,s,l,t)}}"
                > GET TOKEN </button>`:""}
          </div>
          <div class="oauth-resp-display red-text small-font-size"></div>
          `:""}
    </div>
  `}function AP(e){var t;const r=null===(t=this.resolvedSpec.securitySchemes)||void 0===t?void 0:t.find((t=>t.securitySchemeId===e));if(r.user="",r.password="",r.value="",r.finalKeyValue="","true"===this.persistAuth){const e=gP.call(this);delete e[r.securitySchemeId],yP.call(this,e)}this.requestUpdate()}function EP(e,t,r){""===r?AP.call(this,t):bP.call(this,t),dP.call(this,e.target?e.target:e)}function OP(){var e;if(!this.resolvedSpec)return"";const t=null===(e=this.resolvedSpec.securitySchemes)||void 0===e?void 0:e.filter((e=>e.finalKeyValue));return t?z`
        ...
        <div id="auth-table">
          ${this.resolvedSpec.securitySchemes.map((e=>z`
                  ...
                  <div>
                    ${"cookie"!==e.in?z`
                        <input
                          ...
                          @input="${t=>{EP.call(this,t,e.securitySchemeId,t.target.value)}}"
              ...
              ${"http"===e.type.toLowerCase()&&"basic"===e.scheme.toLowerCase()?z`
                  ...
                  <div>
                    <input
                      ...
                      style="width:100px"
                      @change = ${e=>{dP.call(this,e.target?e.target:e)}}
                    >
                    <input
                      type="password"
                      spellcheck="false"
                    ...
                    <button class="m-btn thin-border"
                      @click="${t=>{bP.call(this,e.securitySchemeId,t)}}"
            ...
            ${"oauth2"===e.type.toLowerCase()?z`
                <div>
                  ${Object.keys(e.flows).map((t=>SP.call(this,t,e["x-client-id"],e["x-client-secret"],e.securitySchemeId,e.flows[t],e["x-default-scopes"],e["x-receive-token-in"])))}
                </div>
                `:""}
          `))}
        </div>`:""}
...
`:void 0}function TP(e){if(this.resolvedSpec.securitySchemes&&e){const t=[];return Array.isArray(e)?0===e.length?"":(e.forEach((e=>{const r=[],n=[];0===Object.keys(e).length?t.push({securityTypes:"None",securityDefs:[]}):(Object.keys(e).forEach((t=>{let o="";const a=this.resolvedSpec.securitySchemes.find((e=>e.securitySchemeId===t));e[t]&&Array.isArray(e[t])&&(o=e[t].join(", ")),a&&(n.push(a.typeDisplay),r.push({...a,scopes:o}))})),t.push({securityTypes:n.length>1?`${n[0]} + ${n.length-1} more`:n[0],securityDefs:r}))})),z`<div style="position:absolute; top:3px; right:2px; font-size:var(--font-size-small); line-height: 1.5;">
  ...
  <div class="tab-panel col"
  ...
  </section>`}function jP(e){return z`
    ...
    `))}
  `}const IP={},_P=W_(class extends V_{constructor(){super(...arguments),this.ot=IP}render(e,t){return t()}update(e,[t,r]){if(Array.isArray(t)){if(Array.isArray(this.ot)&&this.ot.length===t.length&&t.every(((e,t)=>e===this.ot[t])))return N}else if(this.ot===t)return N;return this.ot=Array.isArray(t)?Array.from(t):t,this.render(t,r)}});var PP=r(131),RP=r.n(PP);const LP=c`
.border-top {
  border-top:1px solid var(--border-color);
}
.border{
...
`,c``,c``,c``,c``];customElements.define("json-tree",class extends ae{static get properties(){return{data:{type:Object},renderStyle:{type:String,attribute:"render-style"}}}static get styles(){return[Ge,LP,Ke,c`
      :host{
        display:flex;
      }
...
`;customElements.define("schema-tree",class extends ae{static get properties(){return{data:{type:Object},schemaExpandLevel:{type:Number,attribute:"schema-expand-level"},schemaDescriptionExpanded:{type:String,attribute:"schema-description-expanded"},allowSchemaDescriptionExpandToggle:{type:String,attribute:"allow-schema-description-expand-toggle"},schemaHideReadOnly:{type:String,attribute:"schema-hide-read-only"},schemaHideWriteOnly:{type:String,attribute:"schema-hide-write-only"}}}connectedCallback(){super.connectedCallback(),(!this.schemaExpandLevel||this.schemaExpandLevel<1)&&(this.schemaExpandLevel=99999),this.schemaDescriptionExpanded&&"true false".includes(this.schemaDescriptionExpanded)||(this.schemaDescriptionExpanded="false"),this.schemaHideReadOnly&&"true false".includes(this.schemaHideReadOnly)||(this.schemaHideReadOnly="true"),this.schemaHideWriteOnly&&"true false".includes(this.schemaHideWriteOnly)||(this.schemaHideWriteOnly="true")}static get styles(){return[Ge,FP,LP,c`
    ...
    `]}});function DP(e){var t,r;const n=null!==(t=null==e?void 0:e.width)&&void 0!==t?t:20,o=null!==(r=null==e?void 0:e.height)&&void 0!==r?r:20;return z`
...
`}function zP(e){var t,r;const n=null!==(t=null==e?void 0:e.width)&&void 0!==t?t:20,o=null!==(r=null==e?void 0:e.height)&&void 0!==r?r:20;return z`
    <svg width=${n} height=${o} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="tooltip">
            ...
            ${e.hasTooltip?z`
              <div class="tooltiptext">
                ${e.tooltip.map((t=>{return z`
                  <div style="display:flex;gap: 5px;">
                    ${e.tooltip.length>1?z`
  <div style=${r}>
...
`:""}
    ...
    `}});class NP extends ae{constructor(e,t){super(),this.active=!0,this.message=null!=t?t:"",this.tone=null!=e?e:"positive",this.tones={info:{borderColor:c`#7CBBEA`,bgColor:c`#DEECF7`,icon:DP},positive:{borderColor:c`#83D187`,bgColor:c`#DFF1E0`,icon:DP},warning:{borderColor:c`#F5AE70`,bgColor:c`#FFEBD7`,icon:DP},critical:{borderColor:c`#F49494`,bgColor:c`#F8E3E3`,icon:DP}}}firstUpdated(){const e=e=>{this.renderRoot.querySelectorAll(".toast-active").length>0&&"fadeOut"===e.animationName&&this.onClose()};this.renderRoot.getElementById("toast").addEventListener("animationend",e),this.renderRoot.getElementById("toast").addEventListener("webkitAnimationEnd",e)}onClose(){this.active=!1;this.dispatchEvent(new CustomEvent("closed-toast",{detail:"closed toast",bubbles:!0,composed:!0}))}render(){return z`
        ...
        `}static get styles(){return[c`
            ...
            `]}}var UP,MP,HP;UP=NP,MP="properties",HP={tone:{type:String},tones:{type:{}},message:{type:String},active:{type:Boolean}},(MP=function(e){var t=function(e,t){if("object"!=typeof e||null===e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var n=r.call(e,t||"default");if("object"!=typeof n)return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:String(t)}(MP))in UP?Object.defineProperty(UP,MP,{value:HP,enumerable:!0,configurable:!0,writable:!0}):UP[MP]=HP,customElements.define("toast-component",NP);class WP extends ae{constructor(e,t,r,n,o){super(),this.id=e,this.url=t,this.path=r,this.computedUrl=n,this.variables=o,this.copied=!1,this.showButton=!1,this.showToast=!1,this.addEventListener("closed-toast",(()=>{this.showToast=!1}))}reset(){this.copied=!1,this.showButton=!1}willUpdate(e){e.has("id")&&this.reset()}onButtonClick(){navigator.clipboard.writeText(this.computedUrl+this.path),this.copied=!0}onTextClick(){navigator.clipboard.writeText(this.computedUrl+this.path),this.showToast=!0}onMouseOver(){this.showButton=!0}onMouseLeave(){this.showButton=!1,this.copied=!1}parseURL(){if(!this.variables)return this.url;let{url:e}=this;for(const[t,r]of Object.entries(this.variables)){const n=new RegExp(`{${t}}`,"g");e=e.replace(n,'<span class="variable">{var}</span>'.replace("{var}",r.value))}return e+this.path}render(){return z`
            <div class='container'>
                <div @mouseover="${this.onMouseOver}" @mouseleave="${this.onMouseLeave}" class="content-copy-container">
                    ${z`<span @click="${this.onTextClick}" part="label-operation-path" class="url">${K_(this.parseURL())}</span>`}
        ...
        `}static get styles(){return[c`
          ...
          `]}}function VP(e){var t;const r=null===(t=this.resolvedSpec)||void 0===t?void 0:t.servers.find((t=>t.url===e));return!!r&&(this.selectedServer=r,this.requestUpdate(),this.dispatchEvent(new CustomEvent("api-server-change",{bubbles:!0,composed:!0,detail:{selectedServer:r}})),!0)}function GP(e,t){const r=[...e.currentTarget.closest(".server-vars").querySelectorAll("input, select")];let n=t.url;r.forEach((e=>{t.variables[e.dataset.var].value=e.value;const r=new RegExp(`{${e.dataset.var}}`,"g");n=n.replace(r,e.value)})),t.computedUrl=n,dP.call(this,e.target?e.target:e),this.requestUpdate()}function KP(){return this.selectedServer&&this.selectedServer.variables?z`
      ...
      ${Object.entries(this.selectedServer.variables).map((e=>z`
        <div>
          ...
          <div>
            ...
            <select
              data-var = "${e[0]}"
              @input = ${e=>{GP.call(this,e,this.selectedServer)}}
            >
        ...
        ${e[1].description?z`<div><div style="border:none; margin-top: 4px"><span class="m-markdown-small"> ${K_(He(e[1].description))} </span></div></div>`:""}
      `))}
    </div>
    `:""}function JP(){var e,t,r;return!this.resolvedSpec||this.resolvedSpec.specLoadError?"":z`
  <section id = 'servers' part="section-servers" class='server-template row-api-right-box regular-font observe-me ${"read focused".includes(this.renderStyle)?"section-gap--read-mode":"section-gap"}'>
    ...
    <div style="display: flex; align-items: center;" class="server-template">
      ${null!==(e=this.selectedServer)&&void 0!==e&&e.computedUrl?z`
    ...
    <div class="row-api regular-font request-panel ${"read focused".includes(this.renderStyle)||"true"===this.callback?"read-mode":"view-mode"}">
      <div class="row-api-left">
        ${_P([this.method,this.path,this.allowTry,this.parameters,this.activeParameterSchemaTabs],(()=>this.inputParametersTemplate("path")))}
        ${_P([this.method,this.path,this.allowTry,this.parameters,this.activeParameterSchemaTabs],(()=>this.inputParametersTemplate("query")))}
        ${this.requestBodyTemplate()}
        ${_P([this.method,this.path,this.allowTry,this.parameters,this.activeParameterSchemaTabs],(()=>this.inputParametersTemplate("header")))}
        ${_P([this.method,this.path,this.allowTry,this.parameters,this.activeParameterSchemaTabs],(()=>this.inputParametersTemplate("cookie")))}
    ...
    `}async updated(){"true"===this.showCurlBeforeTry&&this.applyCURLSyntax(this.shadowRoot),"true"===this.webhook&&(this.allowTry="false")}async saveExampleState(){if("focused"===this.renderStyle){[...this.shadowRoot.querySelectorAll("textarea.request-body-param-user-input")].forEach((e=>{e.dataset.user_example=e.value}));[...this.shadowRoot.querySelectorAll('textarea[data-ptype="form-data"]')].forEach((e=>{e.dataset.user_example=e.value})),this.requestUpdate()}}async updateExamplesFromDataAttr(){if("focused"===this.renderStyle){[...this.shadowRoot.querySelectorAll("textarea.request-body-param-user-input")].forEach((e=>{e.value=e.dataset.user_example||e.dataset.example}));[...this.shadowRoot.querySelectorAll('textarea[data-ptype="form-data"]')].forEach((e=>{e.value=e.dataset.user_example||e.dataset.example})),this.requestUpdate()}}renderExample(e,t,r){var n,o;return z`
      ...
      <a
        ...
        @click="${e=>{const t=e.target.closest(".request-card").querySelector(`[data-pname="${r}"]`);t&&(t.value="array"===e.target.dataset.exampleType?e.target.dataset.example.split("~|~"):e.target.dataset.example)}}"
    ...
    `}renderShortFormatExamples(e,t,r){return z`${e.map(((e,n)=>z`
      ...
      ${e.map((e=>{var n,o;return z`
          <li>
            ...
            ${(null===(o=e.description)||void 0===o?void 0:o.length)>0?z`<p>${K_(He(e.description))}</p>`:""}
          </li>
        `}))}
    </ul>`}exampleListTemplate(e,t,r=[]){return z` ${r.length>0?z`<span style="font-weight:bold">Examples: </span>
          ${n=r,n.some((e=>{var t,r;return(null===(t=e.summary)||void 0===t?void 0:t.length)>0||(null===(r=e.description)||void 0===r?void 0:r.length)>0}))?this.renderLongFormatExamples(r,t,e):this.renderShortFormatExamples(r,t,e)}`:""}`;var n}inputParametersTemplate(e){const t=this.parameters?this.parameters.filter((t=>t.in===e)):[];if(0===t.length)return"";let r="";"path"===e?r="Path Params":"query"===e?r="Query-String Params":"header"===e?r="Headers":"cookie"===e&&(r="Cookies");const n=[];for(const r of t){const[t,o,a]=pP(r);if(!t)continue;const i=Z_(t);if(!i)continue;const s=sP(t,{});let l="form",c=!0,p=!1;"query"===e&&(r.style&&"form spaceDelimited pipeDelimited".includes(r.style)?l=r.style:o&&(l=o),"boolean"==typeof r.explode&&(c=r.explode),"boolean"==typeof r.allowReserved&&(p=r.allowReserved));const d=Q_(r.examples||Y_(r.example)||Y_(null==a?void 0:a.example)||(null==a?void 0:a.examples)||Y_(i.examples)||Y_(i.example),i.type);d.exampleVal||"object"!==i.type||(d.exampleVal=lP(t,o||"json","","","true"===this.callback||"true"===this.webhook,"true"!==this.callback&&"true"!==this.webhook,!0,"text")[0].exampleValue),this.resolvedSpec.securitySchemes.some((e=>e.name===r.name))||n.push(z`
              ...
              ${"true"===this.allowTry?z`
                ...
                anchor:anchor, anchor-param-example:anchor-param-example"
                        ...
                        <input type="${"password"===i.format?"password":"text"}" spellcheck="false" style="width:100%" W
                          ...
                          @input = ${e=>{dP.call(this,e.target?e.target:e),this.requestUpdate()}}
                        />`}`:""}
              <span class="param-description">${K_(He(r.description||""))}</span>
    ...
    <div class="request-card">
      ...
      `,a.forEach((e=>{let a,i=[];if(this.selectedRequestBodyType.includes("json")||this.selectedRequestBodyType.includes("xml")||this.selectedRequestBodyType.includes("text")||this.selectedRequestBodyType.includes("jose"))e.mimeType===this.selectedRequestBodyType&&(i=lP(e.schema,e.mimeType,e.examples,e.example,"true"===this.callback||"true"===this.webhook,"true"!==this.callback&&"true"!==this.webhook,"text",!1),this.selectedRequestBodyExample||(this.selectedRequestBodyExample=i.length>0?i[0].exampleId:""),o=z`
            ${o}
            <div class = 'example-panel pad-top-8'>
              ...
              ${i.filter((e=>e.exampleId===this.selectedRequestBodyExample)).map((t=>z`
                <div class="example ${t.exampleId===this.selectedRequestBodyExample?"example-selected":""}" data-example = '${t.exampleId}'>
                  ...
                  ${t.exampleDescription?z`<div class="m-markdown-small" style="padding: 4px 0"> ${K_(He(t.exampleDescription||""))} </div>`:""}
          ...
          `);else if(this.selectedRequestBodyType.includes("form-urlencoded")||this.selectedRequestBodyType.includes("form-data")){if(e.mimeType===this.selectedRequestBodyType){const t=lP(e.schema,e.mimeType,e.examples,e.example,"true"===this.callback||"true"===this.webhook,"true"!==this.callback&&"true"!==this.webhook,"text",!1);e.schema&&(r=this.formDataTemplate(e.schema,e.mimeType,t[0]?t[0].exampleValue:""))}}else/^audio\/|^image\/|^video\/|^font\/|tar$|zip$|7z$|rtf$|msword$|excel$|\/pdf$|\/octet-stream$/.test(this.selectedRequestBodyType)&&e.mimeType===this.selectedRequestBodyType&&(t=z`
          ...
          `);(e.mimeType.includes("json")||e.mimeType.includes("xml")||e.mimeType.includes("text")||this.selectedRequestBodyType.includes("jose"))&&(a=sP(e.schema,{}),"table"===this.schemaStyle?n=z`
            ${n}
            <schema-table
      ...
      <div class='request-body-container' data-selected-request-body-type="${this.selectedRequestBodyType}">
        ...
        ${this.request_body.description?z`<div class="m-markdown" style="margin-bottom:12px">${K_(He(this.request_body.description))}</div>`:""}
    ...
    `}formDataParamAsObjectTemplate(e,t,r){var n;const o=sP(t,{}),a=lP(t,"json",t.examples,t.example,"true"===this.callback||"true"===this.webhook,"true"!==this.callback&&"true"!==this.webhook,"text",!1);return z`
    ...
    `}formDataTemplate(e,t,r=""){const n=[];if(e.properties){for(const r in e.properties){var o,a;const i=e.properties[r];if(i.readOnly)continue;const s=i.examples||i.example||"",l=i.type,c=Z_(i),p="read focused".includes(this.renderStyle)?"200px":"160px",d=Q_(c.examples||c.example,c.type);n.push(z`
                      ...
                      ${c.allowedValues&&c.allowedValues.split("┃").map(((e,t)=>z`
                        ...
                        ${z`
                          <a part="anchor anchor-param-constraint" class = "${"true"===this.allowTry?"":"inactive-link"}"
                            ...
                            data-enum="${e.trim()}"
                            @click="${e=>{const t=e.target.closest("div").querySelector(`[data-pname="${r}"]`);t&&("array"===e.target.dataset.type?t.value=[e.target.dataset.enum]:t.value=e.target.dataset.enum,dP.call(this,t),this.requestUpdate())}}"
                          > 
                            ${e} 
                          </a>`}`))}
                    </div>`:""}
      ...
      <textarea
        ...
        style="width:100%"
      ></textarea>
      ${e.description?z`<span class="m-markdown-small">${K_(He(e.description))}</span>`:""}
    `}curlSyntaxTemplate(e="flex"){return console.log("curlSyntaxTemplate"),console.log(this.curlSyntax),z`
      ...
      <div class="tab-panel col" style="border-width:0 0 1px 0;">
        ...
        ${this.responseIsBlob?z`
            <div class="tab-content col" style="flex:1; display:${"response"===this.activeResponseTab?"flex":"none"};">
              ...
              ${"view"===this.responseBlobType?z`<button class="m-btn thin-border mar-top-8" style="width:135px"  @click='${e=>{pt(this.responseBlobUrl)}}' part="btn btn-outline">VIEW (NEW TAB)</button>`:""}
            </div>`:z`
    ...
    `;if(this.resultLoad){const e=this.renderRoot.host.shadowRoot.children[0];dP.call(this,e.target?e.target:e)}else this.updateComplete.then((()=>{const e=this.renderRoot.host.shadowRoot.children[0];dP.call(this,e.target?e.target:e),this.requestUpdate()})),this.resultLoad=!0;return z`
    ...
    `}async onFillRequestData(e){[...e.target.closest(".request-panel").querySelectorAll("input, tag-input, textarea:not(.is-hidden)")].forEach((e=>{e.dataset.example&&("TAG-INPUT"===e.tagName.toUpperCase()?e.value=e.dataset.example.split("~|~"):e.value=e.dataset.example)}))}async onClearRequestData(e){[...e.target.closest(".request-panel").querySelectorAll("input, tag-input, textarea:not(.is-hidden)")].forEach((e=>{e.value=""}))}buildFetchURL(e){let t;const r=[...e.querySelectorAll("[data-ptype='path']")],n=[...e.querySelectorAll("[data-ptype='query']")],o=[...e.querySelectorAll("[data-ptype='query-object']")];t=this.path,r.map((e=>{t=t.replace(`{${e.dataset.pname}}`,encodeURIComponent(e.value))}));const a=new Map,i=[];n.length>0&&n.forEach((e=>{const t=new URLSearchParams;if("true"===e.dataset.paramAllowReserved&&i.push(e.dataset.pname),"false"===e.dataset.array)""!==e.value&&t.append(e.dataset.pname,e.value);else{const{paramSerializeStyle:r,paramSerializeExplode:n}=e.dataset;let o=e.value&&Array.isArray(e.value)?e.value:[];o=Array.isArray(o)?o.filter((e=>""!==e)):[],o.length>0&&("spaceDelimited"===r?t.append(e.dataset.pname,o.join(" ").replace(/^\s|\s$/g,"")):"pipeDelimited"===r?t.append(e.dataset.pname,o.join("|").replace(/^\||\|$/g,"")):"true"===n?o.forEach((r=>{t.append(e.dataset.pname,r)})):t.append(e.dataset.pname,o.join(",").replace(/^,|,$/g,"")))}t.toString()&&a.set(e.dataset.pname,t)})),o.length>0&&o.map((e=>{const t=new URLSearchParams;try{let r={};const{paramSerializeStyle:n,paramSerializeExplode:o,pname:a}=e.dataset;if(r=Object.assign(r,JSON.parse(e.value.replace(/\s+/g," "))),"true"===e.dataset.paramAllowReserved&&i.push(e.dataset.pname),"json xml".includes(n))"json"===n?t.append(e.dataset.pname,JSON.stringify(r)):"xml"===n&&t.append(e.dataset.pname,eP(r));else for(const e in r){const i=`${a}[${e}]`;"object"==typeof r[e]?Array.isArray(r[e])&&("spaceDelimited"===n?t.append(i,r[e].join(" ")):"pipeDelimited"===n?t.append(i,r[e].join("|")):"true"===o?r[e].forEach((e=>{t.append(i,e)})):t.append(i,r[e])):t.append(i,r[e])}}catch(t){console.error("RapiDoc: unable to parse %s into object",e.value)}t.toString()&&a.set(e.dataset.pname,t)}));let s="";return a.size&&(a.forEach(((e,t)=>{i.includes(t)?(s+=`${t}=`,s+=e.getAll(t).join(`&${t}=`),s+="&"):s+=`${e.toString()}&`})),s=s.slice(0,-1)),0!==s.length&&(t=`${t}${t.includes("?")?"&":"?"}${s}`),this.api_keys.filter((e=>"query"===e.in)).forEach((e=>{t=`${t}${t.includes("?")?"&":"?"}${e.name}=${encodeURIComponent(e.finalKeyValue)}`})),t=`${this.serverUrl.replace(/\/$/,"")}${t}`,t=`/api/proxy/${encodeURIComponent(t)}`,t}buildFetchHeaders(e){var t;const r=null===(t=this.closest(".expanded-req-resp-container, .req-resp-container"))||void 0===t?void 0:t.getElementsByTagName("api-response")[0],n=[...e.querySelectorAll("[data-ptype='header']")],o=e.querySelector(".request-body-container"),a=null==r?void 0:r.selectedMimeType,i=new Headers;if(a?i.append("Accept",a):this.accept&&i.append("Accept",this.accept),this.api_keys.filter((e=>"header"===e.in)).forEach((e=>{i.append(e.name,e.finalKeyValue)})),n.map((e=>{e.value&&i.append(e.dataset.pname,e.value)})),o){const e=o.dataset.selectedRequestBodyType;e.includes("form-data")||i.append("Content-Type",e)}return i}buildFetchBodyOptions(e){const t=e.querySelector(".request-body-container"),r={method:this.method.toUpperCase()};if(t){const n=t.dataset.selectedRequestBodyType;if(n.includes("form-urlencoded")){const t=e.querySelector("[data-ptype='dynamic-form']");if(t){const e=t.value,n=new URLSearchParams;let o,a=!0;if(e)try{o=JSON.parse(e)}catch(e){a=!1,console.warn("RapiDoc: Invalid JSON provided",e)}else a=!1;if(a){for(const e in o)n.append(e,JSON.stringify(o[e]));r.body=n}}else{const t=[...e.querySelectorAll("[data-ptype='form-urlencode']")],n=new URLSearchParams;t.filter((e=>"file"!==e.type)).forEach((e=>{if("false"===e.dataset.array)e.value&&n.append(e.dataset.pname,e.value);else{const t=e.value&&Array.isArray(e.value)?e.value.join(","):"";n.append(e.dataset.pname,t)}})),r.body=n}}else if(n.includes("form-data")){const t=new FormData;[...e.querySelectorAll("[data-ptype='form-data']")].forEach((e=>{"false"===e.dataset.array?"file"===e.type&&e.files[0]?t.append(e.dataset.pname,e.files[0],e.files[0].name):e.value&&t.append(e.dataset.pname,e.value):e.value&&Array.isArray(e.value)&&t.append(e.dataset.pname,e.value.join(","))})),r.body=t}else if(/^audio\/|^image\/|^video\/|^font\/|tar$|zip$|7z$|rtf$|msword$|excel$|\/pdf$|\/octet-stream$/.test(n)){const t=e.querySelector(".request-body-param-file");null!=t&&t.files[0]&&(r.body=t.files[0])}else if(n.includes("json")||n.includes("xml")||n.includes("text")){const t=e.querySelector(".request-body-param-user-input");null!=t&&t.value&&(r.body=t.value)}}return r}async onTryClick(e){console.log("onTryClick");const t=e.target,r=t.closest(".request-panel"),n=this.buildFetchURL(r),o=this.buildFetchBodyOptions(r),a=this.buildFetchHeaders(r);this.responseUrl="",this.responseHeaders=[],this.curlSyntax=this.generateCURLSyntax(n,a,o,r),this.responseStatus="success",this.responseIsBlob=!1,this.respContentDisposition="",this.responseBlobUrl&&(URL.revokeObjectURL(this.responseBlobUrl),this.responseBlobUrl=""),this.fetchCredentials&&(o.credentials=this.fetchCredentials);const i=new AbortController,{signal:s}=i;o.headers=a;const l={url:n,...o};this.dispatchEvent(new CustomEvent("before-try",{bubbles:!0,composed:!0,detail:{request:l,controller:i}}));const c={method:l.method,headers:l.headers,credentials:l.credentials,body:l.body},p=new Request(l.url,c);let d,u;console.log(p);try{let e,r,n;t.disabled=!0,this.responseText="⌛",this.responseMessage="",this.requestUpdate();const o=performance.now();d=await fetch(p,{signal:s});const a=performance.now();u=d.clone(),t.disabled=!1,this.responseMessage=z`${d.statusText?`${d.statusText}:${d.status}`:d.status} <div style="color:var(--light-fg)"> Took ${Math.round(a-o)} milliseconds </div>`,this.responseUrl=d.url,console.log("RESPOSTAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"),console.log(this.responseMessage);const i={};d.headers.forEach(((e,t)=>{i[t]=e,this.responseHeaders=`${this.responseHeaders}${t}: ${e}\n`}));const l=d.headers.get("content-type");if(0===(await d.clone().text()).length)this.responseText="";else if(l){if("application/x-ndjson"===l)this.responseText=await d.text();else if(l.includes("json"))if(/charset=[^"']+/.test(l)){const e=l.split("charset=")[1],t=await d.arrayBuffer();try{n=new TextDecoder(e).decode(t)}catch{n=new TextDecoder("utf-8").decode(t)}try{r=JSON.parse(n),this.responseText=JSON.stringify(r,null,2)}catch{this.responseText=n}}else r=await d.json(),this.responseText=JSON.stringify(r,null,2);else/^font\/|tar$|zip$|7z$|rtf$|msword$|excel$|\/pdf$|\/octet-stream$|^application\/vnd\./.test(l)?(this.responseIsBlob=!0,this.responseBlobType="download"):/^audio|^image|^video/.test(l)?(this.responseIsBlob=!0,this.responseBlobType="view"):(n=await d.text(),l.includes("xml")?this.responseText=RP()(n,{textNodesOnSameLine:!0,indentor:"  "}):this.responseText=n);if(this.responseIsBlob){const t=d.headers.get("content-disposition");this.respContentDisposition=t?t.split("filename=")[1].replace(/"|'/g,""):"filename",e=await d.blob(),this.responseBlobUrl=URL.createObjectURL(e)}}else n=await d.text(),this.responseText=n;this.dispatchEvent(new CustomEvent("after-try",{bubbles:!0,composed:!0,detail:{request:p,response:u,responseHeaders:i,responseBody:r||n||e,responseStatus:u.ok}}))}catch(e){t.disabled=!1,"AbortError"===e.name?(this.dispatchEvent(new CustomEvent("request-aborted",{bubbles:!0,composed:!0,detail:{err:e,request:p}})),this.responseMessage="Request Aborted",this.responseText="Request Aborted"):(this.dispatchEvent(new CustomEvent("after-try",{bubbles:!0,composed:!0,detail:{err:e,request:p}})),this.responseMessage=`${e.message} (CORS or Network Issue)`)}this.requestUpdate()}liveCURLSyntaxUpdate(e){this.applyCURLSyntax(e),this.requestUpdate()}onGenerateCURLClick(e){const t=this.getRequestPanel(e);this.applyCURLSyntax(t)}getRequestPanel(e){return e.target.closest(".request-panel")}applyCURLSyntax(e){const t=this.buildFetchURL(e),r=this.buildFetchBodyOptions(e),n=this.buildFetchHeaders(e);this.curlSyntax=this.generateCURLSyntax(t,n,r,e)}generateCURLSyntax(e,t,r,n){let o,a="",i="",s="",l="";const c=n.querySelector(".request-body-container");if(!1===e.startsWith("http")){o=new URL(e,window.location.href).href}else o=e;if(a=`curl -X ${this.method.toUpperCase()} "${o}" \\\n`,i=Array.from(t).map((([e,t])=>` -H "${e}: ${t}"`)).join("\\\n"),i&&(i=`${i} \\\n`),r.body instanceof URLSearchParams)s=` -d ${r.body.toString()} \\\n`;else if(r.body instanceof File)s=` --data-binary @${r.body.name} \\\n`;else if(r.body instanceof FormData)l=Array.from(r.body).reduce(((e,[t,r])=>{if(r instanceof File)return[...e,` -F "${t}=@${r.name}"`];const n=r.match(/([^,],)/gm);if(n){const r=n.map((e=>`-F "${t}[]=${e}"`));return[...e,...r]}return[...e,` -F "${t}=${r}"`]}),[]).join("\\\n");else if(c&&c.dataset.selectedRequestBodyType){const e=c.dataset.selectedRequestBodyType,t=n.querySelector(".request-body-param-user-input");if(null!=t&&t.value){if(r.body=t.value,e.includes("json"))try{s=` -d '${JSON.stringify(JSON.parse(t.value))}' \\\n`}catch(e){}s||(s=` -d '${t.value.replace(/'/g,"'\"'\"'")}' \\\n`)}}return`${a}${i}${s}${l}`}onAddRemoveFileInput(e,t,r){if("button"!==e.target.tagName.toLowerCase())return;if(e.target.classList.contains("file-input-remove-btn")){return void e.target.closest(".input-set").remove()}const n=e.target.closest(".file-input-container"),o=document.createElement("div");o.setAttribute("class","input-set row");const a=document.createElement("input");a.type="file",a.style="width:200px; margin-top:2px;",a.setAttribute("data-pname",t),a.setAttribute("data-ptype",r.includes("form-urlencode")?"form-urlencode":"form-data"),a.setAttribute("data-array","false"),a.setAttribute("data-file-array","true");const i=document.createElement("button");i.setAttribute("class","file-input-remove-btn"),i.innerHTML="&#x2715;",o.appendChild(a),o.appendChild(i),n.insertBefore(o,e.target)}clearResponseData(){this.responseUrl="",this.responseHeaders="",this.responseText="",this.responseStatus="success",this.responseMessage="",this.responseIsBlob=!1,this.responseBlobType="",this.respContentDisposition="",this.responseBlobUrl&&(URL.revokeObjectURL(this.responseBlobUrl),this.responseBlobUrl="")}disconnectedCallback(){this.curlSyntax="",this.responseBlobUrl&&(URL.revokeObjectURL(this.responseBlobUrl),this.responseBlobUrl=""),super.disconnectedCallback()}});customElements.define("schema-table",class extends ae{static get properties(){return{schemaExpandLevel:{type:Number,attribute:"schema-expand-level"},schemaDescriptionExpanded:{type:String,attribute:"schema-description-expanded"},allowSchemaDescriptionExpandToggle:{type:String,attribute:"allow-schema-description-expand-toggle"},schemaHideReadOnly:{type:String,attribute:"schema-hide-read-only"},schemaHideWriteOnly:{type:String,attribute:"schema-hide-write-only"},data:{type:Object}}}connectedCallback(){super.connectedCallback(),(!this.schemaExpandLevel||this.schemaExpandLevel<1)&&(this.schemaExpandLevel=99999),this.schemaDescriptionExpanded&&"true false".includes(this.schemaDescriptionExpanded)||(this.schemaDescriptionExpanded="false"),this.schemaHideReadOnly&&"true false".includes(this.schemaHideReadOnly)||(this.schemaHideReadOnly="true"),this.schemaHideWriteOnly&&"true false".includes(this.schemaHideWriteOnly)||(this.schemaHideWriteOnly="true")}static get styles(){return[Ge,FP,c`
      ...
      <div class="table ${"true"===this.schemaDescriptionExpanded?"expanded-all-descr":"collapsed-all-descr"}" @click="${e=>this.handleAllEvents(e)}">
        ...
        ${null!==(r=this.data)&&void 0!==r&&r["::description"]?z`<span part="schema-description" class='m-markdown'> ${K_(He(this.data["::description"]||""))}</span>`:""}
    ...
    `}generateTree(e,t="object",r="",n="",o="",a=0,i=0,s=""){var l,c;if("true"===this.schemaHideReadOnly){if("array"===t&&"readonly"===s)return;if(e&&"readonly"===e["::readwrite"])return}if("true"===this.schemaHideWriteOnly){if("array"===t&&"writeonly"===s)return;if(e&&"writeonly"===e["::readwrite"])return}if(!e)return z`<div class="null" style="display:inline;">
        ...
        <span class="key-label xxx-of-key"> ${n.replace("::OPTION~","")}</span>
        ${"array"===t?z`<span class='mono-font'> [ ] </span>`:"object"===t?z`<span class='mono-font'> { } </span>`:z`<span class='mono-font'> schema undefined </span>`}
      </div>`;const p=null!==(l=e["::type"])&&void 0!==l&&l.startsWith("xxx-of")?a:a+1,d="xxx-of-option"===t||"xxx-of-option"===e["::type"]||n.startsWith("::OPTION")?i:i+1,u=10*d;if(0===Object.keys(e).length)return z`<span class="td key object" style='padding-left:${u}px'>${n}</span>`;let h="",f="",m=!1;if(n.startsWith("::ONE~OF")||n.startsWith("::ANY~OF"))h=n.replace("::","").replace("~"," "),m=!0;else if(n.startsWith("::OPTION")){const e=n.split("~");h=e[1],f=e[2]}else h=n;let g="";if("object"===e["::type"]?g="array"===t?"array of object":e["::dataTypeLabel"]||e["::type"]:"array"===e["::type"]&&(g="array"===t?"array of array "+("object"!==r?`of ${r}`:""):e["::dataTypeLabel"]||e["::type"]),"object"==typeof e)return z`
        ${p>=0&&n?z`
            <div class='tr ${p<=this.schemaExpandLevel?"expanded":"collapsed"} ${e["::type"]}' data-obj='${h}' title="${e["::deprecated"]?"Deprecated":""}">
              ...
              <div class='td key-descr' style='line-height:1.7'>${K_(He(o||""))}</div>
            </div>`:z`
    ...
    `}resetSelection(){this.selectedStatus="",this.selectedMimeType=""}getResponseStatusType(e){const t=e.toString();return t.startsWith("1")?"informational":t.startsWith("2")?"success":t.startsWith("3")?"redirection":t.startsWith("4")||t.startsWith("5")?"error":""}responseTemplate(){if(!this.responses)return"";for(const n in this.responses){this.selectedStatus||(this.selectedStatus=n);const o={};for(const r in null===(e=this.responses[n])||void 0===e?void 0:e.content){var e,t;const a=this.responses[n].content[r];this.selectedMimeType||(this.selectedMimeType=r);const i=sP(a.schema,{}),s=lP(a.schema,r,a.examples,a.example,"true"!==this.callback&&"true"!==this.webhook,"true"===this.callback||"true"===this.webhook,r.includes("json")?"json":"text");o[r]={description:this.responses[n].description,examples:s,selectedExample:(null===(t=s[0])||void 0===t?void 0:t.exampleId)||"",schemaTree:i}}const a=[];for(const e in null===(r=this.responses[n])||void 0===r?void 0:r.headers){var r;a.push({name:e,...this.responses[n].headers[e]})}this.headersForEachRespStatus[n]=a,this.mimeResponsesForEachStatus[n]=o}return z`
      ${Object.keys(this.responses).length>=1?z`<div class='row' style='flex-wrap:wrap; gap:12px'>
                ...
                >
                  <div style='display: flex; flex-direction: row; justify-content: flex-start; align-items: center;'>
                    <div style="display: flex; justify-content: center; align-items: center; margin-right: 8px">
                      ${function(e){var t,r;const n=null!==(t=null==e?void 0:e.width)&&void 0!==t?t:16,o=null!==(r=null==e?void 0:e.height)&&void 0!==r?r:16;return z`
  ...
  `}()}
          ...
          <div class="resp-border resp-modal-content">
            ...
            <div class="resp-modal-body">
              ...
              ${0===Object.keys(this.mimeResponsesForEachStatus[e]).length?"":z`  
                  <div class="tab-panel col">
                    ${1===Object.keys(this.mimeResponsesForEachStatus[e]).length?z`<code style = "font-weight:normal; margin-bottom:8px; width:min-content"> ${Object.keys(this.mimeResponsesForEachStatus[e])[0]} </code>`:z`${this.mimeTypeDropdownTemplate(Object.keys(this.mimeResponsesForEachStatus[e]))}`}                                                      
                    <div class="tab-buttons row" @click="${e=>{"button"===e.target.tagName.toLowerCase()&&(this.activeSchemaTab=e.target.dataset.tab)}}" >
                      <button class="tab-btn ${"example"!==this.activeSchemaTab?"active":""}" data-tab = 'schema' >Parameters</button>
                      <button class="tab-btn ${"example"===this.activeSchemaTab?"active":""}" data-tab = 'example'>Example </button>
                      <div style="flex:1"></div>
    ...
    `}responseHeaderListTemplate(e){return z`
      ...
      ${1===e.examples.length?z`
          ${"json"===e.examples[0].exampleFormat?z`
              ...
              ${e.examples[0].exampleDescription?z`<div class="m-markdown-small" style="padding: 4px 0"> ${K_(He(e.examples[0].exampleDescription||""))} </div>`:""}
              <json-tree 
    ...
    <span part="anchor-endpoint" id='${e.elementId}'></span>
      ${"focused"===this.renderStyle&&"General ⦂"!==t?z`<h3 class="operation-tag" style="font-weight:bold" part="section-operation-tag"> ${t} </h3>`:""}
      ...
      ${e.description?z`<div class="m-markdown"> ${K_(He(e.description))}</div>`:""}
      <!-- ${TP.call(this,e.security)} -->
      ${p}
      <div class='expanded-req-resp-container'>
        <api-request
          class = "${this.renderStyle}-mode"
        ...
        ${e.callbacks?jP.call(this,e.callbacks):""}
  ...
  `}function tR(){return this.resolvedSpec?z`
  ${this.resolvedSpec.tags.map((e=>z`
    <section id="${e.elementId}" part="section-tag" class="regular-font section-gap--read-mode observe-me" style="border-top:1px solid var(--primary-color);">
      ...
      ${K_(`\n          <div class="m-markdown regular-font">\n          ${He(e.description||"","true"===this.infoDescriptionHeadingsInNavBar?{renderer:XP(e.elementId)}:void 0)}\n        </div>`)}
      </div>
    </section>
    <section class="regular-font section-gap--read-mode" part="section-operations-in-tag">
      ${e.paths.map((e=>eR.call(this,e)))}
    </section>
    `))}
`:""}function rR(e){return z`
  ...
  ${"table"===this.schemaStyle?z`
      ...
      <schema-tree
        ...
        exportparts = "schema-description:schema-description, schema-multiline-toggle:schema-multiline-toggle"
      > </schema-tree>`}
  </div>`}function nR(e,t){return-1!==e.id.indexOf("schemas-")?rR.call(this,e):z`
  <div class='divider'></div>
  <div class='expanded-endpoint-body observe-me ${e.name}' id='cmp--${e.id}' >
    ${z`
  ...
  `}function oR(){return this.resolvedSpec?z`
  ${this.resolvedSpec.components.map((e=>z`
    ...
    <div class='regular-font section-gap--read-mode'>
      ${e.subComponents.filter((e=>!1!==e.expanded)).map((t=>nR.call(this,t,e.name)))}
    </div>
    `))}
`:""}function aR(){const e=new He.Renderer;return e.heading=(e,t,r,n)=>`<h${t} class="observe-me" id="overview--${n.slug(r)}">${e}</h${t}>`,e}function iR(){var e,t,r,n;return this.resolvedSpec.info.description=QP(this.resolvedSpec.info.description),z`
  ...
  <nav class='nav-bar ${this.renderStyle}' part='section-navbar'>
    ...
    ${"false"===this.allowSearch&&"false"===this.allowAdvancedSearch?"":z`
      ...
      `}
    ${z`<nav class='nav-scroll' tabindex='-1' part='section-navbar-scroll' @click='${e=>lR.call(this,e)}' @keyup='${e=>lR.call(this,e)}' >
      ...
      <!-- TAGS AND PATHS-->
      ${this.resolvedSpec.tags.filter((e=>e.paths.filter((e=>st(this.matchPaths,e,this.matchType))).length)).map((e=>{var t;return z`
          <div class='nav-bar-tag-and-paths ${"read"===this.renderStyle||e.expanded?"expanded":"collapsed"}' >
            ...
            <div class='nav-bar-paths-under-tag' style='max-height:${e.expanded||"read"===this.renderStyle?50*((null===(t=e.paths)||void 0===t?void 0:t.length)||1):0}px;'>
              ...
              ${e.paths.filter((e=>!this.matchPaths||st(this.matchPaths,e,this.matchType))).map((e=>z`
              <div 
...
`}function pR(e){const t=new He.Renderer;return t.heading=(t,r,n,o)=>`<h${r} class="observe-me" id="${e}--${o.slug(n)}">${t}</h${r}>`,t}function dR(e){return z`
    <div class='regular-font section-gap--focused-mode' part="section-operations-in-tag">
      ${e}
    </div>`}function uR(){var e;if("true"===this.showInfo)return dR(iR.call(this));const t=this.resolvedSpec.tags[0],r=null===(e=this.resolvedSpec.tags[0])||void 0===e?void 0:e.paths[0];return dR(t&&r?eR.call(this,r,t.name):"")}function hR(e){return z`
    <h1 id="${e.elementId}">${e.name}</h1>
    ${"show-description"===this.onNavTagClick&&e.description?z`
        <div class="m-markdown">
          ${K_(`\n            <div class="m-markdown regular-font">\n              ${He(e.description||"","true"===this.infoDescriptionHeadingsInNavBar?{renderer:pR(e.elementId)}:void 0)}\n            </div>`)}
        </div>`:""}
  `}function fR(){if(!this.focusedElementId||!this.resolvedSpec)return;const e=this.focusedElementId;let t,r=null,n=null,o=0;if(e.startsWith("overview")&&"true"===this.showInfo)t=iR.call(this);else if("auth"===e&&"true"===this.allowAuthentication)t=OP.call(this);else if("servers"===e&&"true"===this.allowServerSelection)t=JP.call(this);else if("operations-top"===e)t=z`
    <div id="operations-top" class="observe-me">
      <slot name="operations-top"></slot>
    </div>`;else if(e.startsWith("cmp--")&&"true"===this.showComponents)t=oR.call(this);else if(e.startsWith("tag--")){const r=e.indexOf("--",4)>0?e.substring(0,e.indexOf("--",5)):e;n=this.resolvedSpec.tags.find((e=>e.elementId===r)),t=n?dR.call(this,hR.call(this,n)):uR.call(this)}else{for(o=0;o<this.resolvedSpec.tags.length&&(n=this.resolvedSpec.tags[o],r=this.resolvedSpec.tags[o].paths.find((t=>`${t.elementId}`===e)),!r);o+=1);if(r){sR(this.shadowRoot.getElementById(`link-${e}`),"expand"),t=dR.call(this,eR.call(this,r,n.name||"",n.description||""))}else t=uR.call(this)}return t}function mR(e){if(e.expanded)e.expanded=!1,"true"===this.updateRoute&&this.replaceHistoryState("");else if(e.expanded=!0,"true"===this.updateRoute){const t=`${this.routePrefix||"#"}${e.elementId}`;window.location.hash!==t&&this.replaceHistoryState(e.elementId)}this.requestUpdate()}function gR(e,t="expand-all"){const r=[...e.querySelectorAll(".section-tag")];"expand-all"===t?r.map((e=>{e.classList.replace("collapsed","expanded")})):r.map((e=>{e.classList.replace("expanded","collapsed")}))}function yR(e,t="expand-all"){gR.call(this,e.target.closest(".operations-root"),t)}function vR(e,t=!1){return z`
  <summary @click="${t=>{mR.call(this,e,t)}}" part="section-endpoint-head-${e.expanded?"expanded":"collapsed"}" class='endpoint-head ${e.method} ${e.deprecated?"deprecated":""} ${t||e.expanded?"expanded":"collapsed"}'>
  ...
  `}function bR(e){var t;const r=new Set;for(const t in e.responses)for(const o in null===(n=e.responses[t])||void 0===n?void 0:n.content){var n;r.add(o.trim())}const o=[...r].join(", "),a=this.resolvedSpec.securitySchemes.filter((t=>{var r;return t.finalKeyValue&&(null===(r=e.security)||void 0===r?void 0:r.some((e=>t.securitySchemeId in e)))}))||[],i=this.resolvedSpec.securitySchemes.find((e=>e.securitySchemeId===ot&&"-"!==e.value));i&&a.push(i);const s=e.xCodeSamples?CP(e.xCodeSamples):"";return e.description=QP(e.description),z`
  <style>
      .label-operation-container {
        text-align: left;
        direction: ltr;
  ...
  <div part="section-endpoint-body-${e.expanded?"expanded":"collapsed"}" class='endpoint-body ${e.method} ${e.deprecated?"deprecated":""}'>
    <div class="summary">
      ...
      ${e.description?z`<div part="section-endpoint-body-description" class="path-description"> ${K_(e.description)}</div>`:""}
      <slot name="${e.elementId}"></slot>
      ${TP.call(this,e.security)}
      ${s}
    </div>  
  ...
  </div>`}function xR(e=!0,t=!0,r=!1){return this.resolvedSpec?z`
    ${e?z`
        <div style="display:flex; justify-content:flex-end;"> 
          <span @click="${e=>yR(e,"expand-all")}" style="color:var(--primary-color); cursor:pointer;">
            Expand all
          </span> 
          &nbsp;|&nbsp; 
          <span @click="${e=>yR(e,"collapse-all")}" style="color:var(--primary-color); cursor:pointer;" >
            Collapse all
          </span> 
          &nbsp; sections
        </div>`:""}
            ...
            <div class='section-tag-body'>
              ...
              ${e.paths.filter((e=>!this.matchPaths||st(this.matchPaths,e,this.matchType))).map((e=>z`
                <section part="section-endpoint" id='${e.elementId}' class='m-endpoint regular-font ${e.method} ${r||e.expanded?"expanded":"collapsed"}'>
                  <!--${vR.call(this,e,r)}-->
                  ${r||e.expanded?bR.call(this,e):""}
                </section>`))}
            </div>
          </div>`:z`
          <div class='section-tag-body'>
          ${e.paths.filter((e=>!this.matchPaths||st(this.matchPaths,e,"exactly"))).map((e=>z`
...
`}
    ...
    </header>`;var e}!function(e,t,r){(t=function(e){var t=function(e,t){if("object"!=typeof e||null===e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var n=r.call(e,t||"default");if("object"!=typeof n)return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:String(t)}(t))in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r}(ZP,"properties",{id:{type:String},content:{type:String},copied:{type:Boolean},showButton:{type:Boolean},showToast:{type:Boolean}}),customElements.define("content-copy-button",ZP);const kR=c`
  *, *:before, *:after { box-sizing: border-box; }
...
`;function $R(){var e;return document.addEventListener("close",(()=>{this.showAdvancedSearchDialog=!1})),document.addEventListener("open",this.onOpenSearchDialog),z`
    <dialog-box 
      heading="Search" 
  ...
  `}customElements.define("dialog-box",class extends ae{static get properties(){return{heading:{type:String,attribute:"heading"},show:{type:String,attribute:"show"}}}static get styles(){return[kR]}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",(e=>{"Escape"===e.code&&this.onClose()}))}attributeChangedCallback(e,t,r){t!==r&&("heading"===e&&(this.heading=r),"show"===e&&(this.show=r,"true"===r&&document.dispatchEvent(new CustomEvent("open",{bubbles:!0,composed:!0,detail:this})))),super.attributeChangedCallback(e,t,r)}render(){return z`
    ${"true"===this.show?z`
        ...
        </div>`:""}`}onClose(){document.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}});const SR={color:{inputReverseFg:"#fff",inputReverseBg:"#333",headerBg:"#444",getRgb(e){if(0===e.indexOf("#")&&(e=e.slice(1,7)),3!==e.length&&4!==e.length||(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),6!==e.length)throw new Error("Invalid HEX color.");return{r:parseInt(e.slice(0,2),16),g:parseInt(e.slice(2,4),16),b:parseInt(e.slice(4,6),16)}},luminanace(e){const t=this.getRgb(e);return.299*t.r+.587*t.g+.114*t.b},invert(e){return this.luminanace(e)>135?"#000":"#fff"},opacity(e,t){const r=this.getRgb(e);return`rgba(${r.r}, ${r.g}, ${r.b}, ${t})`},brightness(e,t){const r=this.getRgb(e);return r.r+=t,r.g+=t,r.b+=t,r.r>255?r.r=255:r.r<0&&(r.r=0),r.g>255?r.g=255:r.g<0&&(r.g=0),r.b>255?r.b=255:r.b<0&&(r.b=0),`#${r.r.toString(16).padStart(2,"0")}${r.g.toString(16).padStart(2,"0")}${r.b.toString(16).padStart(2,"0")}`},hasGoodContrast(e,t){return this.luminanace(e)-this.luminanace(t)}}};function AR(e){return/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3}|[A-Fa-f0-9]{8}|[A-Fa-f0-9]{4})$/i.test(e)}function ER(e,t={}){let r={};const n=t.primaryColor?t.primaryColor:"dark"===e?"#f76b39":"#ff591e",o=SR.color.invert(n),a=SR.color.opacity(n,"0.4");if("dark"===e){const e=t.bg1?t.bg1:"#2a2b2c",i=t.fg1?t.fg1:"#bbb",s=t.bg2?t.bg2:SR.color.brightness(e,5),l=t.bg3?t.bg3:SR.color.brightness(e,17),c=t.bg3?t.bg3:SR.color.brightness(e,35),p=t.fg2?t.fg2:SR.color.brightness(i,-15),d=t.fg3?t.fg3:SR.color.brightness(i,-20),u=t.fg3?t.fg3:"#A1A8B3",h=t.inlineCodeFg?t.inlineCodeFg:"#aaa",f="#bbb",m="#eee",g=t.headerColor?t.headerColor:SR.color.brightness(e,10),y=t.navBgColor?t.navBgColor:SR.color.brightness(e,10),v=t.navTextColor?t.navTextColor:SR.color.opacity(SR.color.invert(y),"0.50"),b=t.navHoverBgColor?t.navHoverBgColor:SR.color.brightness(y,-15),x=t.navHoverTextColor?t.navHoverTextColor:SR.color.invert(y),w=t.navAccentColor?t.navAccentColor:SR.color.brightness(n,25);r={bg1:e,bg2:s,bg3:l,lightBg:c,fg1:i,fg2:p,fg3:d,lightFg:u,inlineCodeFg:h,primaryColor:n,primaryColorTrans:a,primaryColorInvert:o,selectionBg:f,selectionFg:m,overlayBg:"rgba(80, 80, 80, 0.4)",navBgColor:y,navTextColor:v,navHoverBgColor:b,navHoverTextColor:x,navAccentColor:w,navAccentTextColor:t.navAccentTextColor?t.navAccenttextColor:SR.color.invert(w),headerColor:g,headerColorInvert:SR.color.invert(g),headerColorDarker:SR.color.brightness(g,-20),headerColorBorder:SR.color.brightness(g,10),borderColor:t.borderColor||SR.color.brightness(e,20),lightBorderColor:t.lightBorderColor||"#e7e9ee",codeBorderColor:t.codeBorderColor||SR.color.brightness(e,30),inputBg:t.inputBg||SR.color.brightness(e,-5),placeHolder:t.placeHolder||SR.color.opacity(i,"0.3"),hoverColor:t.hoverColor||SR.color.brightness(e,-10),red:t.red?t.red:"#F06560",lightRed:t.lightRed?t.lightRed:SR.color.brightness(e,-10),pink:t.pink?t.pink:"#ffb2b2",lightPink:t.lightPink||SR.color.brightness(e,-10),green:t.green||"#7ec699",lightGreen:t.lightGreen||SR.color.brightness(e,-10),blue:t.blue||"#71b7ff",lightBlue:t.lightBlue||SR.color.brightness(e,-10),orange:t.orange?t.orange:"#f08d49",lightOrange:t.lightOrange||SR.color.brightness(e,-10),yellow:t.yellow||"#827717",lightYellow:t.lightYellow||SR.color.brightness(e,-10),purple:t.purple||"#786FF1",brown:t.brown||"#D4AC0D",codeBg:t.codeBg||SR.color.opacity(SR.color.brightness(e,-15),.7),codeFg:t.codeFg||"#aaa",codePropertyColor:t.codePropertyColor||"#f8c555",codeKeywordColor:t.codeKeywordColor||"#cc99cd",codeOperatorColor:t.codeOperatorColor||"#67cdcc"}}else{const e=t.bg1?t.bg1:"#fafbfc",i=t.fg1?t.fg1:"#444444",s=t.bg2?t.bg2:SR.color.brightness(e,-5),l=t.bg3?t.bg3:SR.color.brightness(e,-15),c=t.bg3?t.bg3:SR.color.brightness(e,-45),p=t.fg2?t.fg2:"#545454",d=t.fg3?t.fg3:SR.color.brightness(i,30),u=t.fg3?t.fg3:"#A1A8B3",h=t.inlineCodeFg?t.inlineCodeFg:"brown",f="#444",m="#eee",g=t.headerColor?t.headerColor:SR.color.brightness(e,-180),y=t.navBgColor?t.navBgColor:SR.color.brightness(e,-200),v=t.navTextColor?t.navTextColor:SR.color.opacity(SR.color.invert(y),"0.65"),b=t.navHoverBgColor?t.navHoverBgColor:SR.color.brightness(y,-15),x=t.navHoverTextColor?t.navHoverTextColor:SR.color.invert(y),w=t.navAccentColor?t.navAccentColor:SR.color.brightness(n,25);r={bg1:e,bg2:s,bg3:l,lightBg:c,fg1:i,fg2:p,fg3:d,lightFg:u,inlineCodeFg:h,primaryColor:n,primaryColorTrans:a,primaryColorInvert:o,selectionBg:f,selectionFg:m,overlayBg:"rgba(0, 0, 0, 0.4)",navBgColor:y,navTextColor:v,navHoverBgColor:b,navHoverTextColor:x,navAccentColor:w,navAccentTextColor:t.navAccentTextColor?t.navAccenttextColor:SR.color.invert(w),headerColor:g,headerColorInvert:SR.color.invert(g),headerColorDarker:SR.color.brightness(g,-20),headerColorBorder:SR.color.brightness(g,10),borderColor:t.borderColor||"#B9B9B9",lightBorderColor:t.lightBorderColor||"#e7e9ee",codeBorderColor:t.codeBorderColor||"transparent",inputBg:t.inputBg||"rgba(255, 255, 255, 0.0001)",placeHolder:t.placeHolder||SR.color.brightness(u,20),hoverColor:t.hoverColor||SR.color.brightness(e,-5),rebelPink:"#e31c58",red:t.red||"#F06560",lightRed:t.lightRed||"#fff0f0",pink:t.pink?t.pink:"#990055",lightPink:t.lightPink?t.lightPink:"#ffb2b2",green:t.green||"#690",lightGreen:t.lightGreen||"#fbfff0",blue:t.blue||"#47AFE8",lightBlue:t.lightBlue||"#eff8fd",orange:t.orange||"#FF9900",lightOrange:t.lightOrange||"#fff5e6",yellow:t.yellow||"#827717",lightYellow:t.lightYellow||"#fff5cc",purple:t.purple||"#786FF1",brown:t.brown||"#D4AC0D",fgPositive:"#38853C",bgPositive:"#DFF1E0",borderPositive:"#83D187",fgWarning:"#D56A00",bgWarning:"#FFEBD7",borderWarning:"#F5AE70",fgInfo:"#2978B5",bgInfo:"#DEECF7",borderInfo:"#7CBBEA",fgCritical:"#CC3D3D",bgCritical:"#F8E3E3",borderCritical:"#F49494",codeBg:t.codeBg||SR.color.opacity(SR.color.brightness(e,-15),.7),codeFg:t.codeFg||"#666",codePropertyColor:t.codePropertyColor||"#905",codeKeywordColor:t.codeKeywordColor||"#07a",codeOperatorColor:t.codeOperatorColor||"#9a6e3a"}}return z`
  <style>
  *, *:before, *:after { box-sizing: border-box; }
  ...
  :host {
  ...
  </style>`}function OR(e=!1,t=!0,r=!0,n=!1){if(!this.resolvedSpec)return"";"true"===this.persistAuth&&vP.call(this);const o={bg1:AR(this.bgColor)?this.bgColor:"",fg1:AR(this.textColor)?this.textColor:"",headerColor:AR(this.headerColor)?this.headerColor:"",primaryColor:AR(this.primaryColor)?this.primaryColor:"",navBgColor:AR(this.navBgColor)?this.navBgColor:"",navTextColor:AR(this.navTextColor)?this.navTextColor:"",navHoverBgColor:AR(this.navHoverBgColor)?this.navHoverBgColor:"",navHoverTextColor:AR(this.navHoverTextColor)?this.navHoverTextColor:"",navAccentColor:AR(this.navAccentColor)?this.navAccentColor:"",navAccentTextColor:AR(this.navAccentTextColor)?this.navAccentTextColor:""};return this.resolvedSpec.specLoadError?e?z`
        ${"dark"===this.theme?ER.call(this,"dark",o):ER.call(this,"light",o)}
    ...
    <!-- Header -->
    ${"false"===this.showHeader?"":wR.call(this)}

    <!-- Advanced Search -->
    ${"false"===this.allowAdvancedSearch?"":$R.call(this)}

    <div id='the-main-body' class='body ${this.cssClasses}' dir='${this.pageDirection}' >
      <!-- Side Nav -->
      ${"read"!==this.renderStyle&&"focused"!==this.renderStyle||"true"!==this.showSideNav||!this.resolvedSpec?"":cR.call(this)}
        ...
        <div class='main-content-inner--${this.renderStyle}-mode'>
          ${!0===this.loading?z`<div class='loader'></div>`:z`
              ${!0===this.loadFailed?z`<div style='text-align: center;margin: 16px;'> Unable to load the Spec</div>`:z`
                  ...
                  ${"focused"===this.renderStyle?z`${fR.call(this)}`:z`
                      ${"true"===this.showInfo?iR.call(this):""}
                      <div id="operations-top" class="observe-me">
                        <slot name="operations-top"></slot>
                      </div>  
                      ${"read"===this.renderStyle?tR.call(this):xR.call(this,t,r,n)}
                    `}
                  </div>
                `}`}
        </div>
  ...
  `}function IR(){return z`
    ${"true"===this.showInfo?iR.call(this):""}
    <div style="font-size:var(--font-size-regular);">
    ${this.resolvedSpec.schemaAndExamples.map((e=>{var t;const r=lP(e.schema,"json",e.examples,e.example,!0,!1,"json",!0);return e.selectedExample=null===(t=r[0])||void 0===t?void 0:t.exampleId,z`
  ...
  `}function _R(e=!1){if(!this.resolvedSpec)return"";const t={bg1:AR(this.bgColor)?this.bgColor:"",fg1:AR(this.textColor)?this.textColor:"",headerColor:AR(this.headerColor)?this.headerColor:"",primaryColor:AR(this.primaryColor)?this.primaryColor:"",navBgColor:AR(this.navBgColor)?this.navBgColor:"",navTextColor:AR(this.navTextColor)?this.navTextColor:"",navHoverBgColor:AR(this.navHoverBgColor)?this.navHoverBgColor:"",navHoverTextColor:AR(this.navHoverTextColor)?this.navHoverTextColor:"",navAccentColor:AR(this.navAccentColor)?this.navAccentColor:"",navAccenttextColor:AR(this.navAccentTextColor)?this.navAccentTextColor:""};return this.resolvedSpec.specLoadError?e?z`
        ${"dark"===this.theme?ER.call(this,"dark",t):ER.call(this,"light",t)}
        <div style="display:flex; align-items:center; border:1px dashed var(--border-color); height:42px; padding:5px; font-size:var(--font-size-small); color:var(--red); font-family:var(--font-mono)"> ${this.resolvedSpec.info.description} </div>
      `:z`
      ${"dark"===this.theme?ER.call(this,"dark",t):ER.call(this,"light",t)}
      <!-- Header -->
