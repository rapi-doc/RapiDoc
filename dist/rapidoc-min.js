      ...
      <div class="tab-panel col" style="border-width:0 0 1px 0;">
        ...
        ${this.responseIsBlob?F`
            ...
            <div class="tab-content col m-markdown" style="flex:1; display:${"response"===this.activeResponseTab?"flex":"none"};" >
              ...
              <pre style="white-space:pre; min-height:50px; height:var(--resp-area-height, 400px); resize:vertical; overflow:auto">${e?F`<code>${HP(He().highlight(this.responseText,He().languages[e],e))}</code>`:`${this.responseText}`}</pre>
            </div>`}
