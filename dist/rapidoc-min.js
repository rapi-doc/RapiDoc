          ...
          <div>
            ...
            ${"authorizationCode"===e||"clientCredentials"===e||"implicit"===e||"password"===e?D`
                <button class="m-btn thin-border" part="btn btn-outline"
                  @click="${t=>{YP.call(this,n,e,s,l,t)}}"
                > GET TOKEN </button>`:""}
          </div>
...
`:void 0}function rR(e){if(this.resolvedSpec.securitySchemes&&e){const t=[];return e.forEach((e=>{const r=[],n=[];0===Object.keys(e).length?t.push({securityTypes:"None",securityDefs:[]}):(Object.keys(e).forEach((t=>{let a="";const o=this.resolvedSpec.securitySchemes.find((e=>e.securitySchemeId===t));e[t]&&Array.isArray(e[t])&&(a=e[t].join(", ")),o&&(n.push(o.typeDisplay),r.push({...o,scopes:a}))})),t.push({securityTypes:n.length>1?`${n[0]} + ${n.length-1} more`:n[0],securityDefs:r}))})),D`<div style="position:absolute; top:3px; right:2px; font-size:var(--font-size-small); line-height: 1.5;">
  ...
  <div class="tab-panel col"
    ...
    `))}
  `}const oR={},iR=DP(class extends zP{constructor(){super(...arguments),this.nt=oR}render(e,t){return t()}update(e,[t,r]){if(Array.isArray(t)){if(Array.isArray(this.nt)&&this.nt.length===t.length&&t.every(((e,t)=>e===this.nt[t])))return z}else if(this.nt===t)return z;return this.nt=Array.isArray(t)?Array.from(t):t,this.render(t,r)}}),sR=l`
.border-top {
  border-top:1px solid var(--border-color);
}
.border{
...
`;customElements.define("schema-tree",class extends re{static get properties(){return{data:{type:Object},schemaExpandLevel:{type:Number,attribute:"schema-expand-level"},schemaDescriptionExpanded:{type:String,attribute:"schema-description-expanded"},allowSchemaDescriptionExpandToggle:{type:String,attribute:"allow-schema-description-expand-toggle"},schemaHideReadOnly:{type:String,attribute:"schema-hide-read-only"},schemaHideWriteOnly:{type:String,attribute:"schema-hide-write-only"}}}connectedCallback(){super.connectedCallback(),(!this.schemaExpandLevel||this.schemaExpandLevel<1)&&(this.schemaExpandLevel=99999),this.schemaDescriptionExpanded&&"true false".includes(this.schemaDescriptionExpanded)||(this.schemaDescriptionExpanded="false"),this.schemaHideReadOnly&&"true false".includes(this.schemaHideReadOnly)||(this.schemaHideReadOnly="true"),this.schemaHideWriteOnly&&"true false".includes(this.schemaHideWriteOnly)||(this.schemaHideWriteOnly="true")}static get styles(){return[He,$R,sR,l`
  ...
  `}customElements.define("schema-table",class extends re{static get properties(){return{schemaExpandLevel:{type:Number,attribute:"schema-expand-level"},schemaDescriptionExpanded:{type:String,attribute:"schema-description-expanded"},allowSchemaDescriptionExpandToggle:{type:String,attribute:"allow-schema-description-expand-toggle"},schemaHideReadOnly:{type:String,attribute:"schema-hide-read-only"},schemaHideWriteOnly:{type:String,attribute:"schema-hide-write-only"},data:{type:Object}}}connectedCallback(){super.connectedCallback(),(!this.schemaExpandLevel||this.schemaExpandLevel<1)&&(this.schemaExpandLevel=99999),this.schemaDescriptionExpanded&&"true false".includes(this.schemaDescriptionExpanded)||(this.schemaDescriptionExpanded="false"),this.schemaHideReadOnly&&"true false".includes(this.schemaHideReadOnly)||(this.schemaHideReadOnly="true"),this.schemaHideWriteOnly&&"true false".includes(this.schemaHideWriteOnly)||(this.schemaHideWriteOnly="true")}static get styles(){return[He,$R,l`
    ...
    `}toggleObjectExpand(e){const t=e.target.closest(".tr");t.classList.contains("expanded")?(t.classList.add("collapsed"),t.classList.remove("expanded"),e.target.innerText="+"):(t.classList.remove("collapsed"),t.classList.add("expanded"),e.target.innerText="-")}});function AR(e){var t,r;const n=null!==(t=null==e?void 0:e.width)&&void 0!==t?t:20,a=null!==(r=null==e?void 0:e.height)&&void 0!==r?r:20;return D`
      <svg width=${n} height=${a} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  `}customElements.define("api-response",class extends re{constructor(){super(),this.selectedStatus="",this.headersForEachRespStatus={},this.mimeResponsesForEachStatus={},this.activeSchemaTab="schema"}static get properties(){return{callback:{type:String},webhook:{type:String},responses:{type:Object},parser:{type:Object},schemaStyle:{type:String,attribute:"schema-style"},renderStyle:{type:String,attribute:"render-style"},selectedStatus:{type:String,attribute:"selected-status"},selectedMimeType:{type:String,attribute:"selected-mime-type"},activeSchemaTab:{type:String,attribute:"active-schema-tab"},schemaExpandLevel:{type:Number,attribute:"schema-expand-level"},schemaDescriptionExpanded:{type:String,attribute:"schema-description-expanded"},allowSchemaDescriptionExpandToggle:{type:String,attribute:"allow-schema-description-expand-toggle"},schemaHideReadOnly:{type:String,attribute:"schema-hide-read-only"},schemaHideWriteOnly:{type:String,attribute:"schema-hide-write-only"}}}static get styles(){return[He,Ve,Ze,Ge,We,sR,l`
    ...
    `}resetSelection(){this.selectedStatus="",this.selectedMimeType=""}getResponseStatusType(e){const t=e.toString();return t.startsWith("1")?"informational":t.startsWith("2")?"success":t.startsWith("3")?"redirection":t.startsWith("4")||t.startsWith("5")?"error":""}responseTemplate(){if(!this.responses)return"";for(const n in this.responses){this.selectedStatus||(this.selectedStatus=n);const a={};for(const r in null===(e=this.responses[n])||void 0===e?void 0:e.content){var e,t;const o=this.responses[n].content[r];this.selectedMimeType||(this.selectedMimeType=r);const i=bR(o.schema,{}),s=xR(o.schema,r,o.examples,o.example,"true"!==this.callback&&"true"!==this.webhook,"true"===this.callback||"true"===this.webhook,r.includes("json")?"json":"text");a[r]={description:this.responses[n].description,examples:s,selectedExample:(null===(t=s[0])||void 0===t?void 0:t.exampleId)||"",schemaTree:i}}const o=[];for(const e in null===(r=this.responses[n])||void 0===r?void 0:r.headers){var r;o.push({name:e,...this.responses[n].headers[e]})}this.headersForEachRespStatus[n]=o,this.mimeResponsesForEachStatus[n]=a}return D`
          ...
          ${Object.keys(this.responses).map((e=>D`
            ${"$$ref"===e?"":D`
                <div class="resp-box resp-border"
                  @click="${()=>{this.selectedStatus=e,this.responses[e].content&&Object.keys(this.responses[e].content)[0]?this.selectedMimeType=Object.keys(this.responses[e].content)[0]:this.selectedMimeType=void 0,this.renderRoot.getElementById(`resp-modal-${e}`).style.display="block"}}"
                >
  ...
  `}()}
      ...
      ${Object.keys(this.responses).map((e=>{var t,r;return D`
        <div class="resp-modal" id="resp-modal-${e}">
          <div class="resp-modal-bg"
            @click="${()=>{this.renderRoot.getElementById(`resp-modal-${e}`).style.display="none"}}"
          ></div>
    ...
    `:D`
      ...
      `}});class ER extends re{constructor(e,t){super(),this.active=!0,this.message=null!=t?t:"",this.tone=null!=e?e:"positive",this.tones={info:{borderColor:l`#7CBBEA`,bgColor:l`#DEECF7`,icon:AR},positive:{borderColor:l`#83D187`,bgColor:l`#DFF1E0`,icon:AR},warning:{borderColor:l`#F5AE70`,bgColor:l`#FFEBD7`,icon:AR},critical:{borderColor:l`#F49494`,bgColor:l`#F8E3E3`,icon:AR}}}firstUpdated(){const e=e=>{this.renderRoot.querySelectorAll(".toast-active").length>0&&"fadeOut"===e.animationName&&this.onClose()};this.renderRoot.getElementById("toast").addEventListener("animationend",e),this.renderRoot.getElementById("toast").addEventListener("webkitAnimationEnd",e)}onClose(){this.active=!1;this.dispatchEvent(new CustomEvent("closed-toast",{detail:"closed toast",bubbles:!0,composed:!0}))}render(){return D`
...
`}
        ...
        `;var e}static get styles(){return[l`
          ...
          `]}}function _R(e){const t=new Be.Renderer;return t.heading=(t,r,n,a)=>`<h${r} class="observe-me" id="${e}--${a.slug(n)}">${t}</h${r}>`,t}function IR(e,t=""){var r,n,a;const o=new Set;for(const t in e.responses)for(const r in null===(i=e.responses[t])||void 0===i?void 0:i.content){var i;o.add(r.trim())}const s=[...o].join(", "),l=this.resolvedSpec.securitySchemes.filter((t=>{var r;return t.finalKeyValue&&(null===(r=e.security)||void 0===r?void 0:r.some((e=>t.securitySchemeId in e)))}))||[],c=this.resolvedSpec.securitySchemes.find((e=>e.securitySchemeId===tt&&"-"!==e.value));c&&l.push(c);const p=e.xCodeSamples?nR.call(this,e.xCodeSamples):"";return D`
  ...
  `}function PR(){return this.resolvedSpec?D`
  ${this.resolvedSpec.tags.map((e=>D`
    <section id="${e.elementId}" part="section-tag" class="regular-font section-gap--read-mode observe-me" style="border-top:1px solid var(--primary-color);">
      ...
      ${qP(`\n          <div class="m-markdown regular-font">\n          ${Be(e.description||"","true"===this.infoDescriptionHeadingsInNavBar?{renderer:_R(e.elementId)}:void 0)}\n        </div>`)}
      </div>
    </section>
    <section class='regular-font section-gap--read-mode' part="section-operations-in-tag">
      ${e.paths.map((e=>IR.call(this,e,"BBB")))}
    </section>
    `))}
`:""}function RR(e){return D`
  ...
  ${"table"===this.schemaStyle?D`
      ...
      <schema-tree
        ...
        exportparts = "schema-description:schema-description, schema-multiline-toggle:schema-multiline-toggle"
      > </schema-tree>`}
  </div>`}function LR(e,t){return-1!==e.id.indexOf("schemas-")?RR.call(this,e):D`
  <div class='divider'></div>
  <div class='expanded-endpoint-body observe-me ${e.name}' id='cmp--${e.id}' >
    ${D`
  ...
  `}function FR(){return this.resolvedSpec?D`
  ${this.resolvedSpec.components.map((e=>D`
    ...
    `))}
`:""}function DR(){const e=new Be.Renderer;return e.heading=(e,t,r,n)=>`<h${t} class="observe-me" id="overview--${n.slug(r)}">${e}</h${t}>`,e}function zR(){var e,t,r,n;return D`
    <section id="overview" part="section-overview"
      ...
      ${null!==(e=this.resolvedSpec)&&void 0!==e&&e.info?D`
          ...
          ${this.resolvedSpec.info.description?D`${qP(`\n                <div class="m-markdown regular-font">\n                ${Be(this.resolvedSpec.info.description,"true"===this.infoDescriptionHeadingsInNavBar?{renderer:DR()}:void 0)}\n              </div>`)}`:""}
          </div>
        `:""}
    </section>
  `}function NR(e){var t;const r=null===(t=this.resolvedSpec)||void 0===t?void 0:t.servers.find((t=>t.url===e));return!!r&&(this.selectedServer=r,this.requestUpdate(),this.dispatchEvent(new CustomEvent("api-server-change",{bubbles:!0,composed:!0,detail:{selectedServer:r}})),!0)}function qR(e,t){const r=[...e.currentTarget.closest("table").querySelectorAll("input, select")];let n=t.url;r.forEach((e=>{const t=new RegExp(`{${e.dataset.var}}`,"g");n=n.replace(t,e.value)})),t.computedUrl=n,this.requestUpdate()}function BR(){return this.selectedServer&&this.selectedServer.variables?D`
      ...
      ${Object.entries(this.selectedServer.variables).map((e=>D`
        <tr>
          ...
          <td>
            ...
            <select
              data-var = "${e[0]}"
              @input = ${e=>{qR.call(this,e,this.selectedServer)}}
            >
    ...
    `:""}function UR(){var e,t,r;return!this.resolvedSpec||this.resolvedSpec.specLoadError?"":D`
  <section id = 'servers' part="section-servers" style="text-align:left; direction:ltr; margin-top:24px; margin-bottom:24px;" class='regular-font observe-me ${"read focused".includes(this.renderStyle)?"section-gap--read-mode":"section-gap"}'>
    ...
    ${BR.call(this)}
  </section>`}function MR(e,t="toggle"){const r=null==e?void 0:e.closest(".nav-bar-tag-and-paths");if(r){const e=r.classList.contains("expanded");!e||"toggle"!==t&&"collapse"!==t?e||"toggle"!==t&&"expand"!==t||r.classList.replace("collapsed","expanded"):r.classList.replace("expanded","collapsed")}}function HR(e){MR(e.target,"toggle")}function WR(e,t="expand-all"){!function(e,t="expand-all"){const r=[...e.querySelectorAll(".nav-bar-tag-and-paths")];"expand-all"===t?r.map((e=>{e.classList.replace("collapsed","expanded")})):r.map((e=>{e.classList.replace("expanded","collapsed")}))}(e.target.closest(".nav-scroll"),t)}function VR(){var e,t,r,n;return!this.resolvedSpec||this.resolvedSpec.specLoadError?D`
      ...
      <div id='link-operations-top' class='nav-bar-section operations' data-content-id='operations-top' @click = '${e=>this.scrollToEventTarget(e,!1)}'>
        <div style="font-size:16px; display:flex; margin-left:10px;">
          ${"focused"===this.renderStyle?D`
              <div @click="${e=>{WR.call(this,e,"expand-all")}}" title="Expand all" style="transform: rotate(90deg); cursor:pointer; margin-right:10px;">▸</div>
              <div @click="${e=>{WR.call(this,e,"collapse-all")}}" title="Collapse all" style="transform: rotate(270deg); cursor:pointer;">▸</div>`:""}  
        </div>
          ...
          <div class='nav-bar-tag-and-paths ${e.expanded?"expanded":"collapsed"}'>
            ${"General ⦂"===e.name?D`<hr style="border:none; border-top: 1px dotted var(--nav-text-color); opacity:0.3; margin:-1px 0 0 0;"/>`:D`
                <div 
                  ...
                  @click='${e=>{"focused"===this.renderStyle&&"expand-collapse"===this.onNavTagClick?HR.call(this,e):this.scrollToEventTarget(e,!1)}}'
                >
                  <div>${e.name}</div>
                  <div class="nav-bar-tag-icon" @click="${e=>{"focused"===this.renderStyle&&"show-description"===this.onNavTagClick&&HR.call(this,e)}}">
                  </div>
                </div>
              `}
            ${"true"===this.infoDescriptionHeadingsInNavBar?D`
...
`}function GR(e){const t=new Be.Renderer;return t.heading=(t,r,n,a)=>`<h${r} class="observe-me" id="${e}--${a.slug(n)}">${t}</h${r}>`,t}function KR(e){return D`
    <div class='regular-font section-gap--focused-mode' part="section-operations-in-tag">
      ${e}
    </div>`}function JR(){var e;if("true"===this.showInfo)return KR(zR.call(this));const t=this.resolvedSpec.tags[0],r=null===(e=this.resolvedSpec.tags[0])||void 0===e?void 0:e.paths[0];return KR(t&&r?IR.call(this,r,t.name):"")}function ZR(e){return D`
    <h1 id="${e.elementId}">${e.name}</h1>
    ${"show-description"===this.onNavTagClick&&e.description?D`
        <div class="m-markdown">
          ${qP(`\n            <div class="m-markdown regular-font">\n              ${Be(e.description||"","true"===this.infoDescriptionHeadingsInNavBar?{renderer:GR(e.elementId)}:void 0)}\n            </div>`)}
        </div>`:""}
  `}function YR(){if(!this.focusedElementId||!this.resolvedSpec)return;const e=this.focusedElementId;let t,r=null,n=null,a=0;if(e.startsWith("overview")&&"true"===this.showInfo)t=zR.call(this);else if("auth"===e&&"true"===this.allowAuthentication)t=tR.call(this);else if("servers"===e&&"true"===this.allowServerSelection)t=UR.call(this);else if("operations-top"===e)t=D`
    <div id="operations-top" class="observe-me">
      <slot name="operations-top"></slot>
    </div>`;else if(e.startsWith("cmp--")&&"true"===this.showComponents)t=FR.call(this);else if(e.startsWith("tag--")){const r=e.indexOf("--",4)>0?e.substring(0,e.indexOf("--",5)):e;n=this.resolvedSpec.tags.find((e=>e.elementId===r)),t=n?KR.call(this,ZR.call(this,n)):JR.call(this)}else{for(a=0;a<this.resolvedSpec.tags.length&&(n=this.resolvedSpec.tags[a],r=this.resolvedSpec.tags[a].paths.find((t=>`${t.elementId}`===e)),!r);a+=1);if(r){MR(this.shadowRoot.getElementById(`link-${e}`),"expand"),t=KR.call(this,IR.call(this,r,n.name))}else t=JR.call(this)}return t}function QR(e){if(e.expanded)e.expanded=!1,"true"===this.updateRoute&&window.history.replaceState(null,null,`${window.location.href.split("#")[0]}${"#"===this.routePrefix?"":`${this.routePrefix}`}`);else if(e.expanded=!0,"true"===this.updateRoute){const t=`${this.routePrefix||"#"}${e.elementId}`;window.location.hash!==t&&window.history.replaceState(null,null,`${window.location.href.split("#")[0]}${t}`)}this.requestUpdate()}function XR(e,t="expand-all"){const r=[...e.querySelectorAll(".section-tag")];"expand-all"===t?r.map((e=>{e.classList.replace("collapsed","expanded")})):r.map((e=>{e.classList.replace("expanded","collapsed")}))}function eL(e,t="expand-all"){XR.call(this,e.target.closest(".operations-root"),t)}function tL(e,t=!1){return D`
  <summary @click="${t=>{QR.call(this,e,t)}}" part="section-endpoint-head-${e.expanded?"expanded":"collapsed"}" class='endpoint-head ${e.method} ${e.deprecated?"deprecated":""} ${t||e.expanded?"expanded":"collapsed"}'>
  ...
  `}function rL(e){var t;const r=new Set;for(const t in e.responses)for(const a in null===(n=e.responses[t])||void 0===n?void 0:n.content){var n;r.add(a.trim())}const a=[...r].join(", "),o=this.resolvedSpec.securitySchemes.filter((t=>{var r;return t.finalKeyValue&&(null===(r=e.security)||void 0===r?void 0:r.some((e=>t.securitySchemeId in e)))}))||[],i=this.resolvedSpec.securitySchemes.find((e=>e.securitySchemeId===tt&&"-"!==e.value));i&&o.push(i);const s=e.xCodeSamples?nR(e.xCodeSamples):"";return D`
  <div part="section-endpoint-body-${e.expanded?"expanded":"collapsed"}" class='endpoint-body ${e.method} ${e.deprecated?"deprecated":""}'>
    ...
    ${e?D`
        <div style="display:flex; justify-content:flex-end;"> 
          <span @click="${e=>eL(e,"expand-all")}" style="color:var(--primary-color); cursor:pointer;">
            Expand all
          </span> 
          &nbsp;|&nbsp; 
          <span @click="${e=>eL(e,"collapse-all")}" style="color:var(--primary-color); cursor:pointer;" >
            Collapse all
          </span> 
          &nbsp; sections
        </div>`:""}
...
`}
    ...
    </header>`;var e}!function(e,t,r){t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r}(jR,"properties",{id:{type:String},content:{type:String},copied:{type:Boolean},showButton:{type:Boolean},showToast:{type:Boolean}}),customElements.define("content-copy-button",jR);const oL=l`
  *, *:before, *:after { box-sizing: border-box; }
...
`;function iL(){var e;return document.addEventListener("close",(()=>{this.showAdvancedSearchDialog=!1})),document.addEventListener("open",this.onOpenSearchDialog),D`
    <dialog-box 
      heading="Search" 
  ...
  `}customElements.define("dialog-box",class extends re{static get properties(){return{heading:{type:String,attribute:"heading"},show:{type:String,attribute:"show"}}}static get styles(){return[oL]}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",(e=>{"Escape"===e.code&&this.onClose()}))}attributeChangedCallback(e,t,r){t!==r&&("heading"===e&&(this.heading=r),"show"===e&&(this.show=r,"true"===r&&document.dispatchEvent(new CustomEvent("open",{bubbles:!0,composed:!0,detail:this})))),super.attributeChangedCallback(e,t,r)}render(){return D`
    ${"true"===this.show?D`
        ...
        </div>`:""}`}onClose(){document.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}});const sL={color:{inputReverseFg:"#fff",inputReverseBg:"#333",headerBg:"#444",getRgb(e){if(0===e.indexOf("#")&&(e=e.slice(1,7)),3!==e.length&&4!==e.length||(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),6!==e.length)throw new Error("Invalid HEX color.");return{r:parseInt(e.slice(0,2),16),g:parseInt(e.slice(2,4),16),b:parseInt(e.slice(4,6),16)}},luminanace(e){const t=this.getRgb(e);return.299*t.r+.587*t.g+.114*t.b},invert(e){return this.luminanace(e)>135?"#000":"#fff"},opacity(e,t){const r=this.getRgb(e);return`rgba(${r.r}, ${r.g}, ${r.b}, ${t})`},brightness(e,t){const r=this.getRgb(e);return r.r+=t,r.g+=t,r.b+=t,r.r>255?r.r=255:r.r<0&&(r.r=0),r.g>255?r.g=255:r.g<0&&(r.g=0),r.b>255?r.b=255:r.b<0&&(r.b=0),`#${r.r.toString(16).padStart(2,"0")}${r.g.toString(16).padStart(2,"0")}${r.b.toString(16).padStart(2,"0")}`},hasGoodContrast(e,t){return this.luminanace(e)-this.luminanace(t)}}};function lL(e){return/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3}|[A-Fa-f0-9]{8}|[A-Fa-f0-9]{4})$/i.test(e)}function cL(e,t={}){let r={};const n=t.primaryColor?t.primaryColor:"dark"===e?"#f76b39":"#ff591e",a=sL.color.invert(n),o=sL.color.opacity(n,"0.8");if("dark"===e){const e=t.bg1?t.bg1:"#2a2b2c",i=t.fg1?t.fg1:"#bbb",s=t.bg2?t.bg2:sL.color.brightness(e,5),l=t.bg3?t.bg3:sL.color.brightness(e,17),c=t.bg3?t.bg3:sL.color.brightness(e,35),p=t.fg2?t.fg2:sL.color.brightness(i,-15),d=t.fg3?t.fg3:sL.color.brightness(i,-20),u=t.fg3?t.fg3:sL.color.brightness(i,-65),h=t.inlineCodeFg?t.inlineCodeFg:"#aaa",f="#bbb",m="#eee",g=t.headerColor?t.headerColor:sL.color.brightness(e,10),y=t.navBgColor?t.navBgColor:sL.color.brightness(e,10);r={bg1:e,bg2:s,bg3:l,lightBg:c,fg1:i,fg2:p,fg3:d,lightFg:u,inlineCodeFg:h,primaryColor:n,primaryColorTrans:o,primaryColorInvert:a,selectionBg:f,selectionFg:m,overlayBg:"rgba(80, 80, 80, 0.4)",navBgColor:y,navTextColor:t.navTextColor?t.navTextColor:sL.color.opacity(sL.color.invert(y),"0.50"),navHoverBgColor:t.navHoverBgColor?t.navHoverBgColor:sL.color.brightness(y,-15),navHoverTextColor:t.navHoverTextColor?t.navHoverTextColor:sL.color.invert(y),navAccentColor:t.navAccentColor?t.navAccentColor:sL.color.brightness(n,25),headerColor:g,headerColorInvert:sL.color.invert(g),headerColorDarker:sL.color.brightness(g,-20),headerColorBorder:sL.color.brightness(g,10),borderColor:t.borderColor||sL.color.brightness(e,20),lightBorderColor:t.lightBorderColor||sL.color.brightness(e,15),codeBorderColor:t.codeBorderColor||sL.color.brightness(e,30),inputBg:t.inputBg||sL.color.brightness(e,-5),placeHolder:t.placeHolder||sL.color.opacity(i,"0.3"),hoverColor:t.hoverColor||sL.color.brightness(e,-10),red:t.red?t.red:"#F06560",lightRed:t.lightRed?t.lightRed:sL.color.brightness(e,-10),pink:t.pink?t.pink:"#ffb2b2",lightPink:t.lightPink||sL.color.brightness(e,-10),green:t.green||"#7ec699",lightGreen:t.lightGreen||sL.color.brightness(e,-10),blue:t.blue||"#71b7ff",lightBlue:t.lightBlue||sL.color.brightness(e,-10),orange:t.orange?t.orange:"#f08d49",lightOrange:t.lightOrange||sL.color.brightness(e,-10),yellow:t.yellow||"#827717",lightYellow:t.lightYellow||sL.color.brightness(e,-10),purple:t.purple||"#786FF1",brown:t.brown||"#D4AC0D",codeBg:t.codeBg||sL.color.opacity(sL.color.brightness(e,-15),.7),codeFg:t.codeFg||"#aaa",codePropertyColor:t.codePropertyColor||"#f8c555",codeKeywordColor:t.codeKeywordColor||"#cc99cd",codeOperatorColor:t.codeOperatorColor||"#67cdcc"}}else{const e=t.bg1?t.bg1:"#fafbfc",i=t.fg1?t.fg1:"#444444",s=t.bg2?t.bg2:sL.color.brightness(e,-5),l=t.bg3?t.bg3:sL.color.brightness(e,-15),c=t.bg3?t.bg3:sL.color.brightness(e,-45),p=t.fg2?t.fg2:"#545454",d=t.fg3?t.fg3:sL.color.brightness(i,30),u=t.fg3?t.fg3:sL.color.brightness(i,70),h=t.inlineCodeFg?t.inlineCodeFg:"brown",f="#444",m="#eee",g=t.headerColor?t.headerColor:sL.color.brightness(e,-180),y=t.navBgColor?t.navBgColor:sL.color.brightness(e,-200);r={bg1:e,bg2:s,bg3:l,lightBg:c,fg1:i,fg2:p,fg3:d,lightFg:u,inlineCodeFg:h,primaryColor:n,primaryColorTrans:o,primaryColorInvert:a,selectionBg:f,selectionFg:m,overlayBg:"rgba(0, 0, 0, 0.4)",navBgColor:y,navTextColor:t.navTextColor?t.navTextColor:sL.color.opacity(sL.color.invert(y),"0.65"),navHoverBgColor:t.navHoverBgColor?t.navHoverBgColor:sL.color.brightness(y,-15),navHoverTextColor:t.navHoverTextColor?t.navHoverTextColor:sL.color.invert(y),navAccentColor:t.navAccentColor?t.navAccentColor:sL.color.brightness(n,25),headerColor:g,headerColorInvert:sL.color.invert(g),headerColorDarker:sL.color.brightness(g,-20),headerColorBorder:sL.color.brightness(g,10),borderColor:t.borderColor||"#B9B9B9",lightBorderColor:t.lightBorderColor||sL.color.brightness(e,-23),codeBorderColor:t.codeBorderColor||"transparent",inputBg:t.inputBg||"rgba(255, 255, 255, 0.0001)",placeHolder:t.placeHolder||sL.color.brightness(u,20),hoverColor:t.hoverColor||sL.color.brightness(e,-5),red:t.red||"#F06560",lightRed:t.lightRed||"#fff0f0",pink:t.pink?t.pink:"#990055",lightPink:t.lightPink?t.lightPink:"#ffb2b2",green:t.green||"#690",lightGreen:t.lightGreen||"#fbfff0",blue:t.blue||"#47AFE8",lightBlue:t.lightBlue||"#eff8fd",orange:t.orange||"#FF9900",lightOrange:t.lightOrange||"#fff5e6",yellow:t.yellow||"#827717",lightYellow:t.lightYellow||"#fff5cc",purple:t.purple||"#786FF1",brown:t.brown||"#D4AC0D",fgPositive:"#38853C",bgPositive:"#DFF1E0",borderPositive:"#83D187",fgWarning:"#D56A00",bgWarning:"#FFEBD7",borderWarning:"#F5AE70",fgInfo:"#2978B5",bgInfo:"#DEECF7",borderInfo:"#7CBBEA",fgCritical:"#CC3D3D",bgCritical:"#F8E3E3",borderCritical:"#F49494",codeBg:t.codeBg||sL.color.opacity(sL.color.brightness(e,-15),.7),codeFg:t.codeFg||"#666",codePropertyColor:t.codePropertyColor||"#905",codeKeywordColor:t.codeKeywordColor||"#07a",codeOperatorColor:t.codeOperatorColor||"#9a6e3a"}}return D`
  <style>
  *, *:before, *:after { box-sizing: border-box; }
  ...
  :host {
  ...
  </style>`}function pL(e=!1,t=!0,r=!0,n=!1){if(!this.resolvedSpec)return"";"true"===this.persistAuth&&VP.call(this);const a={bg1:lL(this.bgColor)?this.bgColor:"",fg1:lL(this.textColor)?this.textColor:"",headerColor:lL(this.headerColor)?this.headerColor:"",primaryColor:lL(this.primaryColor)?this.primaryColor:"",navBgColor:lL(this.navBgColor)?this.navBgColor:"",navTextColor:lL(this.navTextColor)?this.navTextColor:"",navHoverBgColor:lL(this.navHoverBgColor)?this.navHoverBgColor:"",navHoverTextColor:lL(this.navHoverTextColor)?this.navHoverTextColor:"",navAccentColor:lL(this.navAccentColor)?this.navAccentColor:""};return this.resolvedSpec.specLoadError?e?D`
        ${"dark"===this.theme?cL.call(this,"dark",a):cL.call(this,"light",a)}
    ...
    <!-- Advanced Search -->
    ${"false"===this.allowAdvancedSearch?"":iL.call(this)}

    <div id='the-main-body' class="body ${this.cssClasses}" dir= ${this.pageDirection} >
      <!-- Side Nav -->
      ${"read"!==this.renderStyle&&"focused"!==this.renderStyle||"true"!==this.showSideNav||!this.resolvedSpec?"":VR.call(this)}
          ...
          ${!0===this.loading?D`<div class="loader"></div>`:D`
              ${!0===this.loadFailed?D`<div style="text-align: center;margin: 16px;"> Unable to load the Spec</div>`:D`
                  ...
                  ${"focused"===this.renderStyle?D`${YR.call(this)}`:D`
                      ...
                      ${"read"===this.renderStyle?PR.call(this):nL.call(this,t,r,n)}
                    `}
                  </div>
                `}`}
        </div>
  ...
  `}function mL(e=!1){if(!this.resolvedSpec)return"";const t={bg1:lL(this.bgColor)?this.bgColor:"",fg1:lL(this.textColor)?this.textColor:"",headerColor:lL(this.headerColor)?this.headerColor:"",primaryColor:lL(this.primaryColor)?this.primaryColor:"",navBgColor:lL(this.navBgColor)?this.navBgColor:"",navTextColor:lL(this.navTextColor)?this.navTextColor:"",navHoverBgColor:lL(this.navHoverBgColor)?this.navHoverBgColor:"",navHoverTextColor:lL(this.navHoverTextColor)?this.navHoverTextColor:"",navAccentColor:lL(this.navAccentColor)?this.navAccentColor:""};return this.resolvedSpec.specLoadError?e?D`
        ${"dark"===this.theme?cL.call(this,"dark",t):cL.call(this,"light",t)}
        <div style="display:flex; align-items:center; border:1px dashed var(--border-color); height:42px; padding:5px; font-size:var(--font-size-small); color:var(--red); font-family:var(--font-mono)"> ${this.resolvedSpec.info.description} </div>
      `:D`
      ${"dark"===this.theme?cL.call(this,"dark",t):cL.call(this,"light",t)}
      <!-- Header -->
